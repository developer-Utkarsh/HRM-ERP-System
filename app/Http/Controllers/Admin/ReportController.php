...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.report.index', compact('report_faculty'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.report.view', compact('faculty_report'));
    }
    ...
    public function subject_report(Request $request){
        ...
        if (!empty($get_subject_report) && !empty($get_subject_report)) {
            ...
            foreach($get_subject_report->startclass as $key => $report){
                ...
                $res .= '<td>' . date('d-m-Y',strtotime($report->sc_date)) . '</td>';
                $res .= '</tr>';
            }
            $res .= '</tbody>';
            $res .= '</table>';
    ...
    public function report_export(Request $request)
    {
        if(is_array($request->id) && !empty($request->id)){
            ...
            return redirect()->route('admin.reports.index')->with('error', 'Please Select The Checkbox');
        }
    }
}
