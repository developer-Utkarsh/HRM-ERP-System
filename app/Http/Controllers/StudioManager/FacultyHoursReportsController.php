...
class FacultyHoursReportsController extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		if(!empty($department_type)){ 
			$whereCond .= " AND departments.id = '".$department_type."'";
		}
        ...
        return view('studiomanager.faculty_hours_reports.index', compact('get_faculty','selectFromDate','selectToDate','branch_location','online_class_type','allDepartmentTypes'));
    }
   ...
   public function download_pdf() { 
		...
		if(!empty($faculty_id) || !empty($selectFromDate) || !empty($selectToDate)){
			...
			$get_faculty = DB::table('users')
							->select('users.id','users.name','users.mobile','users.committed_hours','users.agreement','departments.name as department_name')
							->leftJoin('departments', 'departments.id', '=', 'users.department_type')
							->whereRaw($whereCond)
							->orderBy('name')
							->get();		
        ...
        // ---------------------------------------------------------
        // $title = 'Studio Report';
		$html = view('studiomanager.faculty_hours_reports.pdf_html', compact('get_faculty','selectFromDate','selectToDate','branch_location','online_class_type'))->render();
        //echo $html; //exit();
   ...
   public function download_excel()
	...
	public function agreement_hours(Request $request)
    {
        ...
        return view('studiomanager.faculty_hours_reports.agreement_hours', compact('get_faculty','selectFromDate','selectToDate','branch_location','mt','yr','year_wise_month'));
    }
