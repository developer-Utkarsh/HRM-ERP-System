...
class TopicController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('studiomanager.topic.index', compact('topics','pageNumber','params'));
    }
    ...
    {
        return view('studiomanager.topic.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($topic->save()) {
            return redirect()->route('studiomanager.topics.index')->with('success', 'Topic Added Successfully');
        } else {
            return redirect()->route('studiomanager.topics.index')->with('error', 'Something Went Wrong !');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('studiomanager.topic.edit', compact('topic'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($topic->update($inputs)) {
            return redirect()->route('studiomanager.topics.index')->with('success', 'Topic Updated Successfully');
        } else {
            return redirect()->route('studiomanager.topics.index')->with('error', 'Something Went Wrong !');
        }
    }
	...
	public function togglePublish($id) {
        $topic = Topic::find($id);
        if (is_null($topic)) {
            return redirect()->route('studiomanager.topics.index')->with('error', 'Topic not found');
        }
        ...
        //return redirect()->route('studiomanager.topics.index')->with('success', 'Status Updated Successfully.');
