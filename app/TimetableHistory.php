...
class TimetableHistory extends Model
{
    ...
    protected $fillable = ['timetable_id','branch_id','user_id','studio_id','faculty_id','batch_id','course_id','subject_id','chapter_id','topic_id','from_time','to_time','cdate','assistant_id','time_table_parent_id','class_type','is_deleted','online_class_type','remark','schedule_type'];
