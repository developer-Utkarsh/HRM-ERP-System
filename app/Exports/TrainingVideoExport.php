...
class TrainingVideoExport implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    ...
    public function collection()
    {
    	$get_data = $this->get_data;
			...
			{  
				...
				if (isset($value->video_id) && !empty($value->video_id))
				{
					$export_data[$key][] = $value->video_id;
				}
				else
				{
					$export_data[$key][] = '';
				...
				if (isset($value->video_url) && !empty($value->video_url))
				{
					$export_data[$key][] = $value->video_url;
				}
				else
				{
					$export_data[$key][] = '';
