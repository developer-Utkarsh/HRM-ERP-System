...
class EmployeeWorkAnniversaryExport implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    ...
    public function collection()
    {
		...
		//dd($get_data);
			...
			{  	
				...
				if (isset($value->branches_name) && !empty($value->branches_name))
				{
					$export_data[$key][] = $value->branches_name;
				}
				else
				{
					$export_data[$key][] = '';
				...
				if (isset($value->degination ) && !empty($value->degination ))
				{
					$export_data[$key][] = $value->degination ;
				}
				else
				{
					$export_data[$key][] = '';
