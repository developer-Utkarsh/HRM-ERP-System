...
class KnowledgeBasedExport implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
    ...
    public function collection()
    {
    	$get_data = $this->get_data;
			...
			{  
				...
				if (isset($value->reference_link) && !empty($value->reference_link))
				{
					$export_data[$key][] = $value->reference_link;
				}
				else
				{
					$export_data[$key][] = '';
