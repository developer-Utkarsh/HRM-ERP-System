    	...
    	$get_data = $this->get_data;
			...
			{  
				...
				foreach($value->user_branches as $user_branches_value){
					if(!empty($user_branches_value->branch)){
						$branch_name  = $user_branches_value->branch->name;
						$location  = $user_branches_value->branch->branch_location;
					}
					else{
				...
				if (isset($sub_department) && !empty($sub_department->name))
				{
					$export_data[$key][] = $sub_department->name;
				}
				else
				{
					$export_data[$key][] = '';
				...
				{
					$export_data[$key][] =  date('d-m-Y',strtotime($value->user_details->dob));
				}
				else
				{
					$export_data[$key][] = '';
				...
				{
					$export_data[$key][] = date('d-m-Y',strtotime($value->user_details->joining_date));
				}
				else
				{
					$export_data[$key][] = '';
				...
				if (isset($value->reason_date) && !empty($value->reason_date))
				{
					$export_data[$key][] = date('d-m-Y',strtotime($value->reason_date));
				}
				else
				{
					$export_data[$key][] = '';
