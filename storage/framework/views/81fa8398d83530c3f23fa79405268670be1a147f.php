					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.asset.index')); ?>" method="get" name="filtersubmit">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
												<div class="col-md-4">
												...
												<div class="col-md-8">
													...
													<fieldset class="form-group">		
														<a href="<?php echo e(route('admin.asset.index')); ?>" class="btn btn-warning">Reset</a>
													</fieldset>
												</div>
											</div>
										</div>
...
$(document).ready(function () { 
        ...
        var assetTable = $('#assetTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.asset.asset-detail')); ?>",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){ 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/asset/index.blade.php ENDPATH**/ ?>