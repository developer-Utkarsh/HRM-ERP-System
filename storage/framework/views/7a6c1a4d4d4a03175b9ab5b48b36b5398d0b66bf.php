					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.studios.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="<?php echo e(route('studiomanager.studios.index')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-category">
									<a href="<?php echo e(route('studiomanager.studios.edit', $value->id)); ?>" class="btn btn-sm btn-primary">
										Change Assistant
									</a>
								...
								<td>
									...
									<a href="<?php echo e(route('studiomanager.studios.status', $value->id)); ?>">
								...
								<td class="product-action">
									<a href="<?php echo e(route('studiomanager.studios.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('studiomanager.studio.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Studio')">
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/studio/index.blade.php ENDPATH**/ ?>