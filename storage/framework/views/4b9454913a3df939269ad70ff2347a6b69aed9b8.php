	...
	<div class="content-wrapper" style="margin-top: 0px !important;">
		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('faculty-hours-reports-new')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-2">											
											...
											<fieldset class="form-group">																					
												<input type="date" name="tdate" placeholder="Date" value="<?php echo e($selectToDate); ?>" class="form-control tdate">	
											</fieldset>									
										</div>	
				...
				<!--div><a href="<?php echo e(asset('laravel/public/training_pdf/62d8f47ec6dfd.pdf')); ?>" download>Download</a></div-->
...
<?php echo $__env->make('layouts.without_login_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/faculty_hours_reports/without_login_index.blade.php ENDPATH**/ ?>