					...
					<table class="table data-list-view" id="coupon_table">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo e($c['coupon_tilte']); ?></td>
								<td><?php echo e(['0' => 'Course d/M/Y', '1' => 'User Dependent', '2' => 'User + Course Dependent'][$c['coupon_for']] ?? '-'); ?></td>
								<td><?php echo e(date('d/M/Y h:i A', $c['start'])); ?></td>
								<td><?php echo e(date('d/M/Y h:i A', $c['end'])); ?></td>
								
								<td><?php echo e($c['coupon_value'] . ($c['coupon_type']==2? "%" : "/-")); ?></td>
								...
								<td>
									...
									?>
										<button type="button" class="add_remark btn btn-primary btn-sm waves-effect waves-light"
											...
											data-coupon_title="<?php echo e($c['coupon_tilte']); ?>"
											data-start_date="<?php echo e($c['start']); ?>"
											data-end_date="<?php echo e($c['end']); ?>"
											data-coupon_value="<?php echo e($c['coupon_value']); ?>"
											data-discount_type="<?php echo e($c['coupon_type']); ?>"
											data-max_discount="<?php echo e($c['max_discount']); ?>"
											data-max_usage="<?php echo e($c['max_usage']); ?>"
											data-coupon_type="<?php echo e($c['coupon_for']); ?>"
											data-coupon_mode="<?php echo e($c['coupon_mode']); ?>"
											data-course_type="<?php echo e($c['is_pro']); ?>"
											>
											Add Remark
										</button>
									<?php } ?>
					...
					<div class="row g-2">
                        <div class="col-md-12 col-12 d-none">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="coupon" id="" required>
                                    <option value="New Coupon" selected<?php echo e(old('coupon') == 'New Coupon' ? 'selected' : ''); ?>>New Coupon</option>
                                </select>
						...
						<div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                <select class="form-control select-multiple1" name="categaory_name" id="" required>
                                    ...
                                    <option value="State One Day" <?php echo e(old('categaory_name') == 'State One Day' ? 'selected' : ''); ?>>State One Day</option>
									<option value="Civil Services" <?php echo e(old('categaory_name') == 'Civil Services' ? 'selected' : ''); ?>>Civil Services</option>
									<option value="K-13" <?php echo e(old('categaory_name') == 'K-13' ? 'selected' : ''); ?>>K-13</option>
									<option value="Center One Day(COD)" <?php echo e(old('categaory_name') == 'Center One Day(COD)' ? 'selected' : ''); ?>>Center One Day(COD)</option>
									<option value="Nursing/Pre Nursing" <?php echo e(old('categaory_name') == 'Nursing/Pre Nursing' ? 'selected' : ''); ?>>Nursing/Pre Nursing</option>
									<option value="Test Series" <?php echo e(old('categaory_name') == 'Test Series' ? 'selected' : ''); ?>>Test Series</option>
									<option value="Digital Influencers" <?php echo e(old('categaory_name') == 'Digital Influencers' ? 'selected' : ''); ?>>Digital Influencers</option>
									<option value="Digital Marketing" <?php echo e(old('categaory_name') == 'Digital Marketing' ? 'selected' : ''); ?>>Digital Marketing</option>
                                </select>
                                <div class="error_msg text-danger fw-bold"></div>
                            </div>
                        </div>
						...
						<div class="col-lg-6 col-12 form-group">
							...
							<select class="form-control select-multiple1" name="discount_type" id="" required>
								<option value=""> - Select Any - </option>
								<option value="2" <?php echo e(old('discount_type') == '2' ? 'selected' : ''); ?>>In Percentage(%)</option>
								<option value="1" <?php echo e(old('discount_type') == '1' ? 'selected' : ''); ?>>In Value</option>
							</select>
							<div class="error_msg text-danger fw-bold"></div>
						</div>
						<div class="col-lg-6 col-12 form-group">
						...
						<div class="col-lg-6 col-12 form-group">
							...
							<select class="form-control select-multiple1" name="coupon_type" id="" required>
								<option value=""> - Select Any - </option>
								<option value="0" <?php echo e(old('coupon_type') == '0' ? 'selected' : ''); ?>>Course Dependent</option>
								<option value="1" <?php echo e(old('coupon_type') == '1' ? 'selected' : ''); ?>>User Dependent</option>
								<option value="2" <?php echo e(old('coupon_type') == '2' ? 'selected' : ''); ?>>User + Course Dependent</option>
							</select>
							<div class="error_msg text-danger fw-bold"></div>
						</div>
						...
						<div class="col-lg-6 col-12 form-group">
							...
							<select class="form-control select-multiple1" name="coupon_mode" id="" required>
								<option value=""> - Select Any - </option>
								<option value="0" <?php echo e(old('coupon_mode') == '0' ? 'selected' : ''); ?>>Auto</option>
								<option value="1" <?php echo e(old('coupon_mode') == '1' ? 'selected' : ''); ?>>Manual</option>
							</select>
							<div class="error_msg text-danger fw-bold"></div>
						</div>
						<div class="col-lg-6 col-12 form-group">
							...
							<select class="form-control select-multiple1" name="course_type" id="" required>
								<option value=""> - Select Any - </option>
								<option value="0" <?php echo e(old('discount_type') == '0' ? 'selected' : ''); ?>>Standard</option>
								<option value="1" <?php echo e(old('discount_type') == '1' ? 'selected' : ''); ?>>Prime</option>
								<option value="2" <?php echo e(old('discount_type') == '2' ? 'selected' : ''); ?>>Both</option>
							</select>
							<div class="error_msg text-danger fw-bold"></div>
						</div>
						<div class="col-lg-12 col-12 form-group">
...
$(document).ready(function () {
	...
	$('#add_new_coupon').on('submit', function (e) {
		...
		$.ajax({
			url: '<?php echo e(route('admin.coupon.addcoupon')); ?>',
			type: 'POST',
			data: formData,
			processData: false,
			contentType: false,
			success: function (response) {
				...
				if (data.status === 'success') {
					...
					window.location.href = "<?php echo e(route('admin.newcoupon.historyList')); ?>";
				} else {
	...
	$('#remarkForm').on('submit', function (e) {
		...
		let formData = new FormData(this);
		$.ajax({
			url: '<?php echo e(route('admin.coupon.addRemark')); ?>',
			type: 'POST',
			data: formData,
			processData: false,
			contentType: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/newcoupon/index.blade.php ENDPATH**/ ?>