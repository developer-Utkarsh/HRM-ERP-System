						...
						<div class="card-content">
							<div class="card-body">
								<div class="users-list-filter">
									<form action="<?php echo e(route('admin.academic-faculty-report')); ?>" method="get">
										<?php echo csrf_field(); ?>
										<div class="row mx-0">								
											<div class="col-3">
												<label>Subject</label>
											...
											<div class="col-4 pt-2">
												...
												<a href="<?php echo e(route('admin.academic-faculty-report')); ?>" class="btn btn-warning">Reset</a>
											</div>
										</div>
									</form>
								</div>
										...
										<table class="table data-list-view">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo e(round($re->avg_rating,2)); ?></td>
													<td><?php echo e($re->avg_nps_4); ?></td>
													<td><?php echo e($re->avg_nps_3); ?></td>
													<td><?php echo e(round(((float)$re->avg_rating + (float)$re->avg_nps_4 + (float) $re->avg_nps_3 )/3,2)); ?></td>
													<td><?php echo e(round($re->subject_avg,2)); ?></td>
													<td>4.52</td>
												</tr>
												<?php } }else{ ?>
												<tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/academic/academic_faculty.blade.php ENDPATH**/ ?>