					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(url('admin/student-attendence-record')); ?>" method="get" name="filtersubmit">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
									<div class="row">
										<div class="col-md-3">
											<label for="users-list-role">Reg. No.</label>
											<fieldset class="form-group">
												<input type="text" class="form-control name" id="se_name" name="name" placeholder="Reg. No." value="<?php if(!empty(app('request')->input('name'))): ?><?php echo e(app('request')->input('name')); ?><?php endif; ?>">
											</fieldset>
										</div>
										<div class="col-md-3">
...
<script type="text/javascript">		
	...
	$(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
				"url": "<?php echo e(route('admin.student-attendence-record-detail')); ?>",
				"dataType": "json",
				"type": "post",
				"data": function(data){
					console.log(data);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/batchinventory/studnet-attendancerecord.blade.php ENDPATH**/ ?>