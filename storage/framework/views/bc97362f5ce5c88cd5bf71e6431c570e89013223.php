	...
	<div class="card-content collapse show">
		<div class="card-body">
			<div class="users-list-filter">
				<form action="<?php echo e(\Request::Url()); ?>" method="get" name="filtersubmit">
					<div class="row">
						...
						<div class="col-12 col-sm-6 col-lg-2">
							<label for="users-list-status">Status</label>
								<select class="form-control type" name="status">
									...
									<option value="2" <?php if('2' == app('request')->input('status')): ?> selected="selected" <?php endif; ?>>Deleted</option>
								</select>												
							</fieldset>
						</div>
						...
						<div class="col-12 col-md-2">
							...
							<fieldset class="form-group">												
								<input type="checkbox" name="blockUsers" placeholder="Date" value="1" class="form-control" <?php if(!empty(app('request')->input('blockUsers'))): ?> checked <?php endif; ?>>
							</fieldset>
						</div>
				...
				= <a href="<?php echo e(route('admin.support-discussion-batch')); ?>" target="_blank" class="btn btn-info"><b><?=$total_batch?></b></a>
				<?php } ?>
			</div>
		</div>
	</div>
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/support_category/discussion-filter.blade.php ENDPATH**/ ?>