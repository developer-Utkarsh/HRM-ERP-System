					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.typist-work-report')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('studiomanager.typist-work-report')); ?>" class="btn btn-warning">Reset</a>
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_typist_work_excel", function (e) {
		...
		window.location.href = "<?php echo URL::to('/studiomanager/'); ?>/typist-work-report-excel?" + Object.keys(data).map(function (k) {
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/typist_work_report/index.blade.php ENDPATH**/ ?>