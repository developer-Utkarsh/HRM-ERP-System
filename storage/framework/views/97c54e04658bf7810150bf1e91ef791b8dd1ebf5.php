					...
					<div class="card-content collapse show">
						<div class="card-body" style="padding: 8px 0px 0px 18px;">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.studio-availability')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-md-2 mt-2 text-right">
											<fieldset class="form-group">		
												<button type="submit" class="btn btn-primary" name="search" value="search">Search</button><br><br>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/batch_reports/studio_availability.blade.php ENDPATH**/ ?>