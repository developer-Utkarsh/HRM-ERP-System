			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.studios.index')); ?>" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.studios.update', $studio->id)); ?>" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Studio Name" name="name" value="<?php echo e(old('name', $studio->name)); ?>">
												...
												<div class="col-md-6 col-12" id="branch_loader">
													<div class="form-group">
														...
														<select class="form-control branch_id select-multiple1" name="branch_id">
															...
															<option value="<?php echo e($value->id); ?>" <?php if($value->id == $studio->branch_id): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</select>
														<i class="fa fa-spinner fa-spin set-loader" style="display: none;"></i>
														<input type="hidden" name="assistant_id" value="<?php echo e($studio->assistant_id); ?>">
														<?php endif; ?>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple3" name="floor">
															...
															<?php for($i=1;$i<=10;$i++) { ?>
															<option value="<?php echo e($i); ?>" <?php if($studio->floor == $i): ?> selected="selected" <?php endif; ?>><?php echo e($i); ?></option>
															<?php } ?>
														</select>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Order No" name="order_no" value="<?php echo e(old('order_no', $studio->order_no)); ?>" min="1">
												...
												<div class="col-md-6 col-12 mt-2">
													<div class="form-group d-flex align-items-center">
														...
														<label>
															<input type="radio" name="status" value="1" <?php echo e(($studio->status == 1) ? "checked" : ""); ?>>
															Active
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="status" value="0" <?php echo e(($studio->status == 0) ? "checked" : ""); ?>>
															Inactive
														</label>
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control change_class" name="type">
															...
															<option value="Online" <?php if($studio->type == 'Online'): ?> selected="selected" <?php endif; ?>>Online</option>
															<option value="Offline" <?php if($studio->type == 'Offline'): ?> selected="selected" <?php endif; ?> >Offline</option>
														</select>
												...
												<div class="col-md-6 col-12 capacity_div" style="display:<?=($studio->type=='Offline')?'':'none';?>">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Capacity" name="capacity" value="<?php echo e(old('capacity', $studio->capacity)); ?>" min="0">
												...
												<div class="col-md-6 col-12 mt-2">
													<div class="form-group d-flex align-items-center">
														...
														<label>
															<input type="radio" name="is_obs" value="Yes" <?php echo e(($studio->is_obs == 'Yes') ? "checked" : ""); ?>>
															Yes
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="is_obs" value="No" <?php echo e(($studio->is_obs == 'No') ? "checked" : ""); ?>>
															No
														</label>
													</div>
												</div>
	...
	$(".assistant_id").on("change", function () {
		...
		if (assistant_id) {
			$.ajax({
				...
				type : 'POST',
				url : '<?php echo e(route('admin.getassistantexits')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/studio/edit.blade.php ENDPATH**/ ?>