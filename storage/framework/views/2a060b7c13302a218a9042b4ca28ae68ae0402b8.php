...
<!-- Batch Planner List -->
<div class="modal fade bd-example-modal-lg" id="statusModel" tabindex="-1" role="dialog" a>
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body chapter_topic_list p-2">
				...
				<div class="py-1 w-100" style="color:#FF6F0E">REET 2nd Grade B-02 Batch</div>
...
$(".complete_submit").on("click",function(e) {
	...
	$.ajax({
		...
		type: "POST",
		url : '<?php echo e(route('admin.batch_subject_status_update')); ?>',
	...
	$.ajax({
		...
		success : function(data){
				...
				for(var i=0;i<data.length;i++){
					...
					var chapter_topic_list=`<div class="py-1 w-100" style="color:#FF6F0E">`+batch_name+`</div>`;
					...
					chapter_topic_list+='<th width="100">Date </th>';
					chapter_topic_list+='</tr>';
					...
					$.each(chapters,function(key){
						...
						if(chapters[key]['cdate']!=null){
							chapter_topic_list+=`<td >`+chapters[key]['cdate']+`</td>`;
						}else{
							chapter_topic_list+=`<td >-</td>`;
						}
...
$("body").on("click", "#download_pdf", function (e) {
		...
		data.batch_id=$(this).attr("data-batch-id"),
		window.open("<?php echo URL::to('/admin/'); ?>/batch-subject-topic-pdf?" + Object.keys(data).map(function (k) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/batch/view.blade.php ENDPATH**/ ?>