	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="content-header-right text-md-right col-md-3 col-12">
				<a href="<?php echo e(route('admin.multi-course-planner.topic',[$subject_id??$id])); ?>"><button class="btn btn-primary" type="button">Back</button></a>
			</div>
		</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.multi-course-planner.save-topic-master')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
														...
														<select class="form-control select-multiple2 " name="" >
															...
															<?php if(count($subject) > 0): ?>
																<?php $__currentLoopData = $subject; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $su): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<option value="<?php echo e($su->id); ?>" <?php echo e(isset($record->subject_id) && $record->subject_id == $su->id ? 'selected' : ''); ?>>
																		<?php echo e($su->name); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/multi-course-planner/add_topic.blade.php ENDPATH**/ ?>