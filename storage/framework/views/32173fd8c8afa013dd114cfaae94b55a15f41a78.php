					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.batch-hours-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<fieldset class="form-group">		
											...
											<a href="<?php echo e(route('studiomanager.batch-hours-reports')); ?>" class="btn btn-warning">Reset</a>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/batch_reports/batch_hours_report.blade.php ENDPATH**/ ?>