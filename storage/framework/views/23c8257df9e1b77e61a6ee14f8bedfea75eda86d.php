            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">                       
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="<?php echo e(route('studiomanager.profile')); ?>"><i class="feather icon-user"></i> Edit Profile</a>
                        <a class="dropdown-item" href="<?php echo e(route('studiomanager.password')); ?>"><i class="feather icon-lock"></i> Change Password</a>
...
</nav><?php /**PATH /var/www/html/laravel/resources/views/layouts/studiomanager/header.blade.php ENDPATH**/ ?>