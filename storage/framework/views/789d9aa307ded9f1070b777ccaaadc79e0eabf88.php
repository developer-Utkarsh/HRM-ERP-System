		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-6">
						<a href="<?php echo e(route('admin.meeting-places.create')); ?>" class="btn btn-primary float-right ">Add Meeting Place</a>
					</div>
				</div>
			</div>
		</div>
			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.meeting-places')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="<?php echo e(route('admin.meeting-places')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
				...
				<div class="table-responsive">
					<table class="table data-list-view">
						...
						<tbody>
							<?php if(count($meeting_place) > 0): ?>
							<?php $__currentLoopData = $meeting_place; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($key + 1); ?></td>
								<td class="product-category"><?php echo e(!empty($value->branch_location) ? ucwords($value->branch_location) : '-'); ?></td>
								...
								<td class="product-action">
									<a href="<?php echo e(route('admin.meeting-places.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('admin.meeting-places.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete?')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/meeting/meeting-places.blade.php ENDPATH**/ ?>