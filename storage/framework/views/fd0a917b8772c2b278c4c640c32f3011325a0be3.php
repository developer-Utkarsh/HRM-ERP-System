					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.attendance.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
									    <?php if(Auth::user()->role_id != 20): ?>
										<div class="col-md-3">
											<label for="users-list-role">Employee Name</label>
											<fieldset class="form-group">
												<input type="text" class="form-control name" name="name" id="se_name" placeholder="Name, EMP Code" value="<?php echo e(app('request')->input('name')); ?>" id="myInputSearch" onkeyup="myFunctionSearch()">
											</fieldset>
										</div>
										<?php endif; ?>
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" name="fdate" class="form-control StartDateClass fdate" value="<?php echo e(app('request')->input('fdate')); ?>"  id="se_fdate">
											</fieldset>
										</div>
										<div class="col-md-2">
											<label for="users-list-verified">To</label>
											<fieldset class="form-group">
												<input type="date" name="tdate" class="form-control EndDateClass tdate" value="<?php echo e(app('request')->input('tdate')); ?>" id="se_tdate">
											</fieldset>
										</div>
									</div>
									<fieldset class="form-group" style="float:right;">		
									<button type="submit" class="btn btn-primary">Search</button>
									<a href="<?php echo e(route('admin.attendance.index')); ?>" class="btn btn-warning">Reset</a>
...
var roleid = <?php echo e(Auth::user()->id); ?>;
 ...
 $(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.attendance.attendance-detail')); ?>",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/index.blade.php ENDPATH**/ ?>