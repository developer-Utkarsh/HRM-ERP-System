		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							...
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.view-task')); ?>" method="get" name="filtersubmit">
									...
									<div class="row">
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<select class="form-control emp_id select-multiple1" name="emp_id">
												...
												<option value="Self" <?php if(!empty(app('request')->input('emp_id')) && 'Self' == app('request')->input('emp_id')): ?> selected="selected" <?php endif; ?>> Assign to Self </option>
												<option value="Other" <?php if(!empty(app('request')->input('emp_id')) && 'Other' == app('request')->input('emp_id')): ?> selected="selected" <?php endif; ?>> Assign to Other </option>
												<option value="aOther" <?php if(!empty(app('request')->input('emp_id')) && 'aOther' == app('request')->input('emp_id')): ?> selected="selected" <?php endif; ?>> Assign by Other </option>
												...
												<option value="<?php echo e($value->id); ?>" <?php if($value->id == app('request')->input('emp_id')): ?> selected="selected" <?php endif; ?>><?=$value->name ." (".$value->register_id." - ".$value->degination.")";?></option>
										...
										<div class="col-12 col-sm-6 col-lg-2">
											...
											<select class="form-control status select-multiple2" name="status">
												...
												<?php $status = ['Assign','In Progress','Completed', 'Dropped']; ?>
												<option value="">Select Any</option>
									...
									<fieldset class="form-group" style="float:right;">		
										...
										<a href="<?php echo e(route('admin.view-task')); ?>" class="btn btn-warning">Reset</a>
				...
				<div class="table-responsive">
					<table class="table data-list-view" style="background:#fff;">
						...
						<tbody>		
							...
							<tr style="<?=$style;?>">
								...
								<td><?php echo e($t->assign_name); ?></td>
								<td><?php echo e($t->emp_name); ?></td>								
								<td><?php echo e($t->plan); ?></td>				 				
								<td><?php echo e($t->spent); ?></td>								
								<td><?php echo e($t->total); ?></td>
								<td>
									<?php 
										if($t->emp_id == Auth::user()->id &&  $t->spent ==''){
									?>									
									<a title="Task Edit" href="javascript:void(0)" data-id="<?php echo e($t->id); ?>" class="get_edit_data">
									...
									?>
									&nbsp; 
									<a href="<?php echo e(route('admin.view-task-history', $t->id)); ?>" title="View Task">View</a></td>
							</tr>	
							<?php 
								$i++; }
								}else{
					...
					<?php echo $task->appends($params)->links(); ?>
...
<div class="modal" id="history">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo e(route('admin.update-spent-hour')); ?>">
...
$(".get_edit_data").on("click", function() { 
		...
		if(task_id){
			...
			$.ajax({
				type : 'POST',
				url : '<?php echo e(route('admin.edit-task')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/get_task/index.blade.php ENDPATH**/ ?>