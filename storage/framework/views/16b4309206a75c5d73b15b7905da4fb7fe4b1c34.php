		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-md-8">
						<h2 class="content-header-title float-left mb-0">Faculty Plan</h2>
						...
						<div class="card-content">
							<div class="card-body">
								<div class="users-list-filter">
									<form action="<?php echo e(route('admin.faculty-plan')); ?>" method="get">
										<?php echo csrf_field(); ?>
										<div class="row mx-0">								
											<div class="col-3">
												<label>Subject</label>
											...
											<div class="col-4 pt-2">
												...
												<a href="<?php echo e(route('admin.faculty-plan')); ?>" class="btn btn-warning">Reset</a>
											</div>
										</div>
									</form>
								</div>
										...
										<table class="table data-list-view">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo e($re->total_allotted_hour??'-'); ?></td>
													<td><?php echo e($re->total_spent_hours??'-'); ?></td>
													<td><?php echo e($re->completed_mark_hrs??'-'); ?></td>
													<td></td>
												</tr>	
												<?php } 
													}else{
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/academic/faculty_plan.blade.php ENDPATH**/ ?>