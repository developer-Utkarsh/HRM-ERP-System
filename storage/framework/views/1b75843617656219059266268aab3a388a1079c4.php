...
<body>
    <div class="container p-4 mt-3">
        <div class="d-flex justify-content-between">
            ...
            <div class="">
                <a href="<?php echo e(route('app-view-complaint', ['user_id' => $user_id])); ?>" class="btn btn-dark"
                    style="font-size:12px;">History</a>
            </div>
        </div>
        <form action="<?php echo e(route('complaint-cleanliness.submit')); ?>" method="POST" class="card p-2"
            ...
            <div class="mb-3">
                ...
                <?php if($errors->has('complaint')): ?>
                    <span class="text-danger"><?php echo e($errors->first('complaint')); ?> </span>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <?php if($errors->has('media')): ?>
                    <span class="text-danger"><?php echo e($errors->first('media')); ?> </span>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/complaint-cleanliness.blade.php ENDPATH**/ ?>