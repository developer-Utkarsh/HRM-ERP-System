					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.notification.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-lg-4">
													...
													<fieldset class="form-group">												
														<select class="form-control select-multiple2 employee_id" name="employee_id">
															...
															<option value="<?php echo e($value->id); ?>" <?php if($value->id == app('request')->input('employee_id')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															<?php endif; ?>
														</select>												
													</fieldset>
												...
												<div class="col-12 col-sm-6 col-lg-4">
													...
													<select class="form-control select-multiple3" name="degination">
														...
														<option value="<?php echo e($value); ?>" <?php if($value == old('degination')): ?> selected="selected" <?php endif; ?>><?php echo e($key); ?></option>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</select>
												</div>
												...
												<div class="col-md-12 col-12">
													<div class="form-group">
														...
														<textarea class="form-control" name="description" id="editor"><?php echo e(old('description')); ?></textarea>
													</div>
												</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/notification/add.blade.php ENDPATH**/ ?>