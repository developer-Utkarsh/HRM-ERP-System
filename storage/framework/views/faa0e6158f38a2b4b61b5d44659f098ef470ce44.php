					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.subject-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('studiomanager.subject-reports')); ?>" class="btn btn-warning">Reset</a>
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_excel", function (e) {
		...
		window.location.href = "<?php echo URL::to('/studiomanager/'); ?>/subject-report-excel?" + Object.keys(data).map(function (k) {
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/subject_reports/index.blade.php ENDPATH**/ ?>