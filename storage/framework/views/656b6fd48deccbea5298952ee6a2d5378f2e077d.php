			...
			<div class="content-header-left col-md-4 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						...
						<a href="<?php echo e(route('admin.chapter.import')); ?>" class="btn btn-primary mr-1">Import Chapter</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.chapters.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo e(route('admin.chapter.status', $value->id)); ?>">
								...
								<td class="product-action">
									<a href="<?php echo e(route('admin.chapters.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('admin.chapter.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Chapter')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/chapter/index.blade.php ENDPATH**/ ?>