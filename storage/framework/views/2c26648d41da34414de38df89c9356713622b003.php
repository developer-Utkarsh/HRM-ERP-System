	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="content-header-left col-md-3 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<a href="<?php echo e(route('studiomanager.subjects.create')); ?>" class="btn btn-primary">
							Add Subject
						</a>
					</div>
				</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.subjects.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
					...
					<table class="table data-list-view">
						...
						<tbody>							
							...
							<tr>
								...
								<td class="product-category"><b><?php echo e($value->id); ?></b></td>
								<!--td><?php if($value->status == 1): ?> Active <?php else: ?> Inactive <?php endif; ?></td-->
								<td>
									
									<a href="<?php echo e(route('studiomanager.subject.status', $value->id)); ?>">
								...
								<td class="product-action">
									<a href="<?php echo e(route('studiomanager.subjects.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('studiomanager.subject.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Subject')">
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/subject/index.blade.php ENDPATH**/ ?>