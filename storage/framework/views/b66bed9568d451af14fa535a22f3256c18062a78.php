					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.employees.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-12 col-sm-6 col-lg-2">
											<label for="users-list-role">Search</label>
											<fieldset class="form-group">
												<input type="text" class="form-control search" name="search" placeholder="Ex:Name, Email, Mobile, Employee Code" value="<?php echo e(app('request')->input('search')); ?>" id="myInputSearch" onkeyup="myFunctionSearch()">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-2">
										...
										<div class="col-md-5">
											...
											<a href="<?php echo e(route('studiomanager.employees.index')); ?>" class="btn btn-warning">Reset</a>
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-name">
									<a href="<?php echo e(route('studiomanager.employees.view', $value->id)); ?>" class="btn btn-sm btn-primary"><?php echo e($value->register_id); ?>
								...
								<td>
									...
									<!--a href="<?php echo e(route('studiomanager.employee.status', $value->id)); ?>" <?php if(Auth::user()->role_id == 21): ?>style="display: inline-block;pointer-events: none;" <?php endif; ?>>
									...
									<a href="<?php if($value->status == 1): ?><?php echo e('javascript:void(0)'); ?> <?php else: ?> <?php echo e(route('studiomanager.employee.status', $value->id)); ?> <?php endif; ?>" <?php if($value->status == 1){ echo 'data-toggle=modal data-id='.$value->id.' data-status='.$value->status ; } ?> id="lnk" <?php if(Auth::user()->role_id == 21): ?>style="display: inline-block;pointer-events: none;" <?php endif; ?>>
								...
								?>
									<a href="<?php echo e(route('studiomanager.employees.approval', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-bell" title="Pending For Approval"></i></span>
									</a>
								<?php
								}
								?>
									<a href="<?php echo e(route('studiomanager.employees.view', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-eye"></i></span>
									</a>
									<?php if(Auth::user()->role_id != 21): ?>
									<a href="<?php echo e(route('studiomanager.employees.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<!--
									<a href="<?php echo e(route('studiomanager.employee.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Employee')">
...
<div id="edit-sts" class="modal fade">
	<div class="modal-dialog modal-lg">
		...
		<form action="<?php echo e(route('studiomanager.employee.status-by-reason')); ?>" method="post" id="submit_user_status_form" class="online-form">
		<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/employee/index.blade.php ENDPATH**/ ?>