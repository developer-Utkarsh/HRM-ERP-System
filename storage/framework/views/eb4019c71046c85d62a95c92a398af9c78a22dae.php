		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-md-6">
						<h2 class="content-header-title float-left mb-0">Training PDF</h2>
					...
					<div class="col-md-6">
						<a href="<?php echo e(route('admin.training_pdf.create')); ?>" class="btn btn-primary float-right ">Add Training PDF</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.training_pdf.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="<?php echo e(route('admin.training_pdf.index')); ?>" class="btn btn-warning">Reset</a>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-category"><a href="<?php echo e(asset('laravel/public/training_pdf/')); ?><?php echo e(!empty($value->pdf_url) ? '/'.$value->pdf_url : '/default-image.png'); ?>" class="btn btn-sm btn-primary get_emp_data waves-effect waves-light" target="__blank">PDF</a></td>
								...
								<td class="product-action">
									<a href="<?php echo e(route('admin.training_pdf.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('admin.training_pdf.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Knowledge Based')">
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_excel", function (e) {
		var data = {};
			...
			window.location.href = "<?php echo URL::to('/admin/'); ?>/training-pdf-report-excel?" + Object.keys(data).map(function (k) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/training_pdf/index.blade.php ENDPATH**/ ?>