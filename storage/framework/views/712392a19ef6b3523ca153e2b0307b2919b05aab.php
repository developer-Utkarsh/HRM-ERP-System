		...
		<div class="modal-content">
			...
			<form method="post" class="card" id="verify_contact">
				...
				<div class="modal-footer">
					...
					<button type="submit" id="course_submit" class="btn btn-primary hide">Submit</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({ 
			...
			success: function (response) {
				...
				if(rsp.Status=="OK"){
					...
					if(record.title==undefined  || record.publish!=1 || record.course_sp<=0){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/payment/add.blade.php ENDPATH**/ ?>