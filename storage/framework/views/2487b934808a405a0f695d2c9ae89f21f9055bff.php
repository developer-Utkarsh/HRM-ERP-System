		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
				<div class="table-responsive">
					<form action="<?php echo e(route('admin.save-it-deo-work')); ?>" method="post">
						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/typist_work_report/add-it-deo.blade.php ENDPATH**/ ?>