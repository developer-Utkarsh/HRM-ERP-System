		...
		<div class="content-body">
			<section id="data-list-view" class="data-list-view-header">
				...
				<div class="text-right pb-2">
					<a href="<?php echo e(route('employee-complaint-history',[$user_id])); ?>" class="btn-dark p-1" style="border-radius:3px;">History</a>
				</div> 
				<div class="card">
					<div class="card-content">
						...
						<div class="card-body">
							...
							<hr>
							<form class="form" action="<?php echo e(route('employee-complaint-store')); ?>" method="post" enctype="multipart/form-data">
								<?php echo csrf_field(); ?>
								<div class="form-body">
									<div class="row">
...
</html><?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/employee-complaint.blade.php ENDPATH**/ ?>