			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('studiomanager.chapters.index')); ?>" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('studiomanager.chapter.import.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<?php endif; ?>
														<br>
														<a href="<?php echo e(asset('laravel/public/chapters-import-sample.xlsx')); ?>" class="download_sample">Download Sample</a>
													</div>
												</div>                                 
												<div class="col-12">
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/chapter/import.blade.php ENDPATH**/ ?>