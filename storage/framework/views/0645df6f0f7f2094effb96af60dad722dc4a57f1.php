							...
							<div class="card-content">
								<div class="card-body">
									<?php if(Auth::user()->role_id == 28 || Auth::user()->role_id == 27 || Auth::user()->role_id == 29 || Auth::user()->user_details->degination == "BRANCH HEAD" || Auth::user()->user_details->degination == "CENTER HEAD" || Auth::user()->user_details->degination == "SR. EXECUTIVE-NOTES DISTRIBUTION"  || Auth::user()->id == 8006){ ?>
										<form class="form" action="<?php echo e(route('admin.batchinventory.save')); ?>" method="post" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>
											<div class="form-body">
												<div class="row">
											...
											<div class="remove_row row">
												<div class="col-md-3 col-4">
													<div class="form-group">
														...
														<?php if($errors->has('inventory_type')): ?>
														<span class="text-danger"><?php echo e($errors->first('inventory_type')); ?> </span>
														<?php endif; ?>
													</div>	
												</div>	
												<div class="col-md-3 col-12">
...
<script type="text/javascript">
	...
	function getInventory(value){
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.batchinventory.get-batch-inventory')); ?>',
			data : {'_token' : '<?php echo e(csrf_token()); ?>', 'batch_code': value},
			dataType : 'html',
			success : function (data){
				$('.insData').empty();
				$('.insData').append(data);
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/batchinventory/add.blade.php ENDPATH**/ ?>