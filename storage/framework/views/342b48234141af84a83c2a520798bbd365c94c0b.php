					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.studio-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">												
												<select class="form-control type" name="change_after_publish">
													<option value="">Select Type</option>
													<option value="0" <?php if('0' == app('request')->input('change_after_publish')): ?> selected="selected" <?php endif; ?>>No</option>
													<option value="1" <?php if('1' == app('request')->input('change_after_publish')): ?> selected="selected" <?php endif; ?>>Yes</option>
													<option value="2" <?php if('2' == app('request')->input('change_after_publish')): ?> selected="selected" <?php endif; ?>>Checked</option>
													<option value="3" <?php if('3' == app('request')->input('change_after_publish')): ?> selected="selected" <?php endif; ?>>Deleted</option>
												</select>												
											</fieldset>
										</div>
										<div class="col-12 col-md-3">
										...
										<div class="col-12 col-md-12 mt-2">
											<fieldset class="form-group">		
												...
												<a href="<?php echo e(route('admin.studio-reports')); ?>" class="btn btn-warning">Reset</a>
					...
					foreach ($get_studios as $branchArray) {
						...
						<table class="table data-list-view" style=''>
							...
							<body>
								...
								?>
									<tr class="<?php if($timetable->change_after_publish==1): ?> btn-danger <?php endif; ?>">
										...
										<?php if($timetable->change_after_publish==1): ?>
											<td class="btn-danger">
												<?php echo $schedule_duration ?>
												<span class="btn btn-sm btn-success changeMark" data-id="<?php echo e($timetable->id); ?>">Mark Done</span>	
											</td>
										<?php else: ?>
										    <td>
												<?php echo $schedule_duration ?>	
...
<script type="text/javascript">
	...
	$(document).on("click",".changeMark",function (){
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.studio-reports.changeMark')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/studio_reports/index.blade.php ENDPATH**/ ?>