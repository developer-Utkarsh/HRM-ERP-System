					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.expense.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="<?php echo e(route('admin.expense.index')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<?php if(!empty($fileExt) && $fileExt == 'pdf'): ?>
								<td class="product-category"><a class="btn btn-primary btn-sm" href="<?php echo e(asset('/')); ?><?php echo e(!empty($value->file_name) ? '/'.$value->file_name : ''); ?>" target="__blank">View</a></td>
								<?php else: ?>
								<td class="product-category"><img src="<?php echo e(asset('/')); ?><?php echo e(!empty($value->file_name) ? '/'.$value->file_name : '/default-image.png'); ?>" style="width: 100px;height: 100px;"></td>
								<?php endif; ?>
								...
								<td class="product-category"><?php echo e(!empty($value->amount) ? $value->amount : ''); ?></td>
								<td class="product-category"><?php echo e(!empty($value->remark) ? $value->remark : ''); ?></td>
								<td class="product-category">
									<?php echo e(!empty($value->status) ? $value->status : ''); ?>
								...
								<td class="product-category"><?php echo e(!empty($value->created_at) ? date('d-m-Y',strtotime($value->created_at)) : ''); ?></td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php else: ?>
...
<div class="modal" id="myModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo e(route('admin.expense.statusupdate')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/expense/index.blade.php ENDPATH**/ ?>