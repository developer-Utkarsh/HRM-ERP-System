			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.class-type-wise')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<fieldset class="form-group" style="float:right;">		
										...
										<a href="<?php echo e(route('admin.class-type-wise')); ?>" class="btn btn-warning">Reset</a> 
				...
				?>
							...
							<tr> 
								...
								<td><b><?php echo e($get_faculty_value->classCount); ?></b></td>
								<td><b></b> 
								<?php
	...
	$(".cancel-cls").on("click", function(){
		...
		if(remark != ''){
			 $.ajax({
				...
				data : {'_token' : '<?php echo e(csrf_token()); ?>', 'remark': remark, 'start_time': start_time, 'end_time': end_time, 'timetable_id': tt_id, 'spent_id': spent_id},
				dataType : 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/class_type_wise/index.blade.php ENDPATH**/ ?>