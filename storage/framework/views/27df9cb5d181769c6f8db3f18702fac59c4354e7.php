			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.attendance.index')); ?>" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.attendance.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
											...
											<?php if(Auth::user()->role_id != 20): ?>
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple1" name="emp_id" required>
															...
															<option value="<?php echo e($value['id']); ?>" <?php if($value['id'] == old('emp_id')): ?> selected="selected" <?php endif; ?>><?=$value['name'] ." (".$value['register_id'].")"." (".$value['role_name'].")";?></option>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control" placeholder="Date" name="date" value="<?php echo e(date('Y-m-d')); ?>"  required>
<!-- 														 max="<?php echo e(date('Y-m-d')); ?>" <?php if(Auth::user()->id != 901): ?>min="<?php echo e(date('Y-m-d', strtotime("-$current_date days"))); ?>"<?php endif; ?>
 -->														<!--<?php if(Auth::user()->id != 901): ?>min="<?php echo e(date('Y-m-d', strtotime("-$current_date days"))); ?>"<?php endif; ?> -->
	...
	$(".branch_id").on("change", function () {
		...
		if (branch_id) {
			$.ajax({
				...
				type : 'POST',
				url : '<?php echo e(route('admin.get-branchwise-employee')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/add.blade.php ENDPATH**/ ?>