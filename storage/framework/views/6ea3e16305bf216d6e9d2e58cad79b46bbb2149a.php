						...
						<tbody>
							...
							<input type="hidden" name="fdate" value="<?php echo e($get_timetable->cdate); ?>">
								...
								<tr style="border-bottom-style:hidden;">
									...
									<td><?php echo e($get_detail->q21); ?></td>
								</tr>
								...
								<tr style="border-bottom-style:hidden;">
									...
									<td><?php echo e($get_detail->q2); ?></td>
								</tr>
								
								<tr style="border-bottom-style:hidden;">
									<td style="font-weight:900;">7. इस टेस्ट की सूचना कौनसी तारीख़ को दी गई व किसने </td>
									<td><?php echo e($get_detail->q3); ?>, <?php echo e($get_detail->q4); ?></td>
								</tr>
								<tr style="border-bottom-style:hidden;">
								...
								<tr style="border-bottom-style:hidden;">
									...
									<td><?php echo e($get_detail->q17); ?></td>
								</tr>
								<tr style="border-bottom-style:hidden;">
...
<?php echo $__env->make('layouts.without_login_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/webview_reports/schedule_test_report_view.blade.php ENDPATH**/ ?>