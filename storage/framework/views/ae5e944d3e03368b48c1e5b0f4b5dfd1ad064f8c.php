					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.department.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="<?php echo e(route('admin.department.index')); ?>" class="btn btn-warning">Reset</a>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo e(route('admin.department.status', $value->id)); ?>">
								...
								<td class="product-action">
									<a href="<?php echo e(route('admin.department.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('admin.department.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Department')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/department/index.blade.php ENDPATH**/ ?>