		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">ESIC NO List</h2>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.employees.esic-no-detail')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-md-3">
										...
										<div class="col-md-3">
											...
											<a href="<?php echo e(route('admin.employees.esic-no-detail')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						<tbody>
							<?php if(count($employees) > 0): ?>
								...
								<tr>
									...
									<td><?php echo e(!empty($value->user_details->esic_no) ? $value->user_details->esic_no : '--'); ?></td>
								</tr>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							<?php else: ?>
								<tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/employee/esic_no.blade.php ENDPATH**/ ?>