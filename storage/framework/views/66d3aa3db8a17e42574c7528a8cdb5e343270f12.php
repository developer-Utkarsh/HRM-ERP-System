	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="content-header-right text-md-right col-md-4 col-12 d-md-block">
				...
				<a href="<?php echo e(route('admin.multi-course-planner.multi-planner-summary',[$id])); ?>"><button class="btn btn-primary" type="button">View Planner</button></a>
				<?php } ?>
							...
							<div class="card-content collapse show">
								<div class="card-body">
									<div class="users-list-filter">
										<form action="<?php echo e(route('admin.multi-course-planner.save-subject-assign')); ?>" method="post" name="filtersubmit">
											<?php echo csrf_field(); ?>
											...
											<div id="filter-wrapper">
												<div class="row filter-section">
													...
													<div class="col-12 col-sm-6 col-lg-3">
														<div class="form-group">
															...
															<select class="form-control select-multiple2 status" name="status"
																<?php if(old('status', $record->status ?? '') == 3 || Auth::user()->role_id != 21): ?> disabled <?php endif; ?>>
													...
													<div class="col-12 col-sm-6 col-lg-4 reason" style="display:none">
														...
														<fieldset class="form-group">												
															<textarea name="reason" class="form-control reason_text" <?php if(old('status', $record->status ?? '') == 3): ?> readonly <?php endif; ?>><?php echo e($record->reason ?? ''); ?></textarea>
														...
														<table class="table data-list-view">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="col-12 col-sm-6 col-lg-3">
																		<fieldset class="">												
																			<select name="subject_id[]" class="form-control select-multiple1 readonly-select" <?php if(Auth::user()->role_id!=21){ echo 'disabled'; } ?>>
																				...
																				<option value="<?php echo e($su->id); ?>" <?php if($sr->subject_id==$su->id){ echo 'selected'; } ?>><?php echo e($su->name); ?></option>
																				<?php } ?>
																			</select>
																	...
																	<td class="col-12 col-sm-6 col-lg-3">
																		<fieldset class="">											
																			...
																			<?php if(Auth::user()->role_id!=21){ echo 'disabled'; } ?>>
																				...
																				<option value="<?php echo e($sm->id); ?>" <?php if($sr->sme_id==$sm->id){ echo 'selected'; } ?>><?php echo e($sm->name); ?> - <?php echo e($sm->register_id); ?></option>
																				<?php } ?>
																			</select>
																	...
																	<td class="col-12 col-sm-6 col-lg-3">
																		<div class="">
																			<h5 class="mb-2" style="font-size:12px !important;"><strong><span class="text-danger"><?php echo e($tStatus); ?></span></strong></h5>
																		</div>
																	</td>
																	<td class="col-12 col-sm-6 col-lg-3">
																		<div class="">
																			...
																			>
																				<option value="">Select Any</option>
																				<?php $__currentLoopData = $sstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																					<option value="<?php echo e($key); ?>"
																						<?php if(old('sstatus', $sr->is_subject ?? '') == $key): ?> selected <?php endif; ?>>
																						<?php echo e($label); ?>
																	...
																	<td class="col-12 col-sm-6 col-lg-3">
																		<fieldset class="">											
																			<select name="faculty_id[]" class="form-control select-multiple1" <?php if(Auth::user()->role_id!=27){ echo 'disabled'; } ?>>
																				...
																				<option value="<?php echo e($fa->id); ?>" <?php if($sr->faculty_id==$fa->id){ echo 'selected'; } ?>><?php echo e($fa->name); ?> - <?php echo e($fa->register_id); ?></option>
																				<?php } ?>
																			</select>
														...
														<div class="col-12 col-sm-6 col-lg-3">
															...
															<fieldset class="form-group">												
																<select name="subject_id[]" class="form-control select-multiple1">
																	<option value="">-- Select --</option>
																	<?php foreach($subject as $su){ ?>
																	<option value="<?php echo e($su->id); ?>"><?php echo e($su->name); ?></option>
																	<?php } ?>
																</select>
															</fieldset>
														</div>
														<div class="col-12 col-sm-6 col-lg-3">
															...
															<fieldset class="form-group">											
																<select name="sme_id[]" class="form-control select-multiple1">
																	<option value="">-- Select --</option>
																	<?php foreach($sme as $sm){ ?>
																	<option value="<?php echo e($sm->id); ?>"><?php echo e($sm->name); ?> - <?php echo e($sm->register_id); ?></option>
																	<?php } ?>
																</select>
															</fieldset>
														</div>															
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/multi-course-planner/subject_assign.blade.php ENDPATH**/ ?>