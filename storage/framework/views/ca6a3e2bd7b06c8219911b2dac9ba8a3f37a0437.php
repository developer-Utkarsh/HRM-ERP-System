					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.batch-reports-shiftwise')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3 branch_loader">
											...
											<fieldset class="form-group">												
												<select class="form-control branch_location" name="branch_location" id="">
													...
													<option value="prayagraj" <?php if('indore' == app('request')->input('branch_location')): ?> selected="selected" <?php endif; ?>>prayagraj</option>
												</select>
											</fieldset>
										</div>
										...
										<fieldset class="form-group">		
											...
											<a href="<?php echo e(route('studiomanager.batch-reports-shiftwise')); ?>" class="btn btn-warning">Reset</a>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/batch_reports/batch_reports_shift_wise.blade.php ENDPATH**/ ?>