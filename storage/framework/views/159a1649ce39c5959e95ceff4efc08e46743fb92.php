			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.view-task')); ?>" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
		</div>
					...
					<table class="table data-list-view" style="background:#fff;">
						...
						<tbody>		
							...
							<tr>
								...
								<td><?php echo e($t->thstatus); ?></td>
								<td><?php echo e($t->thremark); ?></td>
								<td>
									<?php 
										if($t->thstatus=='Assign' || $t->thstatus=='In Progress'){ 
											if($t->emp_id == Auth::user()->id){
									?>
									<a title="Task Edit" href="javascript:void(0)" data-id="<?php echo e($t->thid); ?>" class="get_edit_data">
									...
									<!--
									<a href="<?php echo e(route('admin.task-history', $t->thid)); ?>" title="Task Details">
									...
									<?php 
										if($t->thstatus=='Assign' || $t->thstatus=='In Progress'){  
											if($t1 > $t2){
									?>
									<a href="<?php echo e(route('admin.task-delete', $t->thid)); ?>" onclick="return confirm('Are You Sure To Delete Task')">
...
<div class="modal" id="history">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo e(route('admin.update-task')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/get_task/view_task.blade.php ENDPATH**/ ?>