					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.batch.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('admin.batch.index')); ?>" class="btn btn-warning">Reset</a>
									</fieldset>
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-action">
									<a href="<?php echo e(route('admin.batch.edit', $value->id)); ?>">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="<?php echo e(route('admin.batch.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Batch')" class="d-none">
										<span class="action-delete"><i class="feather icon-trash"></i></span>
									</a>
									<a href="<?php echo e(route('admin.batch.view', $value->id)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/batch/index.blade.php ENDPATH**/ ?>