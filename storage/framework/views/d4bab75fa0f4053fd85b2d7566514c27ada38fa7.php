					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.faculty-agreement-hours')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<fieldset class="form-group" style="float:right;">		
										...
										<a href="<?php echo e(route('studiomanager.faculty-agreement-hours')); ?>" class="btn btn-warning">Reset</a>
							...
							<?php $s_no = 0; ?>
								...
								<?php
									...
									<tr>
										...
										<td class="product-category"><?php echo e($total_Offline_tt); ?> </td>
										<td class="product-category"><?php echo e($total_Online_tt); ?> </td>
									</tr>
									<?php
									}
								?>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/faculty_hours_reports/agreement_hours.blade.php ENDPATH**/ ?>