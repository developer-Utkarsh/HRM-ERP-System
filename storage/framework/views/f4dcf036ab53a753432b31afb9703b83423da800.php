					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.attendance.fullattendence')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('admin.attendance.fullattendence')); ?>" class="btn btn-warning">Reset</a>
...
$.fn.serializeObject = function() {
    ...
    $("body").on("click", ".search_click", function (e) {
        ...
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.attendance.full-attendence-detail-new')); ?>",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/fullattendence_new.blade.php ENDPATH**/ ?>