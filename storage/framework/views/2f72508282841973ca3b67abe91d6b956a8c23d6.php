					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.sub_department.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
														...
														<select class="form-control select-multiple department_id" name="department_id">
															...
															<?php if(count($department_list) > 0): ?>
																<?php $__currentLoopData = $department_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<option value="<?php echo e($value->id); ?>" <?php if($value->id == old('department_id')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Sub Department" name="name" value="<?php echo e(old('name')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/sub_department/add.blade.php ENDPATH**/ ?>