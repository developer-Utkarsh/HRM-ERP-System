					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" id="buyerForm" action="<?php echo e(route('admin.buyer.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Contact No" name="contact_no" value="<?php echo e(old('contact_no')); ?>" required>
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" id="gst_no" placeholder="GST No" name="gst_no" value="<?php echo e(old('gst_no')); ?>" required>
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control pan_no" placeholder="Pan No" name="pan_no" value="<?php echo e(old('pan_no')); ?>" required>
												...
												<div class="col-md-4 col-12 msme" style="display:none;">
													<div class="form-group">
														...
														<input type="file" class="form-control" name="msme_uam_file" value="<?php echo e(old('email')); ?>">
													</div>
												</div>
												<div class="col-md-4 col-12 msme" style="display:none;">
													<div class="form-group">
														<label for="first-name-column">MSME No / UAM No</label>
														<input type="text" class="form-control" placeholder="UAM No" name="msme_uam_no" value="<?php echo e(old('email')); ?>">
													</div>
												</div>	
												<div class="col-md-6 col-12 other" style="display:none;">
													<div class="form-group">
														...
														<input type="file" class="form-control" name="declaration_form" value="<?php echo e(old('email')); ?>">
													</div>
												</div>
												<div class="col-md-12 col-12">
													<div class="form-group">
														<label for="first-name-column">Address <span class="text-danger">*</span></label>
														<textarea class="form-control" placeholder="Address" name="address" required><?php echo e(old('address')); ?></textarea>													
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Pincode" name="pincode" value="<?php echo e(old('pincode')); ?>" required>
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Credit Period Days" name="credit_day" value="<?php echo e(old('credit_day')); ?>" required>
												...
												<div class="col-md-4 col-6">
													<div class="form-group">
														...
														<input type="file" class="form-control" name="bank_proof" value="<?php echo e(old('account')); ?>" required>
													...
													<div class="bank_details">
														...
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="text" class="form-control" placeholder="Beneficiary's Name" name="beneficiary[]" value="<?php echo e(old('beneficiary')); ?>" required>
														...
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="text" class="form-control" placeholder="Bank Account No." name="account[]" value="<?php echo e(old('account')); ?>" required>
																<?php if($errors->has('account')): ?>
																<span class="text-danger"><?php echo e($errors->first('account')); ?> </span>
																<?php endif; ?>
															</div>
														...
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="text" class="form-control" placeholder="Bank Name" name="bank_name[]" value="<?php echo e(old('bank_name')); ?>" required>
														...
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="text" class="form-control" placeholder="RTGS/NEFT IFSC CODE" name="ifsc[]" value="<?php echo e(old('ifsc')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/buyer/add.blade.php ENDPATH**/ ?>