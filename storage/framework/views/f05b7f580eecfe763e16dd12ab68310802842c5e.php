...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - Studio Assistant Panel</title>
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <!-- BEGIN: Header-->
    <?php echo $__env->make('layouts.studioassistant.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- END: Header-->
    <!-- BEGIN: Main Menu-->
    <?php echo $__env->make('layouts.studioassistant.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- END: Main Menu-->
    ...
    <!-- BEGIN: Footer-->
    <?php echo $__env->make('layouts.studioassistant.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- END: Footer-->
...
<?php /**PATH /var/www/html/laravel/resources/views/layouts/studioassistant.blade.php ENDPATH**/ ?>