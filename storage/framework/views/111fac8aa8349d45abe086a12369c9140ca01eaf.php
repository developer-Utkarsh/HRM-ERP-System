					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.batch-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<fieldset class="form-group">		
											...
											<a href="<?php echo e(route('studiomanager.batch-reports')); ?>" class="btn btn-warning">Reset</a>
				...
				if (count($get_batches) > 0) {
					...
					foreach ($get_batches as $batchArray) {
							...
							<head>
								<tr style="">
									...
									<h3>Batch Name : <?php echo $batchArray->name; ?>,
										...
										<?php if(!empty($firstclass)): ?>
										  Start Date :<?php echo date("d-m-Y",strtotime($firstclass->cdate)); ?>
										<?php endif; ?> 
										
										<?php if($batchArray->erp_course_id!=0): ?>
											(ERP Course ID : <?php echo e($batchArray->erp_course_id); ?>) 
										<?php endif; ?>
								    </h3></th>
								</tr>
							</head>
						...
						<table class="table data-list-view" style=''>
							...
							<tfoot>
								<th colspan="9">
									Total Schedule Hours : <?php echo e($schedule_hours); ?>

									<progress id="file" value="<?php echo e($precent_time); ?>" max="100"> <?php echo e($precent_time); ?> </progress>
									Total Plan Hours: <?php echo e($plan_hours); ?>
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/batch_reports/index.blade.php ENDPATH**/ ?>