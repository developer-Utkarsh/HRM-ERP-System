...
<body style="margin:auto; width: 1200px; margin-top: 30px;">
	...
	<table>
		...
		<tr>
			...
			<td style="font-family:freeserif;"><?php echo e($get_detail->q1); ?></td>
		</tr>
		
		<tr>
			<td style="font-family:freeserif;">5. टेस्ट का प्रकार </td>
			<td style="font-family:freeserif;"><?php echo e($get_detail->q21); ?></td>
		</tr>
		<?php 
		...
		<tr>
			...
			<td style="font-family:freeserif;"><?php echo e($get_detail->q2); ?></td>
		</tr>
		
		<tr>
			<td style="font-family:freeserif;">7. इस टेस्ट की सूचना कौनसी तारीख़ को दी गई व किसने </td>
			<td style="font-family:freeserif;"><?php echo e($get_detail->q3); ?>, <?php echo e($get_detail->q4); ?></td>
		</tr>
		...
		<tr>
			...
			<td style="font-family:freeserif;"><?php echo e($get_detail->q17); ?></td>
		</tr>
		...
		<tr>
			...
			<td style="font-family:freeserif;"><?php echo e($get_detail->q18); ?></td>
		</tr>

		<tr>
			<td style="font-family:freeserif;">22. क्या टेस्ट में कोई प्रश्न रिपीट हुआ ? (अगर हुआ तो विस्तार से बतायें)</td>
			<td style="font-family:freeserif;"><?php echo e($get_detail->q19); ?>, <?php echo e($get_detail->q19_1); ?> </td>
		</tr>

		<tr>
			<td style="font-family:freeserif;">23. इस टेस्ट पेपर को किसने फाईनल करके फोटोकॉपी/प्रेस में भेजा</td>
			<td style="font-family:freeserif;"><?php echo e($get_detail->q20); ?></td>
		</tr>
		<?php } ?>
	...
	</html><?php /**PATH /var/www/html/laravel/resources/views/admin/webview_reports/schedule_test_report_download.blade.php ENDPATH**/ ?>