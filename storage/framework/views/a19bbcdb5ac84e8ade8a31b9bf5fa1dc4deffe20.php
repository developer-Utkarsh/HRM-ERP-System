			...
			<tbody >
				...
				?>
					<tr style="background-color:#e4f4ff;font-size: 14px;border:0;color:#000;">					
						<td colspan="6"><?php echo e($svalue->description); ?></td>						
						<td colspan="8"><?php echo e($svalue->status); ?></td>
					</tr>
...
</script><?php /**PATH /var/www/html/laravel/resources/views/admin/get_task/pdf_html.blade.php ENDPATH**/ ?>