					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.faculty-hours-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<fieldset class="form-group" style="float:right;">		
										...
										<a href="<?php echo e(route('studiomanager.faculty-hours-reports')); ?>" class="btn btn-warning">Reset</a>
						...
						<tbody>
							...
							<?php $s_no = 0; ?>
								...
								<?php
									...
									if(!empty($branch_location) ){
										...
										<tr>
											...
											<td class="product-category"><?php echo e($get_faculty_val->department_name); ?></td>
								...
								<tr>
									...
									<td class="product-category"><?php echo e($get_faculty_val->mobile); ?></td>
									<td class="product-category"><?php echo e($get_faculty_val->department_name); ?></td>
									<td class="product-category"><?php echo e($get_faculty_val->bname); ?></td>
									<td class="product-category"><?php echo e((count($subject_arr) > 0) ? implode(",", array_unique($subject_arr)) : '--'); ?></td>
									<td class="product-category">
									<?php
									if($get_faculty_val->agreement=='Yes'){
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/faculty_hours_reports/index.blade.php ENDPATH**/ ?>