					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('studiomanager.free-faculty-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('studiomanager.free-faculty-reports')); ?>" class="btn btn-warning">Reset</a>
							...
							<tr style="">
								...
								<td class="text-center" colspan="3">
									<table class="table" style="background: #fff;">
										...
										?>
											<tr>
												<td><?php echo e($f_time); ?></td>
												<td><?php echo e($t_time); ?></td>
											</tr>
										<?php
											$f_time =  date('h:i A', strtotime($check_timetable_value->to_time));
											} 
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_free_faculty_excel", function (e) {
		...
		window.location.href = "<?php echo URL::to('/studiomanager/'); ?>/free-faculty-report-excel?" + Object.keys(data).map(function (k) {
	...
	$(".branch_id").on("change", function () {
		...
		if (branch_id) {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?php echo e(route('studiomanager.get-branchwise-faculty')); ?>',
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/free_faculty_reports/index.blade.php ENDPATH**/ ?>