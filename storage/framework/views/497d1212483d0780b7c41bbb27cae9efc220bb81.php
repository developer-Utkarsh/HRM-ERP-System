			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.faculty-leave')); ?>" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$("#leave_add").submit(function(e) {
		...
		$.ajax({
			...
			type: "POST",
			url : '<?php echo e(route('admin.faculty_leave_add_save')); ?>',
			data : dataForm,
			processData : false,  
			contentType : false,
			dataType : 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/faculty_leave/add.blade.php ENDPATH**/ ?>