				...
				<div class="card mb-1">
					<div class="card-content collapse show">
						<div class="card-body">
							...
							<form class="" action="<?php echo e(route('po-approval-list',[$sess_emp_id,$type])); ?>" method="get">
								...
								<button type="button" class="btn btn-primary" onclick="location.href = '<?php echo e(route('po-approval-list',[$sess_emp_id,$type])); ?>';">Reset</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="card-content">
						<div class="card-body">
							...
							<div class="row" style="padding-top:5px;">
								...
								<div class="col-7 font-weight-bold">: <a href="<?php echo e(route('web-view-poprint', [$g->id,$sess_emp_id])); ?>">Download</a></div>
							</div>
...
<script type="text/javascript">
	function poAction(id, value, approve){  
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('web-view-po')); ?>',
...
</html><?php /**PATH /var/www/html/laravel/resources/views/po-approval.blade.php ENDPATH**/ ?>