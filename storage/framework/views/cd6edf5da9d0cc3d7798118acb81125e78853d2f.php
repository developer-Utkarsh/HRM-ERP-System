		...
		<div class="content-body">			
			<section id="data-list-view" class="data-list-view-header">	
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.request.vendor-invoice')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-3 col-sm-3 col-lg-3">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control hadate" name="hadate" value="<?php echo e(app('request')->input('hadate')); ?>">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple1 vendor_id" name="vendor_id">
													...
													<option value="<?php echo e($value->id); ?>" <?php if($value->id == app('request')->input('vendor_id')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
										...
										<div class="col-6  pt-2">
											...
											<a href="<?php echo e(route('admin.request.vendor-invoice')); ?>" class="btn btn-warning">Reset</a>
				...
				<div class="table-responsive">
						...
						<tbody>			
							...
							<tr class="">
								...
								<td>
									...
									<a href="<?php echo e(route('admin.request.poprint', $value->request_id)); ?>" target='_blank' class='text-primary'>PO</a>
									<?php } ?>
								</td>
								<td><?php echo e($poText); ?></td>
								<td><?php echo e(isset($value->bname) ?  $value->bname : '-'); ?></td>
								<td><?php echo e(date('d-m-Y', strtotime($value->date_of_invoice))); ?></td>
								<td><?php echo e($value->invoice_no); ?></td>
								<td><?php echo e(date('d-m-Y', strtotime($value->handover_accounts))); ?></td>
								<td><?php echo e($value->amount); ?></td>
								<td>
									<?php if(!empty($value->attachment)){ ?>
									<a href="<?php echo e(asset('laravel/public/quotation/'.$value->attachment)); ?>" download >Preview</a>
									<?php }else{ echo '-'; } ?>
									<hr style="margin:0.5rem 0;">
									<?php echo e($value->	remark); ?>
								...
								<td>
									...
									<?php }else if($value->cfo_status==2){ ?>
										...
										<?=$value->cfo_reason;?>									
									<?php }else{ ?>
										<a href="javascript:void(0)"  data-id="<?php echo e($value->id); ?>" class="get_edit_cfo text-primary">
								...
								<td>
									...
									<a href="javascript:void(0)"  data-id="<?php echo e($value->id); ?>" class="get_edit_data text-primary">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
					...
					<?php echo $vendor->appends($params)->links(); ?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<form action="<?php echo e(route('admin.accounts-invoice-update')); ?>" method="post" class="form"  enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
...
<div class="modal fade" id="cfoModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<form action="<?php echo e(route('admin.request.status')); ?>" method="post" class="form"  enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/request/vendor-invoice.blade.php ENDPATH**/ ?>