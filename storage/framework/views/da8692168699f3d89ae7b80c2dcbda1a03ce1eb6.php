					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.assigned-assistants')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('admin.assigned-assistants')); ?>" class="btn btn-warning">Reset</a>
...
$(".change_assistant").on("click",function(e) {
		...
		$.ajax({
			...
			type: "POST",
			url : '<?php echo e(route('admin.assigned_assistant_update')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/assigned_assistants/index.blade.php ENDPATH**/ ?>