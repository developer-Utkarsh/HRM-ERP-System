                ...
                <div class="col-md-4 mb-3">
                    <div class="card shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <p><strong>Shift:</strong> <?php echo e($details->shift); ?></p>
                            <p><strong>Remark:</strong> <?php echo e($details->remark); ?></p>
                            <?php
                            ...
                            ?>
                            <p><strong>Status:</strong> <span class="btn <?php echo e($statusClass); ?>"><?php echo e($statusText); ?> <?php echo e($rej_reason); ?></span></p>
                            <p><strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($details->created_at)->format('d M Y h:i A')); ?></p>

                            <?php if($details->image_path): ?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="imageModalLabel<?php echo e($details->id); ?>">Report Image</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div class="modal-body text-center">
                                                <img src="<?php echo e(asset('laravel/public/cleanliness/' . basename($details->image_path))); ?>"
...
</html><?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/app-view-cleanliness-report.blade.php ENDPATH**/ ?>