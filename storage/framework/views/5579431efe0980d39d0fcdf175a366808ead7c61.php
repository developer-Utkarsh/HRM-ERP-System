			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-5 text-right">
						<a href="<?php echo e(route('admin.request.requisition-request')); ?>" class="btn btn-primary">Back</a>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.request.update-requisition', [$id, $type])); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
											...
											<div class="row">
												...
												?>
													<div class="text-right col-md-12">
														<a href="javascript:void(0)"  data-id="<?php echo e($record->arid); ?>" class="get_edit_data text-primary">Request <?=$powoText;?></a></br>
													</div>
												<?php } ?>
												...
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<input name="title[]" class="form-control" value="<?php echo e($record->title); ?>"/>
													</div>
												</div>
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<select class="form-control select-multiple1 branch_id<?=$j;?>" name="branch_id[]" data-id="<?=$j;?>">
															...
															?>
															<?php $__currentLoopData = $branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option value="<?php echo e($bData->id); ?>" <?php if($bData->id==$record->branch_id){ echo 'selected'; }?>><?php echo e($bData->name); ?></option>
												...
												<div class="col-md-6 col-6">
													<div class="form-group">
														...
														<textarea name="requirement[]" class="form-control" placeholder="Please enter your product description"><?php echo e($record->requirement); ?></textarea>
													</div>
												</div>	
													...
													<div class="form-group">
														...
														<select class="form-control select-multiple1" name="emp_id[]" required>
															...
															<?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>															
																<option value="<?php echo e($value->id); ?>" <?php if($value->id==$record->emp_id){ echo 'selected'; } ?>><?php echo e($value->name); ?> - <?php echo e($value->register_id); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</select>													
													</div>
												</div>
												...
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<select name="remark[]" class="form-control select-multiple1">
															...
															<option value="<?php echo e($dvalue->id); ?>" <?php if($dvalue->id==$record->remark){ echo 'selected'; } ?>><?php echo e($dvalue->name); ?> - <?php echo e($dvalue->register_id); ?></option>
															<?php } ?>
														</select>
														<?php }else{ ?>
														<textarea name="remark[]" class="form-control"><?php echo e($record->remark); ?></textarea>
														<?php } ?>												
												...
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<select name="material_category[]" class="form-control select-multiple1" required>
															...
															<option value="<?php echo e($value->id); ?>" <?php if($value->id == $record->material_category): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															<?php endif; ?>
														</select>
															...
															<label for="first-name-column">Category</label>
															 <select class="form-control select-multiple1 cat_id" name="category[]" data-id="<?=$j;?>">
																...
																<?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	...
																	?>
																<option value="<?php echo e($categoryvalue->id); ?>" <?=$selected;?>><?php echo e($categoryvalue->name); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																<?php endif; ?>
															</select>
															...
															<select class="form-control select-multiple1 sub_product sub_cat_id<?=$j;?>" name="scategory[]" data-id="<?=$j;?>">
																<?php if(!empty($record->scategory)): ?>
																	...
																	<?php $__currentLoopData = $subCatData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subCatDataValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		...
																		?>
																		<option value="<?php echo e($subCatDataValue->id); ?>" <?=$selected;?>><?php echo e($subCatDataValue->name); ?></option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																<?php else: ?>
																	<option value="">Select Category</option>
																<?php endif; ?>
															...
															<select class="form-control select-multiple1 product_data<?=$j;?>" name="product[]" data-id="<?=$j;?>" <?=$required;?>>		
																...
																<?php
																	$proData = DB::table('products')
																		...
																		->get();
																?>
																<?php $__currentLoopData = $proData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $proDataValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<?php 
																	...
																	?>
																	<option value="<?php echo e($proDataValue->id); ?>" <?=$selected;?>><?php echo e($proDataValue->cat_name); ?>- <?php echo e($proDataValue->scat_name); ?>- <?php echo e($proDataValue->name); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															
															</select>	
															<?php if($errors->has('product_data')): ?>
															<span class="text-danger"><?php echo e($errors->first('product_data')); ?> </span>
															<?php endif; ?>
														</div>
													</div>
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<input type="number" name="qty[]" class="form-control" placeholder="Please enter your quantity" step="any" value="<?php echo e($record->qty); ?>"/>	
													</div>
												</div>
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control" name="uom[]">
															...
															?>
															<option value="<?php echo e($val->code); ?>" <?=$selected;?>><?php echo e($val->code); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>															
														</select>	
													</div>
												</div>
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control pur_status" name="purchase_status[]">
															<option value="0" <?php if('0' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>In Progress</option>
															<option value="1" <?php if('1' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>On Hold</option>
															<option value="2" <?php if('2' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>Deliver</option>
															<option value="3" <?php if('3' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>PO Generated</option>
															<option value="4" <?php if('4' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>Below 5000 - Deliver</option>
															<option value="5" <?php if('5' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>Cancel</option>
															<option value="6" <?php if('6' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>Rejected</option>
															<option value="7" <?php if('7' == old('type', $record->purchase_status )): ?> selected="selected" <?php endif; ?>>Proceed To Maintenance</option>
														</select>
													</div>
												</div>		
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control" name="dm_status[]" onChange="statusUpdate3(this.value)">
															<option value="0" <?php if('0' == old('type', $record->dm_status )): ?> selected="selected" <?php endif; ?>>Pending</option>
															<option value="1" <?php if('1' == old('type', $record->dm_status )): ?> selected="selected" <?php endif; ?>>Approved</option>
															<option value="2" <?php if('2' == old('type', $record->dm_status )): ?> selected="selected" <?php endif; ?>>Reject</option>
														</select>
													</div>
												</div>		
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control" name="pm_status[]" onChange="statusUpdate4(this.value)">
															<option value="0" <?php if('0' == old('type', $record->pm_status )): ?> selected="selected" <?php endif; ?>>Pending</option>
															<option value="1" <?php if('1' == old('type', $record->pm_status )): ?> selected="selected" <?php endif; ?>>Approved</option>
															<option value="2" <?php if('2' == old('type', $record->pm_status )): ?> selected="selected" <?php endif; ?>>Reject</option>
														</select>
													</div>
												</div>
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control" name="status[]" onChange="statusUpdate(this.value)">
															<option value="0" <?php if('0' == old('type', $record->status)): ?> selected="selected" <?php endif; ?>>Pending</option>
															<option value="1" <?php if('1' == old('type', $record->status)): ?> selected="selected" <?php endif; ?>>Approved</option>
															<option value="2" <?php if('2' == old('type', $record->status)): ?> selected="selected" <?php endif; ?>>Reject</option>
														</select>
													</div>
												</div>	
												...
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<select class="form-control branch_id select-multiple_2" name="branch_id[]" data-id>
															...
															?>
															<?php $__currentLoopData = $branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option value="<?php echo e($bData->id); ?>" ><?php echo e($bData->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>															
														</select>	
													</div>
												</div>
												...
												<div class="col-md-3 col-3">
													<div class="form-group">
														...
														<select class="form-control select-multiple_2" name="emp_id[]" required>
															<option value="">Select</option>
															<?php $__currentLoopData = $employee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>															
																<option value="<?php echo e($value->id); ?>" ><?php echo e($value->name); ?> - <?php echo e($value->register_id); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</select>												
													</div>
												</div>
													...
													<div class="col-lg-6">
														<div class="form-group">
															...
															<select class="form-control product_data select-multiple_2"  name="product[]" required data-id>												
																...
																?>
																<?php $__currentLoopData = $proData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $proDataValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<option value="<?php echo e($proDataValue->id); ?>" <?php echo e(old('sub_cat_id', !empty(old('sub_cat_id')) && $proDataValue->id == old('sub_cat_id') ? 'selected' : '' )); ?>><?php echo e($proDataValue->cat_name); ?> - <?php echo e($proDataValue->scat_name); ?> - <?php echo e($proDataValue->name); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="col-md-2 col-2">
													<div class="form-group">
														...
														<select class="form-control" name="uom[]">
															...
															<?php $uom = DB::table('uom')->get(); ?>
															<?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($val->code); ?>" <?php echo e(old('sub_cat_id', !empty(old('sub_cat_id')) && $proDataValue->id == old('sub_cat_id') ? 'selected' : '' )); ?>><?php echo e($val->code); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>															
														</select>	
													</div>
												</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div>
						...
						<a href="<?php echo e(asset('laravel/public/product-import.xlsx')); ?>" title="Click Here" download>Sample File</a>
					</div>
				</div>
				<div class="modal-footer">
...
<div class="modal fade bd-example-modal-xl" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl text-dark" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo e(route('admin.request.po-request')); ?>" method="post" enctype="multipart/form-data" class="po_request_new">
				<?php echo csrf_field(); ?>
				<div class="modal-body">
					<div class=" px-2"> 
						<div class="row match-height">
											...
											<div class="col-md-6 col-12 pl-4 comleft">
												...
												<select name="company" class="select-multiple2 form-control blankvalue" onChange="getCompanydetails(this.value)">
													...
													<?php foreach($buyer as $b){ ?>
														<option value="<?php echo e($b->id); ?>"><?php echo e($b->name); ?> - (V<?php echo e($b->id); ?>)</option>
													<?php } ?>
												</select>
												<div class="fill-name">												
													...
													<tr class="gethtml1">
														...
														<td>
															...
															<select name="uom[]" class="w-100 uom1">
																...
																<?php $uom = DB::table('uom')->get(); ?>
																<?php $__currentLoopData = $uom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option value="<?php echo e($val->code); ?>"><?php echo e($val->code); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															</select>
														</td>
...
<script type="text/javascript">
	...
	$("body").on('change','.sub_product',function(){
		...
		if (sub_cat_id) {
			$.ajax({
				type : 'POST',
				url : '<?php echo e(route('admin.product.get-sub-product')); ?>',
				data : {'_token' : '<?php echo e(csrf_token()); ?>', 'sub_cat_id': sub_cat_id},
				dataType : 'html',
				success : function (data){
	...
	$("body").on('change','.product_id',function(){
		...
		if (pro_id) {
			$.ajax({
				type : 'POST',
				url : '<?php echo e(route('admin.check-product-quantity')); ?>',
				data : {'_token' : '<?php echo e(csrf_token()); ?>', 'pro_id': pro_id},
				dataType : 'html',
				success : function (data){
					console.log(data);
					$('.product_qty').empty();
	...
	$("body").on("change",".options",function(){ 
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.request.get-product-item')); ?>',
	...
	$("#submit_import_file").submit(function(e) {
		...
		if(validatorprice.valid()){
			...
			$.ajax({
				...
				type: "POST",
				url : '<?php echo e(route('admin.request.mrl-import')); ?>',
				data : dataForm,
				processData : false, 
				contentType : false,
				dataType : 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/request/edit_requisition.blade.php ENDPATH**/ ?>