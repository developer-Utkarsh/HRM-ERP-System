							...
							<div class="card-content collapse show">
								<div class="card-body">
									<div class="users-list-filter">
										<form action="<?php echo e(route('faculty-leave-report')); ?>" method="get" name="filtersubmit">
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-lg-3">											
													...
													<fieldset class="form-group">																					
														<input type="month" name="fmonth"  value="<?php echo e(app('request')->input('fmonth')); ?>" class="form-control fmonth" >	
												...
												<div class="col-12 col-sm-6 col-lg-3 pt-4" style="display:;" >
													...
													<a href="<?php echo e(route('faculty-leave-report')); ?>?faculty_id=<?php echo e($user_id); ?>" class="btn btn-warning">Reset</a>						
												</div>	
											</div>
										</form>
									</div>
								...
								<div class="all_report">									
									<table class="table table-bordered  bg-light text-center">
										...
										<tbody>		
											...
											<tr>												
												<td><?=$i;?></td>
												<td><?php echo e(date('d-m-Y',strtotime($fi->date))); ?></td>
												<td>
													<?php 
													if(!empty($fi->reason)){	
														echo $fi->reason; 
...
<?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/faculty-leave.blade.php ENDPATH**/ ?>