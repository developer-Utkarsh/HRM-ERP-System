						...
						<div class="card-body pt-0">
							<div class="chart-info d-flex justify-content-between">
								<div class="text-center">
									...
									<a href="#"><span class="font-large-1"><?php echo e($totalMrl); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">WRL Generated</p>
									<a href="#"><span class="font-large-1"><?php echo e($totalWrl); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">PO Generated</p>
									<a href="#"><span class="font-large-1"><?php echo e($totalPO); ?></span></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body pt-0">
							<div class="chart-info d-flex justify-content-between">
								<div class="text-center">
									...
									<a href="#"><span class="font-large-1"><?php echo e($store_pending); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">Purchase</p>
									<a href="#"><span class="font-large-1"><?php echo e($purchase_pending); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">PO Approval</p>
									<a href="#"><span class="font-large-1"><?php echo e($po_approval_pending); ?></span></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body pt-0">
							<div class="chart-info d-flex justify-content-between">
								<div class="text-center">
									...
									<a href="#"><span class="font-large-1"><?php echo e($total_report[0]->pocount); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">Work Order</p>
									<a href="#"><span class="font-large-1"><?php echo e($total_report[0]->wocount); ?></span></a>
								</div>
								<div class="text-center">
									<p class="mb-50">Rejected</p>
									<a href="#"><span class="font-large-1"><?php echo e($total_report[0]->total_rejected); ?></span></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body pt-0">
							<div class="chart-info d-flex justify-content-between">
								<div class="text-center">
									...
									<a href="#"><span class="font-large-1"><?php echo e($total_report[0]->total_amount); ?></span></a>
								</div>								
							</div>
						</div>
					</div>
...
<div class="modal fade bd-example-modal-lg" id="rollback" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<form action="<?php echo e(route('admin.mrl-rollback')); ?>" method="post"/>
			<?php echo csrf_field(); ?>
...
<script type="text/javascript">
	...
	$(".mrl_no").blur(function(){
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.get-mrl-details')); ?>',
			data : {'_token' : '<?php echo e(csrf_token()); ?>', 'mrl_no': mrl_no},
			dataType : 'html',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/request/store-purchase-dashboard.blade.php ENDPATH**/ ?>