...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
	...
	<script>
		$(".EndDateClass").change(function () {
			var startDate = document.getElementsByClassName("StartDateClass")[0].value;
			if(startDate !=''){
				var endDate = document.getElementsByClassName("EndDateClass")[0].value;
			 
				if ((Date.parse(endDate) < Date.parse(startDate))) {
					alert("To date should be greater than From date");
					document.getElementsByClassName("EndDateClass")[0].value = "";
				}
			}
			else{
...
<?php /**PATH /var/www/html/laravel/resources/views/layouts/without_login_admin.blade.php ENDPATH**/ ?>