...
function showDiv(e, branch_id){
	...
	if (branch_id) {
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('studiomanager.get-studio-by-branch-cm')); ?>',
...
function getSubjectFaculty(val,ress){
	...
	if(subject_id){
		...
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('studiomanager.get-subject-history')); ?>',
			data : {'_token' : '<?php echo e(csrf_token()); ?>', 'subject_id': subject_id,'sublocation':sublocation},
			dataType : 'json',
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/timetable/indexcm.blade.php ENDPATH**/ ?>