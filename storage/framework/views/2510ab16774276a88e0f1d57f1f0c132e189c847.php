					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.timetable.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
				...
				<script type="text/javascript">
					...
					$(document).on("change", ".batch_accord_subjects", function () {
						...
						if (subject_id && course_id) {
							$.ajax({
								type : 'POST',
								url : '<?php echo e(route('admin.get-chapter')); ?>',
					...
					$(".start_class").on("click", function() {
						...
						if(timetable_id){
							$.ajax({
								...
								type: "POST",
								url : '<?php echo e(route('admin.startclass.store')); ?>',
					...
					$(".end_class").on("click", function() {
						...
						if(class_type=="online"){
							...
							if(class_status == 'Partially' || class_status == 'End Class'){
								$.ajax({   
									type: "POST",
									url : '<?php echo e(route('admin.partially_end_class_data')); ?>',
						...
						if(end_date != "" || class_type=='online'){ 
							if(timetable_id){
								$.ajax({
									...
									type: "POST",
									url : '<?php echo e(route('admin.endclass.update')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/timetables/index.blade.php ENDPATH**/ ?>