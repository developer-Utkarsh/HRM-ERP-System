		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Holiday</h2>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.holiday.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3" style="display:none;">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple type" name="type">
													<?php $type = array('Public' => 'Public','Optional' => 'Optional'); ?>
													<option value="">Select Any</option>
													...
													<option value="<?php echo e($key); ?>" <?php if( app('request')->input('type') != '' && $key == app('request')->input('type')): ?> selected="selected" <?php endif; ?>><?php echo e($value); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>												
											</fieldset>
										</div>
						...
						<tbody>
							<?php if(count($holiday) > 0): ?>
								...
								<tr>
									...
									<td class="product-category"><span class="btn btn-sm btn-outline-<?php echo e($clr); ?>"><?php echo e($sts); ?></span></td>
									<td class="product-action">
										<a href="<?php echo e(route('admin.holiday.edit', $value->id)); ?>">
											<span class="action-edit"><i class="feather icon-edit"></i></span>
										</a>
										<a href="<?php echo e(route('admin.holiday.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Holday')">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/holiday/index.blade.php ENDPATH**/ ?>