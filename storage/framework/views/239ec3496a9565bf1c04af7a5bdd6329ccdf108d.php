		...
		<div class="content-body">
			<section id="data-list-view" class="data-list-view-header">
				<div class="text-right pb-2">
					<a href="<?php echo e(route('employee-details',[$sess_emp_id,$type])); ?>" class="btn-dark p-1">Back</a>
				</div>
				<div class="card mb-1">
				...
				<div class="card mb-1">
					<div class="card-content collapse show">
						<div class="card-body">
							<form class="" action="<?php echo e(route('employee-requisition-list',[$sess_emp_id,$type])); ?>" method="get">
								<div class="form-group">
									<input type="text" class="form-control" name="mrl_number" value="<?php echo e(app('request')->input('mrl_number')); ?>" placeholder="MRL Number">
								</div>
								<div class="text-right">
									<button type="submit" class="btn btn-success">Submit</button> &nbsp;
									<button type="button" class="btn btn-primary" onclick="location.href = '<?php echo e(route('employee-requisition-list',[$sess_emp_id,$type])); ?>';">Reset</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="card-content">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-7 font-weight-bold text-primary">: REQ-<?php echo e($value->unique_no); ?></div>
							</div>
							...
							<div class="row" style="padding-top:5px;">
								...
								<div class="col-7">: <?php echo e($value->emp_name); ?> </div>
							</div>
							<div class="row" style="padding-top:5px;">
								<div class="col-5 font-weight-bold">Product Title</div>
								<div class="col-7">: <?php echo e($value->title); ?>  <?php if(!empty($value->image)){ ?>- <a href="<?php echo e(asset('laravel/public/quotation/' . $value->image)); ?>" download >Preview</a><?php } ?></div>
							</div>
							<div class="row" style="padding-top:5px;">
								<div class="col-5 font-weight-bold">Product Description</div>
								<div class="col-7">: <?php echo e($value->requirement); ?></div>
							</div>
							<div class="row" style="padding-top:5px;">
								<div class="col-5 font-weight-bold">Qty</div>
								<div class="col-7">: <?php echo e($value->qty); ?></div>
							</div>
							<div class="row" style="padding-top:5px;">
							...
							<div class="row" style="padding-top:5px;">
								...
								<div class="col-7">: <?php echo e($value->pname); ?></div>
							</div>
							<div class="row" style="padding-top:5px;">
							...
							<div class="row" style="padding-top:5px;">
								...
								<div class="text-center w-100">
									<?php if(($value->purchase_status==2 || $value->purchase_status==4 || $value->it_status==1) && $value->product_status==0): ?>
										<a href="javascript:void(0)" title="Accept" data-id="<?php echo e($value->id); ?>" class="product_accept btn-success" style="padding:5px 20px;">Accept</a>
									<?php elseif($value->product_status==1): ?>
										<hr>
										<?php if($value->request_type=='0' && $value->inventory_status==0 && $value->type=='Asset'){ ?>
										<a href="javascript:void(0)" title="Accept" data-id="<?php echo e($value->id); ?>" data-product-id="<?php echo e($value->product_id); ?>" class="product_return btn-danger" style="padding:5px;">Return</a>
										<?php 
...
</html><?php /**PATH /var/www/html/laravel/resources/views/employee-requisition.blade.php ENDPATH**/ ?>