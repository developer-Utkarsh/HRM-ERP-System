					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(url('admin/attendence-record')); ?>" method="get" name="filtersubmit">
									...
									<div class="row">
										...
										<div class="col-md-3">
											...
											<fieldset class="form-group">
												<input type="text" class="form-control name" id="se_name" name="name" placeholder="Name, EMP Code" value="<?php if(!empty(app('request')->input('name'))): ?><?php echo e(app('request')->input('name')); ?><?php endif; ?>">
											</fieldset>
										</div>
										<?php endif; ?>
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control start_date" name="start_date" value="<?php if(!empty(Request::get('start_date'))): ?><?php echo e(Request::get('start_date')); ?><?php else: ?><?php echo e($start_date); ?><?php endif; ?>">
											</fieldset>
										</div>
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control end_date" name="end_date" value="<?php if(!empty(Request::get('end_date'))): ?><?php echo e(Request::get('end_date')); ?><?php else: ?><?php echo e($end_date); ?><?php endif; ?>">
											</fieldset>
										</div>
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<select class="form-control get_role status" id="se_status" name="status">
													...
													<option value="1" <?php if('1' == app('request')->input('status')): ?> selected="selected" <?php endif; ?>>Active</option>
													<option value="0" <?php if('0' == app('request')->input('status')): ?> selected="selected" <?php endif; ?>>Inactive</option>
												</select> 
											</div>
										</div>
										<!--div class="col-md-2">
...
$.fn.serializeObject = function() {
    ...
    $(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.attendance.attendence-record-detail')); ?>",
		     "dataType": "json",
		     "type": "post",
			 "data": function(data){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/attendancerecord.blade.php ENDPATH**/ ?>