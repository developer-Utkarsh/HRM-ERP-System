					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.leave.leave-full-detail')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<?php
										...
										<div class="col-12 col-md-3">
											...
											<fieldset class="form-group">
												<input type="text" class="form-control search" name="search" placeholder="Ex:Name, Mobile, Employee Code" value="<?php echo e(app('request')->input('search')); ?>" id="myInputSearch">
											</fieldset>
										</div>
										...
										<div class="col-12 col-md-3 branch_loader">
											...
											<fieldset class="form-group">												
												<input type="date" class="form-control from_date" placeholder="Date" name="from_date" value="<?php echo e(app('request')->input('from_date')); ?>">
											</fieldset>
										</div>
										...
										<div class="col-12 col-md-3 branch_loader">
											...
											<fieldset class="form-group">												
												<input type="date" class="form-control to_date" placeholder="Date" name="to_date" value="<?php echo e(app('request')->input('to_date')); ?>">
											</fieldset>
										</div>
										...
										<div class="col-12 col-md-4">
											...
											<fieldset class="form-group" >		
												...
												<a href="<?php echo e(route('admin.leave.leave-full-detail')); ?>" class="btn btn-warning">Reset</a>
				...
				<table class="table data-list-view" >
					<thead>
						<tr>
							...
							<th style="" colspan="3">Availed Leave</th>
							<th colspan="3">Taken Leave</th>
							<th colspan="4">Reamained Leave</th>
						...
						<tr>
							...
							<th style="width:;background-color:yellow;">Probation date</th>
				...
				if (count($get_data) > 0) { 
					foreach ($get_data as $leave) {
						...
						if($is_comp_off){
							...
							else if($leave->branch_location=='prayagraj'){
								$holiday_location = 4;
							}
								...
								foreach($get_holiday as $get_holiday_val){
									if(!empty($get_holiday_val->branch_id)){
										...
										if($get_holiday_val->type =='Employee'){
											if(!empty($leave->id) && !empty($holiday_branch) && in_array($leave->id, $holiday_branch)){
						...
						?>
							...
							<td>
							<?php
							echo (!empty($leave->joining_date))?date('d/m/Y',strtotime($leave->probation_from)):'';
							/* if($leave->status==0){
							...
							<?php $total_reamining = $remaining_pl + $remaining_cl + $remaining_comp_off;?>
							...
							<td>
								<a href="javascript:void(0);" data-user_id="<?php echo e($leave->id); ?>" class="view_history">View History</a>
							</td>
...
<script src="<?php echo e(asset('laravel/public/js')); ?>/table2csv.js"></script>
...
$(".view_history").on("click",function(e) {
		...
		$.ajax({
			...
			type: "POST",
			url : '<?php echo e(route('admin.leave-full-detail-history')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/leave/leave_full_detail.blade.php ENDPATH**/ ?>