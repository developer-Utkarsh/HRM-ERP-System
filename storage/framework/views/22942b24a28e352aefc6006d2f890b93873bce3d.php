			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.freelancer.index')); ?>" class="btn btn-primary">Back</a>
					</div>
				</div>
			</div>
		</div>
					...
					<table class="table data-list-view" id="">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?php echo e(route('admin.freelancer.freelancer-invoice-download',$r->id)); ?>">Print</a></td>
							</tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/freelancer/invoice_history.blade.php ENDPATH**/ ?>