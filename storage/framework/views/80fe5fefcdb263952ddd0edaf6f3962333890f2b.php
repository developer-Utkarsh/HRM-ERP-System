		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
				...
				<div class="col-md-12 btn-dark text-center text-light" style="margin-top: 15px;border-radius: 10px;" >		
					<a href="<?php echo e(asset('laravel/public/chanakya-employee-management.pdf')); ?>" class="btn clickonloader" style="color:#fff !important;width:100%;"><strong>चाणक्य की भूमिका </strong></a> 
				</div>
				...
				if(count($mentor_batch_list) > 0){
					...
					<div class="col-md-12 btn-dark text-center text-light" style="margin-top: 15px;border-radius: 10px;" >		
						<a href="<?php echo e(route('mentor-report-batch-detail')); ?>?batch_id=<?=$val['batch_id']?>&&mentor_id=<?=$val['mentor_id']?>" class="btn clickonloader" style="color:#fff !important;width:100%;">Batch Name -  <strong><?=$val['batch_name']?></strong></a> 
					</div>
...
<?php echo $__env->make('layouts.without_login_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/chanakya_reports.blade.php ENDPATH**/ ?>