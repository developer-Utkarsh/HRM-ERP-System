											...
											<table class="table1" cellpadding="1" style="width: 100%;font-size: 14px;border: solid 1px #dee2e6;">
												<tbody>
													...
													<tr style="">												
														...
														<td style="font-size: 13px;"><?php echo !empty($value->cdate) ? $value->cdate : ''; ?></td>
...
</script><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/batch_reports/pdf_html.blade.php ENDPATH**/ ?>