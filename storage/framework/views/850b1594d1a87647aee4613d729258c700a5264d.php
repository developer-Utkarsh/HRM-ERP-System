					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('studiomanager.chapters.update', $chapter->id)); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-6 col-12" id="course_loader">
													<div class="form-group">
														...
														<select class="form-control course_id select-multiple1" name="course_id">
															...
															<option value="<?php echo e($value->id); ?>" <?php if($value->id == $chapter->course_id): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control subject_id select-multiple1" name="subject_id">
															<?php if(isset($chapter->subject_id) && !empty($chapter->subject_id)): ?>
															<option value="<?php echo e($chapter->subject_id); ?>"><?php echo e($chapter->subject->name); ?></option>
															<?php endif; ?>
														</select>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														<label for="first-name-column">Chapter Name</label>
														<input type="text" class="form-control" placeholder="Chapter Name" name="name" value="<?php echo e(old('name', $chapter->name)); ?>">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="duration" class="form-control" value="<?php echo e(old('duration', $chapter->duration)); ?>" placeholder="Duration">
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group d-flex align-items-center mt-2">
														...
														<label>
															<input type="radio" name="status" value="1" <?php echo e(($chapter->status == 1) ? "checked" : ""); ?>>
															Active
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="status" value="0" <?php echo e(($chapter->status == 0) ? "checked" : ""); ?>>
															Inactive
														</label>
													</div>
												</div>                                       
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/chapter/edit.blade.php ENDPATH**/ ?>