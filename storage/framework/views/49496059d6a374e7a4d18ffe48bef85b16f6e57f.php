					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.free-assistant-reports')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('admin.free-assistant-reports')); ?>" class="btn btn-warning">Reset</a>
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_free_assistant_excel", function (e) {
		...
		window.location.href = "<?php echo URL::to('/admin/'); ?>/free-assistant-report-excel?" + Object.keys(data).map(function (k) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/free_assistant_reports/index.blade.php ENDPATH**/ ?>