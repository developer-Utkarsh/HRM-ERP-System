	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="content-header-left col-md-3 col-12 mb-2 text-right">
				<a class="btn btn-primary" href="<?php echo e(route('studiomanager.course.index')); ?>">Back</a>
			</div>
		</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/course/view.blade.php ENDPATH**/ ?>