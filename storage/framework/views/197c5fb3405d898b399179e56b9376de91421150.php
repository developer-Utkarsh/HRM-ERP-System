	...
	<div class="content-wrapper" style="margin-top: 0px !important;">
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
                ...
                <span class="float-right"><a href="<?php echo e(route('acge','isFaculty')); ?>?export=yes" target="_blank">Export</a></span>
...
<?php echo $__env->make('layouts.without_login_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/all_reports/complaint-faculty.blade.php ENDPATH**/ ?>