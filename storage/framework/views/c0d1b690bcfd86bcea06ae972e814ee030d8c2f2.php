		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Remove Supervisor</h2>
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Home</a>
								</li>
								<li class="breadcrumb-item active"><a href="#">Remove Supervisor</a>
								</li>
							</ol>
						</div>
					</div>
				...
				<div class="row match-height">
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<h5 class="mb-2">Remove Supervisor By Department</h5>
									<form class="form" action="<?php echo e(route('admin.remove-supervisor-by-department')); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										<?php echo csrf_field(); ?>
										<div class="form-body"> 
											<div class="row">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<h5 class="mb-2">Remove Supervisor By Employees</h5>
									<form class="form" action="<?php echo e(route('admin.remove-supervisor-by-employee')); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										<?php echo csrf_field(); ?>
										<div class="form-body"> 
											<div class="row">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<h5 class="mb-2">Remove Supervisor By Branch</h5>
									<form class="form" action="<?php echo e(route('admin.remove-supervisor-by-branch')); ?>" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										<?php echo csrf_field(); ?>
										<div class="form-body"> 
											<div class="row">
												<div class="col-md-4 col-12">
														...
														<select class="form-control select-multiple branch_id" name="branch_id[]" multiple>
															...
															<?php if(count($branch_list) > 0): ?>
																<?php $__currentLoopData = $branch_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<option value="<?php echo e($value->id); ?>" <?php if($value->id == old('from_branch')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															<?php endif; ?>
														</select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/employee/remove-supervisor.blade.php ENDPATH**/ ?>