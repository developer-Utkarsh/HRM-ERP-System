		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.faculty-topic')); ?>" method="get" name="filtersubmit">										
									<div class="row">											
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple faculty_id" name="faculty_id">
													...
													<?php $__currentLoopData = $faculty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($fa->id); ?>" <?php if($fa->id == app('request')->input('faculty_id')): ?> selected="selected" <?php endif; ?>><?php echo e($fa->name); ?></option>
										...
										<div class="col-12 col-sm-6 col-lg-3">											
											...
											<fieldset class="form-group">															
												<input type="text" name="erp_id"  placeholder="" value="<?php echo e(app('request')->input('erp_id')); ?>" class="form-control erp_id" >	
											</fieldset>	
										</div>
										<div class="col-12 col-sm-6 col-lg-4">
											...
											<fieldset class="form-group">												
												...
												<a href="<?php echo e(route('admin.faculty-topic')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>	
									</div>
								</form>
				...
				<div class="table-responsive">
					...
					<?php echo $cards->appends($params)->links(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/faculty_reports/faculty_topic.blade.php ENDPATH**/ ?>