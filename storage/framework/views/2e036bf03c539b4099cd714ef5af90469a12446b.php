					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.course-planner.batchReports')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">
												<select class="form-control" name="indicator">
													<option value=""> - Select - </option>													
													<option value="10" <?php if(app('request')->input('indicator') =='10'): ?> selected="selected" <?php endif; ?>>Red</option>
													<option value="-10" <?php if(app('request')->input('indicator') =='-10'): ?> selected="selected" <?php endif; ?>>BLue</option>
													<option value="1" <?php if(app('request')->input('indicator') =='1'): ?> selected="selected" <?php endif; ?>>Green</option>
												</select>												
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">
												<select class="form-control" name="percentage_batch_complete">
													...
													<?php for($i=5;$i<=100;$i=$i+5){ ?>											
													  <option value="<?=$i;?>" <?php if(app('request')->input('percentage_batch_complete') ==$i): ?> selected="selected" <?php endif; ?> ><?=$i;?></option>
													<?php } ?>
												</select>												
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">
												<input type="number" name="possible_delay" class="form-control" value="<?php echo e(app('request')->input('possible_delay')); ?>" placeholder=">=">
											</fieldset>
										</div>
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">
												<select class="form-control" name="batch_status">
													<option value=""> - Select - </option>													
													<option value="1" <?php if(app('request')->input('batch_status') =='1'): ?> selected="selected" <?php endif; ?>>Completed</option>
													<option value="2" <?php if(app('request')->input('batch_status') =='2'): ?> selected="selected" <?php endif; ?>>Running</option>
												</select>												
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">
												<input type="number" name="erp_id" class="form-control" value="<?php echo e(app('request')->input('erp_id')); ?>" placeholder="Enter ERP ID">
											</fieldset>
										</div>

										<div class="col-12 col-sm-6 col-lg-3">
											<button type="submit" class="btn btn-primary mt-1">Search</button>
											<a href="<?php echo e(route('admin.course-planner.batchReports')); ?>" class="btn btn-warning mt-1">Reset</a>
										</div>
									</div>
								</form>
							</div>
		            ...
		            font-size:22px;
						...
						<table class="table data-list-view">
							...
							<tbody>	
								...
								<tr>
									<td>
										<a href="javascript:void(0)"  data-id="<?php echo e($br->batch_id); ?>" class="get_edit_data text-primary">Subject Status</a>
									</td>
									<td><?php echo e($i); ?></td>
									<td><?php echo e($br->course_name); ?></td>
									<td><?php echo e($br->batch_name); ?></td>
									<td><?php if($br->erp_course_id!=0){ echo $br->erp_course_id; }else{ echo '-'; } ?></td>
									<td><?php echo e($br->batch_duration_hours); ?> Hours</td>
									<td><?php echo e($br->batch_schedule_hours); ?> Hours</td>
									<td><?php echo e($br->batch_spent_time_hours); ?> Hours</td>
									<td><?php echo e($br->batch_topic_completed_hours); ?> Hours</td>
									<td><?php echo e($br->percentage_batch_complete); ?>% </td>
									<td><?php echo e($br->batch_duration_days); ?> Days</td>
									...
									<td><?php echo e($br->avg_class_duration); ?> Hours</td>
									<td><?php echo e($br->required_days); ?> Days</td>
									<td><?php echo e($br->possible_delay); ?> Days</td>
									<td><?php echo e($br->expected_end_date); ?></td>
									<td><?php echo e($br->additions_planner); ?> Hours</td>
									<td>
						...
						<?php echo $batch_report->appends($params)->links(); ?>
...
<script type="text/javascript">
	$(".get_edit_data").on("click", function() {  
		...
		$('.levelStatus').attr("href", '<?php echo e(route('admin.batch.view')); ?>/'+batch_id);
		
		
		$.ajax({
			type : 'GET',
			url : '<?php echo e(route('admin.course-planner.batchSubjectReports')); ?>/'+batch_id,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/report/course_planner/batch.blade.php ENDPATH**/ ?>