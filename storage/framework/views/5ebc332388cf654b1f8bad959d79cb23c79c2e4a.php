					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('test-report')); ?>" method="get" name="filtersubmit">
									<div class="row">
										
										<input type="hidden" name="user_id" class="faculty_id_get" name="" value="<?php echo e(app('request')->input('user_id')); ?>">
										
										
										<div class="col-12 col-sm-6 col-lg-3">											
											<label for="users-list-status">Date</label>								
											<fieldset class="form-group">																					
												<input type="date" name="fdate" placeholder="Date" value="<?php echo e($selectFromDate); ?>" class="form-control StartDateClass fdate">	
											</fieldset>	
										</div>	
										<div class="col-12 col-md-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple2 batch_id" name="batch_id">
													...
													<option value="<?php echo e($value->batch_id); ?>" <?php if($value->batch_id == app('request')->input('batch_id')): ?> selected="selected" <?php endif; ?>><?php echo e($value->batch_name); ?></option>
								...
								<tr style="border-bottom-style:hidden;color:#000 !important;">
									...
									<td class=""> 
										<?php if(date('Y-m-d',strtotime($selectFromDate. ' +2 day')) >= date('Y-m-d')){?>
											<a href="<?php echo e(route('test-report-update')); ?>?user_id=<?php echo e($user_id); ?>&tt_id=<?php echo e($get_faculty_timetable_value->id); ?>" class="btn btn-dark" style="color:#fff !important;margin-bottom: 5px;"> Update </a> &nbsp;
										<?php } ?>
										
										<?php if($check_update > 0){ ?>
										<a href="<?php echo e(route('test-report-view')); ?>?user_id=<?php echo e($user_id); ?>&tt_id=<?php echo e($get_faculty_timetable_value->id); ?>" class="btn btn-dark" style="color:#fff !important;margin-bottom: 5px;"> View </a>
										
										<a href="<?php echo e(route('test-report-download')); ?>?user_id=<?php echo e($user_id); ?>&tt_id=<?php echo e($get_faculty_timetable_value->id); ?>" class="btn btn-dark" style="color:#fff !important;margin-bottom: 5px;"> Download </a>
										<?php } ?>
...
<?php echo $__env->make('layouts.without_login_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/webview_reports/schedule_test.blade.php ENDPATH**/ ?>