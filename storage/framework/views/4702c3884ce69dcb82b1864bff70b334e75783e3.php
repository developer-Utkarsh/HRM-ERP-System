		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-8">
						<h2 class="content-header-title float-left mb-0">PO / WO List</h2>
							...
							<div class="users-list-filter">
								<form action="" method="get" name="filtersubmit">
									<div class="row">
										...
										<?php 										
											if( Auth::user()->role_id ==29 || Auth::user()->role_id ==31 || Auth::user()->id ==6828 || Auth::user()->id == 6859 || Auth::user()->department_type == 10){
										?>
										<div class="col-12 col-sm-6 col-lg-2">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											if(!empty($vendor_id)){
												$branches->where('id', $vendor_id);
											}
											$buyer = $buyer->orderBy('id','desc')->get();											
											?>
											<fieldset class="form-group">												
												<select class="form-control select-multiple1 vendor" name="vendor">
													<option value="">Select</option>													
													...
													<option value="<?php echo e($value->id); ?>" <?php if($value->id == app('request')->input('vendor')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													<?php endif; ?>
												</select>												
											</fieldset>
										...
										<div class="col-12 text-right">
											...
											<a href="<?php echo e(route('admin.request.po-list')); ?>" class="btn btn-warning">Reset</a>
						...
						<tbody>			
							<?php if(count($notification) > 0): ?>
								...
								<tr style="">
									...
									<td>
										<?php if( Auth::user()->role_id ==31 || Auth::user()->department_type ==10){ ?>
										<a href="javascript:void(0)" title="Click" data-id="<?php echo e($value->request_id); ?>" class="get_invoice_data text-primary">
...
<div class="modal fade" id="invoicePop" tabindex="-1" role="dialog">
	<form action="<?php echo e(route('admin.invoice-details')); ?>" method="post" class="form"  enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="pt-2">
						<label>Vendor</label>
						<select name="vendor" class="form-control select-multiple2" required>
							<option value="">-- Select --</option>
							<?php 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/request/po-list.blade.php ENDPATH**/ ?>