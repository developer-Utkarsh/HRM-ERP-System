						...
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.attendance.rpattendance')); ?>" method="get" name="filtersubmit">
									...
									<button type="button" class="btn btn-primary search_click">Search</button>
								
									<a href="<?php echo URL::to('/admin/absent-full-attendence'); ?>" class="btn btn-warning">Reset</a>
...
$("body").on("click", "#download_excel", function (e) {
	...
	window.location.href = "<?php echo URL::to('/admin/'); ?>/absent-full-attendance-report-excel?" + Object.keys(data).map(function (k) {
...
$.fn.serializeObject = function() {
    ...
    $(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.attendance.absent-full-attendence-detail')); ?>",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/absentfullattendence.blade.php ENDPATH**/ ?>