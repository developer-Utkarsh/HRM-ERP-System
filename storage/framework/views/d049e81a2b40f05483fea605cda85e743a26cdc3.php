		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4">
						<a class="btn btn-primary" style ="float:right;" href="<?php echo url('admin/category-discount-add') ?>">Add Paternity Leave</a>
					</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/discountApprovel/category_discount.blade.php ENDPATH**/ ?>