												...
												<div class="row">
													<div class="col-md-6 col-12">
														<div class="form-group">
															...
															<input type="date" class="form-control date" placeholder="Date" name="date[]" value="<?=date("Y-m-d");?>"  min="<?php echo e(date('Y-m-d', time() - 86400)); ?>" required>
													...
													<div class="col-md-6 col-12">
														<div class="form-group">
															...
															<select class="form-control emp_id select-multiple1" name="emp_id[]">
																...
																<option value="<?php echo e($value->id); ?>" <?php if($value->id == old('emp_id')): ?> selected="selected" <?php endif; ?>><?=$dd;?></option>
...
<script src="<?php echo e(asset('laravel/public/js/audio_recorder.js')); ?> "></script>
<script src="<?php echo e(asset('laravel/public/js/audio_app.js')); ?> "></script>
-->
...
<script type="text/javascript">		
	...
	function formsubmit(panel, blob, filename){
		...
		$.ajax({
			...
			type		: "POST",
			url 		: '<?php echo e(route('admin.task-store')); ?>',
			data 		: dataForm,
			processData : false, 
			contentType : false,
			dataType 	: 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/get_task/add.blade.php ENDPATH**/ ?>