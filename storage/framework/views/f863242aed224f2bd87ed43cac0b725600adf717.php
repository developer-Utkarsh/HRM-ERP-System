			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.attendance.gallery')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-12 col-sm-6 col-lg-3">
											<label for="users-list-role">Employee Name</label>
											<fieldset class="form-group">
												<input type="text" class="form-control" name="name" placeholder="Name, EMP Code" value="<?php echo e(app('request')->input('name')); ?>">
											</fieldset>
										</div>
										<?php
										...
										<div class="col-12 col-sm-6 col-lg-2">
											...
											<fieldset class="form-group">
												<input type="date" name="fdate" class="form-control StartDateClass" value="<?php echo e(app('request')->input('fdate')); ?>" id="">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-2">
											<label for="users-list-verified">To</label>
											<fieldset class="form-group">
												<input type="date" name="tdate" class="form-control EndDateClass" value="<?php echo e(app('request')->input('tdate')); ?>" id="">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="<?php echo e(route('admin.attendance.gallery')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
				...
				<div class="row"> 
					...
					?>
						...
						?>
						<img src="<?php echo e(asset('laravel/public/'.$image)); ?>" style="width:100%;height:150px;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/attendance/gallery.blade.php ENDPATH**/ ?>