					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.employees.work-anniversary')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-md-3">
										...
										<div class="col-md-5">
											...
											<a href="<?php echo e(route('admin.employees.work-anniversary')); ?>" class="btn btn-warning">Reset</a>
						...
						<tbody>
							<?php if(count($employees) > 0): ?>
								...
								<tr>
									...
									<td class="product-price"><?php echo e(!empty($value->joining_date) ? date('d-m-Y',strtotime($value->joining_date)) : ''); ?></td>
								</tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/employee/work-anniversary.blade.php ENDPATH**/ ?>