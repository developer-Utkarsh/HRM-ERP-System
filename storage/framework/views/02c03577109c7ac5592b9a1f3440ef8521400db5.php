			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="<?php echo e(route('admin.add-it-deo-work-report')); ?>" class="btn btn-primary text-white">Add</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.it-deo-work-report')); ?>" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="<?php echo e(route('admin.it-deo-work-report')); ?>" class="btn btn-warning">Reset</a>
									</fieldset>
								</form>
							</div>
						</div>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo e($val->number_of); ?></td>
								<td><?php echo e($val->paper); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/typist_work_report/itdeo.blade.php ENDPATH**/ ?>