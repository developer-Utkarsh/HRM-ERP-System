		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-6">
						<a href="<?php echo e(route('admin.meeting-add')); ?>" class="btn btn-primary float-right ">Add Meeting</a>
					</div>
				</div>
			</div>
		</div>
			...
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.meeting.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="<?php echo e(route('admin.meeting.index')); ?>" class="btn btn-warning">Reset</a>
				...
				<div class="table-responsive">
					<table class="table data-list-view">
						...
						<tbody>
							<?php if(count($appointment_result) > 0): ?>
							<?php $__currentLoopData = $appointment_result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td><?php echo e($key + 1); ?></td>
								<td class="product-category"><?php echo e(!empty($value->user_name) ? $value->user_name : ''); ?></td>
								<td class="product-category"><?php echo e(!empty($value->appointment_date) ? date('d-m-Y',strtotime($value->appointment_date)) : ''); ?></td>
								<td class="product-category"><?php echo e($value->start_time); ?> <b>-</b> <?php echo e($value->end_time); ?></td>
								...
								<td class="product-category"><?php echo e(!empty($value->meeting_place_name) ? $value->meeting_place_name : ''); ?></td>
								
								<!--
								<td class="product-category"><?php echo e(!empty($value->start_time) ? $value->start_time : ''); ?></td>
								<td class="product-category"><?php echo e(!empty($value->end_time) ? $value->end_time : ''); ?></td>
								-->
								...
								<td class="">
									<a href="javascript:void(0)" title="View Employee Status" data-id="<?php echo e($value->id); ?>" data-toggle="modal" class="get_emp_data"><i class="fa fa-users" aria-hidden="true"></i></a>		
									&nbsp;
									<a href="<?php echo e(route('admin.meeting-history', $value->id)); ?>" title="View Details"><i class="feather icon-eye"></i></a>	
									&nbsp;
									
									
									<?php if($value->appointment_date >= date('Y-m-d')){ ?>
									<a href="javascript:void(0)" title="Task" data-id="<?php echo e($value->id); ?>" data-toggle="modal" class="key_point"><i class="fa fa-hand-pointer-o"></i></a>
									<?php } ?>
									
									<?php if($value->user_id == Auth::user()->id && $value->status == 1){ ?>
									<!--
									&nbsp;&nbsp;<a href="<?php echo e(route('admin.meeting-add', $value->id)); ?>" title="Reschedule" target="_blank"><i class="fa fa-repeat" aria-hidden="true"></i></a>&nbsp;&nbsp;
									-->
									...
									-->
									<a href="javascript:void(0)" title="Cancel Meeting" data-id="<?php echo e($value->id); ?>" data-toggle="modal" class="cancel_meeting"><i class="fa fa-times-circle"></i></a>
									...
									<!--
									<a href="javascript:void(0)" title="View Employee Status" data-id="<?php echo e($value->id); ?>" data-toggle="modal" class="btn btn-sm btn-success key_point">Reschedule</a>
									-->
...
<div id="key_point" class="modal fade keypoint">
    <div class="modal-dialog modal-l">
        ...
        <form method="post" id="submit_timetable_online_form" action="<?php echo e(route('admin.add-key-point')); ?>" class="online-form">
			<?php echo csrf_field(); ?>
...
<div id="cancel_meeting" class="modal fade">
    <div class="modal-dialog modal-l">
        <div class="modal-content">
			...
			<form method="post" id="submit_timetable_online_form" action="<?php echo e(route('admin.cancel-appointment-status')); ?>" class="online-form">
				<?php echo csrf_field(); ?>
				<input type="hidden" name="appointment_id" class="mid" value=""/>
				<div class="modal-body">
					<div class="form-body">				
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        $(".get_emp_data").on("click", function() { 
            ...
            $.ajax({type : 'POST',
                url : '<?php echo e(route('admin.get-appointment-status')); ?>',
                data : {'_token' : '<?php echo e(csrf_token()); ?>', 'app_id': app_id},
                dataType : 'html',
	...
	function statusUpdate(value, status){
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.update-appointment-status')); ?>',
			data : {'_token' : '<?php echo e(csrf_token()); ?>', 'value': value, 'status':status},
			dataType : 'json',
	...
	function cancelUpdate(value, status){
		$.ajax({
			type : 'POST',
			url : '<?php echo e(route('admin.cancel-appointment-status')); ?>',
			data : {'_token' : '<?php echo e(csrf_token()); ?>', 'value': value, 'status':status},
			dataType : 'json',
			success : function (data){
				if(data.status == false){
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/meeting/index.blade.php ENDPATH**/ ?>