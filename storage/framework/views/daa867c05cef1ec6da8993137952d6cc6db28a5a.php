		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-md-6">
						<h2 class="content-header-title float-left mb-0">Support Category</h2>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.support_category.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="<?php echo e(route('admin.support_category.index')); ?>" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						<?php if(count($category) > 0): ?>
							...
							<tr>
								...
								<td class="product-category">
									<a href="<?php echo e(route('admin.support_category.status', $value->id)); ?>">
								...
								<td class="product-action">
									...
									<a title="Delete Category" href="<?php echo e(route('admin.support_category.delete', $value->id)); ?>" onclick="return confirm('Are You Sure To Delete Category')">
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo e(route('admin.support_category.store')); ?>">
...
<script type="text/javascript">
	$(".get_edit_data").on("click", function() { 
		...
		if(cat_id){
			...
			$.ajax({
				type : 'POST',
				url : '<?php echo e(route('admin.edit-support-category')); ?>',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/support_category/category.blade.php ENDPATH**/ ?>