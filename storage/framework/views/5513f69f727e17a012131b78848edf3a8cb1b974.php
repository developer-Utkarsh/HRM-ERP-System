					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('studiomanager.employees.store')); ?>" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										<div class="form-body">
											<div class="row">
												<div class="col-md-4 col-12" style="display: none;">
													<div class="form-group">
														...
														<select class="form-control get_role select-multiple1" name="role_id">
															...
															<option value="<?php echo e($value->id); ?>" <?php if($value->id == 2): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
												...
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														...
														<input type="text" class="form-control com_hours" placeholder="Committed Hours" name="committed_hours" value="<?php echo e(old('committed_hours')); ?>">
													</div>
												</div>
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														<label for="first-name-column">Start Date</label>
														<input type="date" class="form-control" placeholder="Start Date" name="agreement_start_date" value="<?php echo e(old('agreement_start_date')); ?>" >
													</div>
												</div>
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														<label for="first-name-column">End Date</label>
														<input type="date" class="form-control" placeholder="End Date" name="agreement_end_date" value="<?php echo e(old('agreement_end_date')); ?>">
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control joining_date" name="joining_date" placeholder="Joining Date" value="<?php echo e(old('joining_date')); ?>">
										...
										<div class="row">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="Net Salary" name="net_salary" value="<?php echo e(old('net_salary')); ?>">
...
<?php echo $__env->make('layouts.studiomanager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/studiomanager/employee/add.blade.php ENDPATH**/ ?>