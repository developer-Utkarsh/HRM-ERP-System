<html>
	...
	<body>
		...
		<div class="text-center w-100 noPrint p-2">
			...
			<a href="<?php echo e(route('admin.request.poedit',[$id])); ?>" class="btn btn-warning mt-2">Edit</a>
			<?php } ?>
		</div>
...
<?php endif; ?>
										...
										<?php /**PATH /var/www/html/laravel/resources/views/admin/request/po.blade.php ENDPATH**/ ?>