		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-3">
						<a href="<?php echo e(route('admin.add-increment')); ?>" class="btn btn-primary float-right">Add Increment/Arrears</a>
					</div>
					<div class="col-md-3">
						<a href="<?php echo e(route('admin.add-deduction')); ?>" class="btn btn-primary float-right">Advance Deduction</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								...
								<form class="form" action="<?php echo e(route('admin.salary.salary-store-increment')); ?>" method="post" enctype="multipart/form-data">
									<?php echo csrf_field(); ?>
										...
										<div class="row">
											<div class="col-md-3 col-12">
												<div class="form-group">
													...
													<select class="form-control select-multiple" name="emp_id">
														...
														<?php if(count($employee_result) > 0): ?>
														<?php $__currentLoopData = $employee_result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee_result_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<option value="<?php echo e($employee_result_val->id); ?>"><?php echo e($employee_result_val->name); ?></option>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<?php if($errors->has('year_wise_month')): ?>
													<span class="text-danger"><?php echo e($errors->first('year_wise_month')); ?></span>
													<?php endif; ?>
													<br>
												</div>
											</div>
			...
			<section id="data-list-view" class="data-list-view-header">
				<div class="card">
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.salary.index')); ?>" method="get" name="filtersubmit">
									<div class="row">
									    <div class="col-md-3">
											<label for="users-list-role"></label>
											 <input type="text" class="form-control" placeholder="Search By Name,Email,Contact No" name="search" id="search" value="<?php if(!empty(app('request')->input('search'))): ?><?php echo e(app('request')->input('search')); ?><?php endif; ?>">
										</div>
										<?php
										...
										<div class="col-md-3">
											...
											<fieldset class="form-group">
												<input type="month" class="form-control year_wise_month" id="year_wise_month" name="year_wise_month" value="<?php echo e($search_year_month); ?>" max="<?php echo e(date('Y-m')); ?>">
											</fieldset>
										</div>
										...
										<div class="col-md-6">
											...
											<a href="<?php echo e(route('admin.salary.index')); ?>" class="btn btn-warning">Reset</a>
				...
				<input type="hidden" name="search_year_month" value="<?php echo e($search_year_month); ?>">
				<div class="row">
					<div class="col-md-6">
						<h5>Total working days of this month : <span><?php echo e($t_workday); ?></span></h5>
					</div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        var salaryTable = $('#salaryTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "<?php echo e(route('admin.salary.salary-record-detail')); ?>",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){ 
	    	...
	    	"columns": [
				...
				//   },
				  ...
				  { "data": null, render:function(data){ 
						var actionHtml ='';			
							actionHtml = '<a href="javascript:void(0)" id="download_pdf" data-id="'+data.register_id+'" data-year_wise_month="<?php echo e($search_year_month); ?>" class=""><span class="action-edit"><i class="feather icon-file-text"></i></span></a>';
					  return actionHtml; 
				  } },
		       ]				   
	...
	e.preventDefault();
		...
		$.ajax({
			...
			type: "POST",
			url : "<?php echo e(route('admin.submit-salary-adjusment')); ?>",
			data : dataForm,
			processData : false, 
			contentType : false,
			dataType : 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/salary/index.blade.php ENDPATH**/ ?>