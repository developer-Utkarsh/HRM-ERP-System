					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="<?php echo e(route('admin.holiday.update', $holiday->id)); ?>" method="post" enctype="multipart/form-data">
												...
												<div class="col-12 col-md-4 branch_loader">
													...
													<fieldset class="form-group">												
														<select class="form-control select-multiple1 branch_id" name="branch_id[]" id="" multiple>
															...
															<option value="<?php echo e($value->id); ?>"  <?php if((!empty(old('branch_id')) && $value->id == old('branch_id')) || (!empty($holiday->branch_id) && in_array($value->id, json_decode($holiday->branch_id)))): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															<?php endif; ?>
														</select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/holiday/edit.blade.php ENDPATH**/ ?>