					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.document.index')); ?>" method="get" name="employeesubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-4">
											...
											<fieldset class="form-group">
												...
												<select class="form-control get_employee select-multiple" name="emp_id">
													...
													<option value="<?php echo e($value->id); ?>" <?php if(app('request')->input('emp_id') == $value->id): ?> selected="selected" <?php endif; ?>><?php echo e($value->name ." (".$value->register_id.")"); ?></option>
							...
							<?php if(!empty(Request::get('emp_id'))): ?>
							<hr>
							<div class="row mt-2">
								...
								<input type="hidden" name="employee_id" class="employee_id" value="<?php if(!empty($get_employee->id)): ?><?php echo e($get_employee->id); ?><?php endif; ?>">
							</div>
							...
							<form method="post" id="document_submit">
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->tenth_marksheet)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->tenth_marksheet)); ?>" class="btn btn-outline-success ml-1 download-btn1" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn1">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile1" <?php if(!empty($get_emp_doc->tenth_marksheet)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->twelth_marksheet)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->twelth_marksheet)); ?>" class="btn btn-outline-success ml-1 download-btn2" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn2">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile2" <?php if(!empty($get_emp_doc->twelth_marksheet)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->graduate)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->graduate)); ?>" class="btn btn-outline-success ml-1 download-btn3" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn3">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile3" <?php if(!empty($get_emp_doc->graduate)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->postgraduate)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->postgraduate)); ?>" class="btn btn-outline-success ml-1 download-btn4" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn4">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile4" <?php if(!empty($get_emp_doc->postgraduate)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->aadhar_card)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->aadhar_card)); ?>" class="btn btn-outline-success ml-1 download-btn5" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn5">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile5" <?php if(!empty($get_emp_doc->aadhar_card)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<div class="row mt-2">
									...
									<?php if(!empty($get_emp_doc->experience_letter)): ?>
										<a href="<?php echo e(asset('laravel/public/'.'/document/'.$get_emp_doc->experience_letter)); ?>" class="btn btn-outline-success ml-1 download-btn6" download>Download</a>
										<a href="javascript:void(0)" class="btn btn-outline-primary ml-1 edit-btn6">Edit</a>
									<?php endif; ?>
									<div class="col-12 col-md-5 showfile6" <?php if(!empty($get_emp_doc->experience_letter)): ?> <?php echo e('style=display:none'); ?> <?php endif; ?>>
								...
								<input type="hidden" name="doc_id" class="doc_id" value="<?php if(!empty($get_emp_doc->id)): ?><?php echo e($get_emp_doc->id); ?><?php endif; ?>">
								<input type="hidden" name="employee_id" class="employee_id" value="<?php if(!empty($get_employee->id)): ?><?php echo e($get_employee->id); ?><?php endif; ?>">
							</form>
							<?php endif; ?>
						</div>
...
<script type="text/javascript">
	...
	function storeDocument(form, types){
		...
		$.ajax({
			...
			type: "POST",
			url : '<?php echo e(route('admin.document.store')); ?>',
			data : dataForm,
			processData : false, 
			contentType : false,
			dataType : 'json',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/employee_document/index.blade.php ENDPATH**/ ?>