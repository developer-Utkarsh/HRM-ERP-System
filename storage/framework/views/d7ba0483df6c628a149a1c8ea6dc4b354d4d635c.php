										...
										if(count($get_faculty) > 0){
													...
													<div id="collapse<?=$i?>" class="accordion-collapse collapse <?=($i==1)?'show':''?>" aria-labelledby="heading<?=$i;?>" data-bs-parent="#accordionExample">
													  ...
													  <div class="accordion-body">
														...
														<div class="tag">
															...
															<button type="button" class="btn btn-outline-secondary">
																<b>Schedule Hour  :</b> <?php echo e($schedule_total_tt); ?> Hr
															</button> 
															<button type="button" class="btn btn-outline-secondary">
																<b>Spent Hour  :</b> <?php echo e($total_tt); ?> Hr
															</button> 
															<button type="button" class="btn btn-outline-secondary">
																<b>Remaining Hour  :</b> <?php echo e($rmTime); ?> Hr
															</button>
														</div>
													  </div>
													</div>
											...
											<div class="accordion-item">
												...
												<div id="collapse<?=$i?>" class="accordion-collapse collapse <?=($i==1)?'show':''?>" data-bs-parent="#accordionExample">
												  ...
												  <div class="accordion-body">
													<strong>Faculty Name</strong> - <?=$faculty;?>
													<div class="tag"><button type="button" class="btn btn-outline-secondary">Plan Hour - <?php echo $get_subject->no_of_hours; ?> Hr</button> <button type="button" class="btn btn-outline-secondary">Schedule Hour - <?php echo e($schedule_total_tt); ?> Hr</button> <button type="button" class="btn btn-outline-secondary">Spent Hour - <?php echo e($total_tt); ?> Hr</button> <button type="button" class="btn btn-outline-secondary">Remaining Hour - <?php echo e($get_subject->no_of_hours); ?> Hr</button></div>
												  </div>
												</div>
											</div>
											<?php
					...
					<div class="accordion-item">
						...
						<div class="accordion" id="accordionExample2">
							...
							<div id="collapse<?=$i;?>" class="accordion-collapse collapse <?=($i==1)?'hide':''?>" data-bs-parent="#accordionExample2">
								<div class="accordion-body">
									<ul class="list-group list-group-flush">
										<li class="list-group-item"><strong>Total No. Student : </strong> <?php echo e($total); ?></li>
										<li class="list-group-item">
											<strong>Given : </strong><?php echo e($assign->given); ?><br>
											<strong>Pending : </strong><?php echo e($pending); ?> 
										</li>
										<li class="list-group-item"><strong>Given Date (First) : </strong> - <?php echo e(date('d-m-Y h:i:s', strtotime($value->created_at))); ?>  </li>
									</ul>
								</div>
							</div>
						</div>
...
<?php /**PATH /var/www/html/laravel/resources/views/admin/webview_reports/mentor_report_batch_detail.blade.php ENDPATH**/ ?>