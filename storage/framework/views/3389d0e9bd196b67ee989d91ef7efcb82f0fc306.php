					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="<?php echo e(route('admin.anuprati-dashboard')); ?>" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-12 col-sm-6 col-lg-3">
											<label for="users-list-verified">Reg. No.</label>
											<fieldset class="form-group">
												<input type="text" name="reg_no" class="form-control reg_no" value="<?php echo e(app('request')->input('reg_no')); ?>" id="">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple batch_id" name="batch_id">
													...
													<option value="<?php echo e($value->batch_code); ?>" <?php if($value->batch_code == app('request')->input('batch_id')): ?> selected="selected" <?php endif; ?>><?php echo e($value->name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>												
											</fieldset>
										</div>										
										<div class="col-lg-12 text-right">
											<fieldset class="form-group mb-0">		
												...
												<a href="<?php echo e(route('admin.anuprati-dashboard')); ?>" class="btn btn-warning">Reset</a>
				...
				<div class="table-responsive">
					<table class="table data-list-view" id="my-table-id">
						...
						<tbody>
							...
							<?php $i = 1; ?>
							<?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
								<?php
									$custom_where = "";
									if(Auth::user()->id!=901){
					...
					<?php echo $student->appends($params)->links(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/batchinventory/anuprati.blade.php ENDPATH**/ ?>