                                ...
                                <tr>
                                    <td colspan="2" style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                        <table width="50%" align="left" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                                     Invoice No: <?= !empty($invoice_report->invoice_no) ? $invoice_report->invoice_no : '';?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                                     Order No: <?= !empty($invoice_report->order_number) ? $invoice_report->order_number : '';?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                        ...
                                        <table width="50%" align="left" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                                     Date: <?= !empty($invoice_report->c_date) ? $invoice_report->c_date : '';?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
                                                     Order Date: <?= !empty($invoice_report->date) ? $invoice_report->date : '';?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold;color:#000;font-size:14px;line-height:1.67;padding-bottom:10px;">
...
$("body").on("click", "#download_pdf", function (e) { 
	...
	var data = {};
		...
		window.location.href = "<?php echo url('/') ?>/invoice-report-pdf/"+invoice_id;
