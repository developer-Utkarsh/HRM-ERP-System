		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-6">
						<a href="{{ route('admin.training_video.create') }}" class="btn btn-primary float-right ">Add Training Video</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.training_video.index') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="{{ route('admin.training_video.index') }}" class="btn btn-warning">Reset</a>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td class="product-category">{{ !empty($value->video_id) ? $value->video_id : '' }}</td>
								<td class="product-category">{{ !empty($value->video_url) ? $value->video_url : '' }}</td>
								...
								<td class="product-action">
									<a href="{{ route('admin.training_video.edit', $value->id) }}">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="{{ route('admin.training_video.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Knowledge Based')">
