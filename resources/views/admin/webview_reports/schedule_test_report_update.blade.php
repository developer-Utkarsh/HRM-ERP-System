             ...
             <!--  table-responsive-stack -->
				<form action="{{ route('test_report_save') }}" method="post" enctype="multipart/form-data">
					...
					<table class="table table-bordered table-striped table-condensed " id="tableOne">
										...
										<table width="100%" border="0">
											<tr style="background-color:transparent;">												
												<td class="radio-inline" width="50%">
													<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Offline" id="q7Offline" name="q21" class="q21" {{ old('q21', isset($get_detail->q21) && $get_detail->q21=='Offline'?'checked':'') }} > <label for="q7Offline">Offline</label>
												</td>
												<td class="radio-inline" width="50%">
													<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Online" id="q7Online" name="q21" class="q21" {{ old('q21', isset($get_detail->q21) && $get_detail->q21=='Online'?'checked':'') }} > <label for="q7Online">Online</label>
												</td>
											</tr>
										</table>
									</td>
						...
						<table class="table table-bordered table-striped table-condensed forHide" style="display: {{ (isset($get_detail->q21) && $get_detail->q21=='Online'?'none':'table') }}">
							...
							<tbody>
									...
									<tr style="border-bottom-style:hidden;">
										<td><input type="number" min="0" max="{{$total_admission}}" name="q2" class="" value="{{ old('q2', isset($get_detail->q2)?$get_detail->q2:'') }}" ></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
										<input type="date" name="q3" class="" value="{{ old('q3', isset($get_detail->q3)?$get_detail->q3:'') }}" style="width:100%;"></br>
										<input type="text" name="q4" class="" value="{{ old('q4', isset($get_detail->q4)?$get_detail->q4:'') }}" style="width:100%;margin-top:20px;" placeholder="Enter Name Here">
										</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
										<textarea name="q5" rows="4" style="border: none;border-bottom: dotted 1px #000;background: transparent;width: 100%;">{{ old('q5', isset($get_detail->q5)?$get_detail->q5:'') }}</textarea>
										</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
											<input type="text" name="q6" class="" value="{{ old('q6', isset($get_detail->q6)?$get_detail->q6:'') }}" style="width:100%;" placeholder="Enter Test Duration">
											<input type="number" min="1" name="q6_1" class="" value="{{ old('q6_1', isset($get_detail->q6_1)?$get_detail->q6_1:'') }}" style="width:100%;margin-top:20px;" placeholder="Enter Total Question Count">
										</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
											<table width="100%" border="0">
												<tr style="background-color:transparent;">												
													<td class="radio-inline" width="50%">
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Yes" id="q7Yes" name="q7" {{ old('q7', isset($get_detail->q7) && $get_detail->q7=='Yes'?'checked':'') }} > <label for="q7Yes">Yes</label>
													</td>
													<td class="radio-inline" width="50%">
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="No" id="q7No" name="q7" {{ old('q7', isset($get_detail->q7) && $get_detail->q7=='No'?'checked':'') }} > <label for="q7No">No</label>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr style="border-bottom-style:hidden;">
										<td><input type="date" name="q8" class="" value="{{ old('q8', isset($get_detail->q8)?$get_detail->q8:'') }}" ></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
										<textarea name="q9" rows="4" style="border: none;border-bottom: dotted 1px #000;background: transparent;width: 100%;">{{ old('q9', isset($get_detail->q9)?$get_detail->q9:'') }}</textarea>
										</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td><input type="number" min="0" name="q10" class="" value="{{ old('q10', isset($get_detail->q10)?$get_detail->q10:'') }}"></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										...
										<td>										
											<table width="100%" border="0">
												<tr style="background-color:transparent;">												
													<td class="radio-inline" width="50%">																							
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Yes" id="q11Yes" name="q11" {{ old('q11', isset($get_detail->q11) && $get_detail->q11=='Yes'?'checked':'') }} > <label for="q11Yes">Yes</label>
													</td>
													<td class="radio-inline" width="50%">	
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="No" id="q11No" name="q11" {{ old('q11', isset($get_detail->q11) && $get_detail->q11=='No'?'checked':'') }} > <label for="q11No">No</label>
									...
									<tr style="border-bottom-style:hidden;">
										<td>										
											<table width="100%" border="0">
												<tr style="background-color:transparent;">												
													<td class="radio-inline" width="50%">													
														<input type="radio" value="Yes" style="width: 5%;bottom: -2px;position: relative;width:30px;" id="q12Yes" name="q12" {{ old('q12', isset($get_detail->q12) && $get_detail->q12=='Yes'?'checked':'') }} > <label for="q12Yes">Yes</label>
													</td>
													<td class="radio-inline" width="50%">													
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="No" id="q12No" name="q12" {{ old('q12', isset($get_detail->q12) && $get_detail->q12=='No'?'checked':'') }} > <label for="q12No">No</label>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr style="border-bottom-style:hidden;">
										<td>
										<textarea name="q13" rows="4" style="border: none;border-bottom: dotted 1px #000;background: transparent;width: 100%;">{{ old('q13', isset($get_detail->q13)?$get_detail->q13:'') }}</textarea></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
										<td style="font-weight:900;">17. प्रश्न पुस्तिका की कितनी सीरिज थी</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
										<td><input type="text" name="q14" class="" value="{{ old('q14', isset($get_detail->q14)?$get_detail->q14:'') }}" ></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
										<td style="font-weight:900;">18. टेस्ट पेपर में कुल कितने पेज थे</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
										<td><input type="text" name="q15" class="" value="{{ old('q15', isset($get_detail->q15)?$get_detail->q15:'') }}" ></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>
										<textarea name="q17" rows="4" style="border: none;border-bottom: dotted 1px #000;background: transparent;width: 100%;">{{ old('q17', isset($get_detail->q17)?$get_detail->q17:'') }}</textarea></td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td>										
											<table width="100%" border="0">
												<tr style="background-color:transparent;">												
													<td class="radio-inline" width="50%">													
														<input type="radio"  style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Yes" id="q18Yes" name="q18" {{ old('q18', isset($get_detail->q18) && $get_detail->q18=='Yes'?'checked':'') }} > <label for="q18Yes">Yes</label>
													</td>
													<td class="radio-inline" width="50%">													
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="No" id="q18No" name="q18" {{ old('q18', isset($get_detail->q18) && $get_detail->q18=='No'?'checked':'') }} > <label for="q18No">No</label>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr style="border-bottom-style:hidden;">
										<td>
											<table width="100%" border="0">
												<tr style="background-color:transparent;">
													<td class="radio-inline" width="50%">
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="Yes" name="q19" id="q19Yes" class="q19" {{ old('q19', isset($get_detail->q19) && $get_detail->q19=='Yes'?'checked':'') }} > <label for="q19Yes">Yes</label>
													</td>
													<td class="radio-inline" width="50%">
														<input type="radio" style="width: 5%;bottom: -2px;position: relative;width:30px;" value="No" name="q19" id="q19No" class="q19" {{ old('q19', isset($get_detail->q19) && $get_detail->q19=='No'?'checked':'') }} > <label for="q19No">No</label>
													</td>
												</tr>
											</table>
											<br/>
											<textarea name="q19_1" rows="4" class="q19_1" style="border: none;border-bottom: dotted 1px #000;background: transparent;width: 100%;display:{{ old('q19', isset($get_detail->q19) && $get_detail->q19=='Yes'?'block':'none') }}" placeholder="Please Describe">{{ old('q19_1', isset($get_detail->q19_1)?$get_detail->q19_1:'') }}</textarea>
										</td>
									</tr>
									<tr style="border-bottom-style:hidden;">
									...
									<tr style="border-bottom-style:hidden;">
										<td><input type="text" name="q20" class="" value="{{ old('q20', isset($get_detail->q20)?$get_detail->q20:'') }}" ></td>
									</tr>
