					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.request-pending-accept') }}" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-12 col-sm-6 col-lg-3">
											<fieldset class="form-group">
												<label for="users-list-status">Req. No.</label>
												<input type="text" class="form-control mrl" name="mrl" placeholder="MRL Number" value="{{ app('request')->input('mrl') }}">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											<fieldset class="form-group">
												<label for="users-list-status">Created Date</label>
												<input type="date" class="form-control cdate" name="cdate" placeholder="Date" value="{{ app('request')->input('cdate') }}">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
											<fieldset class="form-group">
												<label for="users-list-status">User Name</label>
												<input type="text" class="form-control uname" name="uname" placeholder="User" value="{{ app('request')->input('uname') }}">
											</fieldset>
										</div>
										<div class="col-12 col-sm-6 col-lg-3">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="{{ route('admin.request-pending-accept') }}" class="btn btn-warning">Reset</a>
