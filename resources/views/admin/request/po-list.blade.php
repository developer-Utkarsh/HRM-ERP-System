										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple1 vendor" name="vendor">
													...
													<option value="{{ $value->id }}" @if($value->id == app('request')->input('vendor')) selected="selected" @endif>{{ $value->name }}</option>
													@endforeach
													@endif
												</select>												
											</fieldset>
							...
							@if(count($notification) > 0)
								...
								<tr style="">
									...
									<td>
										...
										<a href="javascript:void(0)" title="Click" data-id="{{ $value->request_id }}" class="get_invoice_data text-primary">
