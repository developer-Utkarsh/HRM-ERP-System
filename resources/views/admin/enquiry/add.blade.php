		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-6">
						<a href="javascript:void(0);" class="btn btn-primary" onclick="window.history.go(-1); return false;" style="float: right;">Back</a>
					</div>
				</div>
			</div>
						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									...
									<form method="post" action="{{ route('admin.enquiry.store') }}">
										@csrf
										<div class="row"> 
