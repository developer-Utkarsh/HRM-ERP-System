		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-3">
						<a href="{{ route('admin.appointment') }}" class="btn btn-primary float-right ">Back</a>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.add-place') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-12 col-12">
													<div class="form-group">
														...
														<textarea class="form-control" placeholder="Meeting Agenda" name="description">{{ old('title') }}</textarea>
												...
												<div class="col-12 col-md-12">
													...
													<fieldset class="form-group">												
														...
														<span class="text-danger">{{ $errors->first('meeting_type') }} </span>
														@endif												
													</fieldset>
												</div>
