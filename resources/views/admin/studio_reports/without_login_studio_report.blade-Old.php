				...
				if (count($get_studios) > 0) {
					...
					foreach ($get_studios as $branchArray) {
						...
						<table  class="table table-bordered table-striped" id="">
							<head>
								<tr style="">
									<td colspan="3" class="m-0 panel-title">
                                        <a class="btn btn-primary text-left lbldeptname w-100 collapsed" data-toggle="collapse" href="#multiCollapseExample0" role="button" aria-expanded="false" aria-controls="multiCollapseExample0" id="heading-<?=$dataFound?>">Branch Name : <?php echo $branchArray->name; ?></a>
                                       </tr>
							</head>
							<tbody>
							<tr style="">
						...
						?>
                           ...
                           <table  class="table table-bordered table-striped" id="">
							<head>
								<tr style="">
									<td colspan="12" class="m-0 panel-title"><a class="btn btn-primary text-left lblsearchable w-100 collapsed" data-toggle="collapse" href="#SchemeCollapse1" role="button" aria-expanded="false" aria-controls="SchemeCollapse1"><b>Studio Name : <?php echo $value->name; ?></b></a></td>
