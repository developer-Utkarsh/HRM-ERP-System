				...
				if (count($get_studios) > 0) {
					...
					foreach ($get_studios as $branchArray) {
						...
						<table  class="table table-bordered table-striped" id="">
							<head>
								<tr style="">
									<td colspan="3"><h3 class="accordion-header" id="heading-<?=$dataFound?>"><button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-<?=$dataFound?>">Branch Name : <?php echo $branchArray->name; ?></button> </h3></td>
								</tr>
							</head>
							<tbody>
							<tr style="">
							<td style="border: 1px solid;">
                                <div id="collapse-<?=$dataFound?>" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
						<?php
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_excel", function (e) {
		...
		data.type = $('.type').val(),
		window.location.href = "studio-report-report-excel?" + Object.keys(data).map(function (k) {
