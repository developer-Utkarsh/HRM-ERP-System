					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.category.index') }}" method="get" name="filtersubmit">
									<div class="row">
										<!--
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.category.index') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
					...
					<table class="table data-list-view" id="TableSearch">
						...
						@if(count($category) > 0)
							...
							<tr>
								...
								<td><a title="Update Sub Category" href="{{ url('admin/subcategory', $value->id) }}" class="btn btn-sm btn-primary waves-effect waves-light">Sub Category</a></td>
								<td class="product-action">
									...
									<!--
									<a title="Delete Category" href="{{ route('admin.category.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Category')">
