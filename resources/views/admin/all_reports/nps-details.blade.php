						...
						<div class="row justify-content-center">
							<div class="col-lg-6 pb-3">
								<div class="">
									...
									<button type="button" class="btn btn-light buttonclass py-2" style="width:35%" onclick="showhide('batchWise')"><b>Batch Wise (NPS 2.0)</b></button>
									<button type="button" class="btn btn-light buttonclass py-2" style="width:35%" onclick="showhide('batchWise3')"><b>Batch Wise (NPS 3.0)</b></button>
								</div>
								<div class="all_report">									
									<table class="table table-bordered  bg-light text-center">
										<thead style="background: #ffe982;">
											<tr>
												...
												<th scope="col"><b>NPS 1.0</b></th>												
												<th scope="col"><b>NPS 2.0</b></th>												
												<th scope="col"><b>NPS 3.0</b></th>												
											</tr>
										</thead>
										<tbody>
											<?php 
												$allFeedback = DB::select("SELECT total_feedback,avg_rating,avg_rating_2,avg_rating_3 FROM `rating_all_3` WHERE `hrms_faculty_id` = '".$secondquery[0]->hrms_faculty_id."'  AND type='a_rating'");
											...
											<tr>
												...
												<td>
													<?php 
														echo $second; 
														if($first >= $second){
															echo '&nbsp; <span class="text-danger"><b><i class="fa fa-arrow-down" aria-hidden="true"></i></b></span>';
														}else{
															echo '&nbsp; <span class="text-success"><b><i class="fa fa-arrow-up" aria-hidden="true"></i> </b></span>';
														}
													?>
												</td>
												<td>
									...
									<table class="table table-bordered bg-light">
										...
										<tbody>
											<?php 
												$innerQuery = DB::select("SELECT total_feedback as question,avg_rating,avg_rating_2,avg_rating_3 FROM `rating_all_3` WHERE `hrms_faculty_id` = '".$secondquery[0]->hrms_faculty_id."' AND type='q_rating'");
												foreach($innerQuery as $key2 => $innval){
													$qfirst = number_format((float)$innval->avg_rating, 2, '.', '');
													$qsecond = number_format((float)$innval->avg_rating_2, 2, '.', '');
													$qthird = number_format((float)$innval->avg_rating_3, 2, '.', '');
											?>
											<tr style="font-size:13px;">
												<td class="w-75">{{ $innval->question }}</td>
												<td class="text-center">{{ $qfirst }}</td>												
										...
										<div class="accordion-item mt-3">
											<h2 class="accordion-header" id="heading<?=$i;?>">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?=$i;?>" aria-expanded="false" aria-controls="collapse<?=$i;?>">
													<b> <span style="font-size:13px;">{{ $value->batch_name }}</b></span>
												</button>
											</h2>
											<div id="collapse<?=$i;?>" class="accordion-collapse collapse" aria-labelledby="heading<?=$i;?>" data-bs-parent="#accordionExample">
												<div class="accordion-body">
													...
													<table class="table table-bordered">
														...
														<tbody>
															<?php 
																$innerQuery = DB::select("SELECT question,avg_rating FROM `questionwise_2` WHERE `hrms_faculty_id` = '".$value->hrms_faculty_id."' AND batch_id = '".$value->batch_id."' AND version=1");
															...
															<tr style="font-size:13px;">
																<td class="w-75">{{ $innval->question }}</td>
																<td class="text-center">
																	{{ number_format((float)$innval->avg_rating, 2, '.', '')  }}
																</td>
															</tr>	
															<?php } }else{ ?>
															<tr>
								...
								<div class="accordion batchWise3" id="accordionExample" style="display:none;">
									<div class="">
										<?php 
											$i =2;
											...
											<div id="collapse<?=$i;?>" class="accordion-collapse collapse" aria-labelledby="heading<?=$i;?>" data-bs-parent="#accordionExample">
												<div class="accordion-body">
													...
													<table class="table table-bordered">
														...
														<tbody>
															<?php 
																$innerQuery = DB::select("SELECT question,avg_rating FROM `questionwise_3` WHERE `hrms_faculty_id` = '".$value->hrms_faculty_id."' AND batch_id = '".$value->batch_id."' AND version=1");
