		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<h3 class="content-header-title mb-0">Faculty Message To CEO</h3>

                <span class="float-right"><a href="{{ route('acge','isFaculty') }}?export=yes" target="_blank">Export</a></span>
		...
		<div class="accordion" id="accordionExample">
			...
			<div class="card" id="result<?=$i;?>">
				...
				<div class="card-header py-1" id="headingOne" style="background-color:#<?=$bgNew;?>;">
				  <h5 class="mb-0 w-100">
						<div class="px-0 text-left w-100 get_edit_data" type="button" style="color:#fff;" data-toggle="collapse" data-target="#collapse<?=$i;?>" data-id="{{ $q->id }}" aria-expanded="true" aria-controls="collapseOne">
							<b>By :  <?=$q->uname;?> &nbsp;( Department: <?=$q->dname;?>,- Branch: <?=$q->branch;?> - <?php echo date('d-m-Y h:i:s', strtotime($q->created_at));?> )</b>
				...
				<div id="collapse<?=$i;?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="background:#<?=$nClass;?>">
					<div class="card-body border-top pt-2">
				      ...
				      <span class="float-right btn btn-outline-dark text-dark px-1 copy_content" data-id="<?=$q->id;?>">Copy & Share</span>
						...
						<form action="{{ route('employee-complaint-reply') }}" method="post">
							@csrf
							...
							<div class=" my-2">
								...
								<div class="text-right">
									...
									<a href="https://api.whatsapp.com/send?phone=+91<?=$q->mobile;?>&text=नमस्कार, आपका मैसेज मुझे उत्कर्ष एम्पलोई एप पर प्राप्त हुआ है। यह मेरा व्यक्तिगत वाट्सअप नम्बर है। मुझे आप वाट्सअप पर व्यक्तिगत मैसेज भी कर देवें। जल्दी ही मैं आपसे सम्पर्क करूंगा।  - निर्मल गहलोत"><button type="button" class="btn btn-primary px-1" style="background-color:#25D366 !important;color:#FFF;font-weight:bold;">Whatsapp</button>
									</a>
