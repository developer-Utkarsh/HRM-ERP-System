						...
						<div class="row justify-content-center">
							<div class="col-lg-6 pb-3">
								<div class="">
									...
									<button type="button" class="btn btn-light buttonclass py-2" style="width:35%" onclick="showhide('batchWise')"><b>Batch Wise (NPS 4.0)</b></button>
								</div>
								<div class="all_report">									
									<table class="table table-bordered  bg-light text-center">
										<thead style="background: #ffe982;">
											<tr>
												...
												<th scope="col"><b>NPS 4.0</b></th>												
											</tr>
										</thead>
										<tbody>
											<?php 
												$allFeedback = DB::select("SELECT total_feedback,avg_rating,avg_rating_2,avg_rating_3 FROM `rating_all_4` WHERE `hrms_faculty_id` = '".$firstquery[0]->hrms_faculty_id."'  AND type='a_rating'");
									...
									<table class="table table-bordered bg-light">
										...
										<tbody>
											<?php 
												$innerQuery = DB::select("SELECT total_feedback as question,avg_rating,avg_rating_2,avg_rating_3 FROM `rating_all_4` WHERE `hrms_faculty_id` = '".$firstquery[0]->hrms_faculty_id."' AND type='q_rating'");
											...
											<div id="collapse<?=$i;?>" class="accordion-collapse collapse" aria-labelledby="heading<?=$i;?>" data-bs-parent="#accordionExample">
												<div class="accordion-body">
													...
													<table class="table table-bordered">
														...
														<tbody>
															<?php 
																$innerQuery = DB::select("SELECT question,avg_rating FROM `questionwise_4` WHERE `hrms_faculty_id` = '".$value->hrms_faculty_id."' AND batch_id = '".$value->batch_id."' AND version=1");
