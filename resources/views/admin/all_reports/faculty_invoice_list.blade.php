		...
		<div class="content-body">
			<section id="data-list-view" class="data-list-view-header">
				<div class="text-right pb-2">
					<a href="{{ route('faculty-invoice-add') }}?user_id={{ $user_id }}" class="btn-dark p-1">Back</a>
				</div>
				<div class="card mb-1">
				...
				<div class="card mb-1">
					<div class="card-content collapse show">
						<div class="card-body">
							<form class="" action="{{ route('faculty-invoice-list',[$user_id]) }}" method="get">
								<div class="form-group">
									<input type="month" class="form-control month" name="month" value="{{ app('request')->input('month') }}">
								</div>
								<div class="text-right">
									<button type="submit" class="btn btn-success">Submit</button> &nbsp;
									<button type="button" class="btn btn-primary" onclick="location.href = '{{ route('faculty-invoice-list',[$user_id]) }}';">Reset</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="card-content">
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-7">: {{ date('F Y', strtotime($value->month . '-01')) }}</div>
							</div>
							<div class="row" style="padding-top:5px;">
								<div class="col-5 font-weight-bold">Invoice</div>
								<div class="col-7 font-weight-bold">: 
									<?php if(!empty($value->invoice)){ ?>
										<a href="{{ asset('laravel/public/invoice/' . $value->invoice) }}" download class="text-primary">Preview</a>
