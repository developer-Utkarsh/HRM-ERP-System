					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.student-get-inventory') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.student-get-inventory') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div> 
									</div>
								</form>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									?>
										<a href="{{ route('admin.student-assign-inventory',[$student->reg_number,$gi->id])}}">Pending</a>
									<?php } ?>
								</td>
							</tr>	
							<?php 		$i++; }
