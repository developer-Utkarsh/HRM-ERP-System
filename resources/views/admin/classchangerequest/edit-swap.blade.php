					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.swap.update', $swap->id) }}" method="post" enctype="multipart/form-data">
										@method('PATCH')
										@csrf
										<div class="form-body">
											<div class="row">
												...
												<input type="hidden" name="c_studio_id" value="{{ $get_timetable->studio_id }}">
												...
												<input type="hidden" name="s_studio_id" value="{{ $get_swap_timetable->studio_id }}">
