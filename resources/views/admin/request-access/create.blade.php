				...
				<div class="content-header-left col-md-12 col-12 mb-2">
					<div class="row breadcrumbs-top">
						...
						<div class="col-4 text-right">
							<a href="{{ route('request-access') }}" class="btn btn-outline-primary mr-1">← Back</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-content">
									<div class="card-body">
										<form class="form" method="POST" action="{{ route('request-access.store') }}">
											@csrf
											<div class="form-body">
												<div class="row">
														...
														<div class="row">
															...
															<div class="col-md-3">
																<div class="form-group">
																	...
																	@if ($errors->has('software_ids.0'))
																		<span class="text-danger">{{ $errors->first('software_ids.0') }}</span>
																	@endif
																</div>
															</div>
															<div class="col-md-3">
    															<div class="form-group">
    															    ...
    															    @if ($errors->has('already_have_access.0'))
    															        <span class="text-danger">{{ $errors->first('already_have_access.0') }}</span>
    															    @endif
    															</div>
															</div>
															<div class="col-md-3 d-none request-type">
																<div class="form-group">
																	...
																	@if ($errors->has('request_type.0'))
																		<span class="text-danger">{{ $errors->first('request_type.0') }}</span>
																	@endif
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	...
																	@if ($errors->has('access_level.0'))
																		<span class="text-danger">{{ $errors->first('access_level.0') }}</span>
																	@endif
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group">
																	...
																	@if ($errors->has('purpose.0'))
																		<span class="text-danger">{{ $errors->first('purpose.0') }}</span>
																	@endif
																</div>
															</div>
															<div class="col-md-12">
