	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="content-header-right text-md-right col-md-3 col-12 d-md-block">
				<a href="{{ route('admin.multi-course-planner.add-topic',[$id]) }}"><button class="btn btn-primary" type="button">Add</button></a>
							...
							<div class="card-content collapse show">
								<div class="card-body">
									<div class="users-list-filter">
										<form action="{{ route('admin.multi-course-planner.topic',[$id]) }}" method="get" name="filtersubmit">
											<div class="row">
												...
												<div class="col-12 col-sm-6 col-lg-3">
													...
													<a href="{{ route('admin.multi-course-planner.topic',[$id]) }}" class="btn btn-warning">Reset</a>
													</fieldset>
												</div>
											</div>
										</form>
										...
										<table class="table data-list-view">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $re->en_name??'-' }}</td>
													<td>
														<a href="{{ route('admin.multi-course-planner.edit-topic', [$re->id,$id]) }}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form action="{{ route('admin.multi-course-planner.upload-topics') }}" method="post" enctype="multipart/form-data">
			@csrf
