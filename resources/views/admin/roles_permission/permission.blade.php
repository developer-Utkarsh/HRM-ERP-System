		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">{{ $heading }} Role & Permission</h2>
			...
			<section id="data-list-view" class="data-list-view-header">
				...
				<div class="table-responsive">
					<div class="container-fluid" style="background-color: #fff;">
						<div class="text-left" >							
							<form action="{{$url}}" method="post" style="padding:0;">						@csrf
								<div style="padding:10px;">
									...
									<div class="py-2 border-top">
										<div style="float:left;font-weight:bold" class="w-25">{{ ucwords($pe->module) }}</div>	
										<div style="float:right;" class="w-75">
											...
											<div style="float:left;" class="w-50">
												<input type="checkbox" name="permissions[]" value="{{ $m->id }}" <?=$selected;?>/>
												{{ ucwords($m->permission) }}
											</div>	
											<?php } ?>
										</div>
