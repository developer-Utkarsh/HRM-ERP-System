		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					?>
					  <a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#IPLModal">IPL Winners</a>
				...
				<div class="row">
				  ...
				  <!-- <div class="col-md-12 col-12 leadcategory d-none">
					...
					<div class="row col-12">
						<div class="col-md-6 col-12 pr_priority">
							<div class="form-group">
...
$(document).ready(function() {
	...
	$("select[name='student_type']").change(function(){
      ...
      dynamicSelectBox.innerHTML = `<option value=""selected="true">--Select--</option>
			<option value="After Payment Order Not Show In App">After Payment Order Not Show In App</option>
