					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.faculty-sme.sme-visibility') }}" method="get" name="filtersubmit">
									<div class="row">
											...
											<fieldset class="form-group">
												<select class="form-control employee select-multiple" name="employee">
													...
													@foreach ($employee as $em)
														<option value="{{ $em->id }}" {{ request('employee') == $em->id ? 'selected' : '' }}>
															{{ $em->name }}
														</option>
													@endforeach
												</select>
											...
											<fieldset class="form-group">
												<select class="form-control faculty select-multiple" name="faculty">
													...
													@foreach ($faculty as $fa)
														<option value="{{ $fa->id }}" {{ request('faculty') == $fa->id ? 'selected' : '' }}>
															{{ $fa->name }}
														</option>
													@endforeach
												</select>
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.faculty-sme.sme-visibility') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									@elseif ($re->restatus == 1)
										<span class="badge bg-success">Completed</span>
									@elseif ($re->restatus == 2)
										<span class="badge bg-danger">Rejected</span>
									@elseif ($re->restatus == 3)
