		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Faculty Report Two</h2>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('faculty-reports-two') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-4">											
											...
											<fieldset class="form-group">																					
												<input type="date" name="tdate" placeholder="Date" value="{{ $selectToDate }}" class="form-control StartDateClass tdate">	
											</fieldset>	
										</div>	
						...
						<tbody>
							...
							?>
								<tr style="border-bottom-style:hidden;">
									<td>
										<?php echo isset($get_faculty_timetable_value->cdate) ?  date("d-m-Y", strtotime($get_faculty_timetable_value->cdate)) : ''; ?>
									</td>
									<td><?php echo isset($get_faculty_timetable_value->batch_name) ?  $get_faculty_timetable_value->batch_name : '' ?></td>
									<td><?php echo isset($get_faculty_timetable_value->faculty_topic_name) ?  $get_faculty_timetable_value->faculty_topic_name : '' ?></td>
									<td>
										<?php echo isset($get_faculty_timetable_value->start_classes_start_time) ?  date("h:i A", strtotime($get_faculty_timetable_value->start_classes_start_time)) : '' ?>
									</td>
									<td>
										<?php echo isset($get_faculty_timetable_value->start_classes_end_time) ?  date("h:i A", strtotime($get_faculty_timetable_value->start_classes_end_time)) : '' ?>
									</td>
									<td><?=$duration?></td>
									...
									<tr style="border-bottom-style:dashed; border-bottom-width:2px;border-bottom-color: black;"><td colspan="4"><?php echo isset($get_faculty_timetable_value->branches_name) ?  $get_faculty_timetable_value->branches_name : '' ?>
									<?php
