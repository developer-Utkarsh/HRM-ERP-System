					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.faculty-topic') }}" method="get" name="filtersubmit">										
									<div class="row">											
										...
										<div class="col-12 col-sm-6 col-lg-3">											
											...
											<fieldset class="form-group">															
												<input type="text" name="erp_id"  placeholder="" value="{{ app('request')->input('erp_id') }}" class="form-control erp_id" >	
											</fieldset>	
										</div>
										<div class="col-12 col-sm-6 col-lg-4">
											...
											<fieldset class="form-group">												
												...
												<a href="{{ route('admin.faculty-topic') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>	
									</div>
								</form>
