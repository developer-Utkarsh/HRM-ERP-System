					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.timetable-history-reports') }}" method="get" name="filtersubmit">
									<div class="row">
									...
									<fieldset class="form-group" style="float:right;">		
										...
										<a href="{{ route('admin.timetable-history-reports') }}" class="btn btn-warning">Reset</a>
