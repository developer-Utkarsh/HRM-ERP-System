					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.faculty-reports.subjects') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.faculty-reports.subjects') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								<td>{{ $key + 1 }}</td>
								<td>{{ $value->name }}</td>
								<td class="product-name">{{ $value->register_id }}
								</td>
								<!--td>
								<?php
								/*$branch_names = "";
