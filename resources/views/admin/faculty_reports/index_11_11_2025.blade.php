	...
	<div class="content-wrapper">
		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
										...
										<div class="col-12 col-md-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple2 batch_id" name="batch_id">
													...
													<option value="{{ $value->id }}" @if($value->id == app('request')->input('batch_id')) selected="selected" @endif>
														{{ $value->name }}-{{ $value->erp_course_id }}</option>
													@endforeach
													@endif
												</select>												
											</fieldset>
										...
										<div class="col-12 col-md-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple3 select_assistant_id" name="assistant_id">
													<option value="">Select Any</option>
													@if(!empty($get_assistant) && count($get_assistant) > 0)
				...
				?>
					<table class="table data-list-view dataTable" style=''>
							...
							?>
								<tr>
									...
									<td data-id="{{ $get_faculty_timetable_value->id }}">
										<?php
											if(empty($duration) || $duration == '00 : 00 Hours'){
				...
				if(data.status == false){
                    ...
                    for(var i=0;i<data['planner'].length;i++){
						...
						$.each(comman_chapters,function(key){
	                        ...
	                        chapter_topic_list+=`<td >`+comman_chapters[key]['topic_name']+`</td>`;
