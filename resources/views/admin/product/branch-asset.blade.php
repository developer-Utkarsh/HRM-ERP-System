					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.branch-product-inventory') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="{{ route('admin.branch-product-inventory') }}" class="btn btn-warning">Reset</a>
						...
						@if(count($product) > 0)
							...
							<tr>
								...
								<td class="product-action">
									...
									<a title="Transfer Product History" href="{{ route('admin.transfer-inventory-history', $value->product_ids) }}">
