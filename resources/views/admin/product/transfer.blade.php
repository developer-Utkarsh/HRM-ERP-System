...
<div class="app-content content">
	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<!--div class="col-md-3"><a href="{{ route('admin.product.add-transfer-product', $product_id) }}" class="btn btn-outline-primary float-right">Transfer</a></div-->
			<div class="col-md-4"><a href="{{ route('admin.product.index') }}" class="btn btn-outline-primary float-right">Back</a></div>
							...
							<table class="table data-list-view">
								...
								@if(count($get_product_detail) > 0)
									...
									<tr>
										...
										<td class="product-category">{{ $value->created_at }}</td>
