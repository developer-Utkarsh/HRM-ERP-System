						...
						<div class="card-content">
							<div class="card-body">
								<div class="users-list-filter">
									<form action="{{ route('admin.faculty-plan') }}" method="get">
										@csrf
										<div class="row mx-0">								
											<div class="col-3">
												<label>Subject</label>
											...
											<div class="col-4 pt-2">
												...
												<a href="{{ route('admin.faculty-plan') }}" class="btn btn-warning">Reset</a>
											</div>
										</div>
									</form>
								</div>
										...
										<table class="table data-list-view">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $re->total_allotted_hour??'-' }}</td>
													<td>{{ $re->total_spent_hours??'-' }}</td>
													<td>{{ $re->completed_mark_hrs??'-' }}</td>
													<td></td>
												</tr>	
												<?php } 
													}else{
