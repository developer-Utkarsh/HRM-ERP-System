										...
										<table class="table data-list-view" id="student_data">
											...
											<tbody>			
												...
												<tr>
													...
													<td>{{ $st->s_name }}</td>
													<td>{{ $st->contact }}</td>
													<td>{{ date('d-m-Y', strtotime($st->reg_date)) }}</td>
													<td>{{ $st->due_amount }}</td>
													<td>{{ $st->due_days }}</td>
													<td>{{ $st->receipt_date }}</td>
													<td>{{ $last_punch->date??'-' }}</td>
													<td>{{ $last_punch->prsent??'-' }}</td>
													<td>{{ ucwords($st->course_status) }}</td>
													<td>{{ $st->batch_running_status }}</td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
