						...
						<div class="card-content">
							<div class="card-body">
								<div class="users-list-filter">
									<form action="{{ route('admin.prediction-report') }}" method="get">
										@csrf
										<div class="row mx-0">								
											<div class="col-3">
												<label>Subject</label>
										...
										<table class="table data-list-view">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $company_cost }}</td>
													<td>{{ round(($re->committed_hours / $daysInMonth) * $daysCount, 2) }}</td>								
													<td>{{ round($re->spent_hrs_1,2) }}</td>													
													<td>{{ $projected }}</td>														
													<td>{{ round(($re->spent_hrs_1 / $daysCount) * $daysInMonth,2) * 500 }}</td>												
													<td>-</td>												
												</tr>
												<?php } }else{ ?>
												<tr>
