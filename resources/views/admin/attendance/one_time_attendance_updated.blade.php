					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.attendance.store_attendance') }}" method="post" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-body">
											...
											@if(Auth::user()->role_id != 20)
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														?>
														<label for="first-name-column">Employee(example : 2324,1244,3454)</label>
														 <input type="text" class='form-control' id="emp_id" name="emp_id" placeholder="Enter your Employee Ids" required="" >
													</div>
												</div>
												@else
											...
											<div class="row">
												<div class="col-md-3 col-12">
													<div class="form-group">
														...
														<input type="time" class="form-control" placeholder="" name="time[]" value="09:00">
												...
												<div class="col-md-3 col-12">
													<div class="form-group">
														...
														<input type="time" class="form-control" placeholder="" name="time[]" value="18:00">
											...
											<div class="row">
												...
												<div class="col-md-8 col-12">
													<div class="form-label-group">
														<textarea name="reason" placeholder="Reason" class="form-control remark" required>Updated</textarea>
													</div>
												</div>
											</div>
