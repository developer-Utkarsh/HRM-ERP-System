					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.attendance.incompleteattendence') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<select class="form-control incomplete_type" id="incomplete_type" name="incomplete_type">
													<option value=""> - Select Any - </option>
													<option value="p" @if('p' == app('request')->input('incomplete_type')) selected="selected" @endif>P</option>
													<option value="a" @if('a' == app('request')->input('incomplete_type')) selected="selected" @endif>A</option>
													<option value="h" @if('h' == app('request')->input('incomplete_type')) selected="selected" @endif>H</option>
												</select>
											</div>
										</div>
									</div>
									...
									<a href="{{ route('admin.attendance.incompleteattendence') }}" class="btn btn-warning">Reset</a>
...
$.fn.serializeObject = function() {
    ...
    $(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "{{ route('admin.attendance.incomplte-attendence-detail') }}",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){
