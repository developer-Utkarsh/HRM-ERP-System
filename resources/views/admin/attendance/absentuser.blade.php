					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.attendance.absentuser') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-4 col-lg-3">
											...
											?>
												<input type="date" name="fdate" class="form-control fdate" value="{{$date }}" id="">
											</fieldset>
										</div>
										<div class="col-md-3">
									...
									<a href="{{ route('admin.attendance.absentuser') }}" class="btn btn-warning">Reset</a>
					...
					<table class="table data-list-view" style="background:#fff;">
						...
						<?php
							...
							<tr >
								...
								<td class="product-category">{{ isset($value->register_id) ?  $value->register_id : '' }}</td>
								<td class="product-category">{{ isset($value->mobile) ?  $value->mobile : '' }}</td>
							</tr>
							<?php
								}	
							}else{
