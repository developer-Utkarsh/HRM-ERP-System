					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ url('admin/attendence-record-single-day') }}" method="get" name="filtersubmit">
									<div class="row">
								...
								<form method="get" name="filtersubmit">
									<div class="row">
										<div class="col-md-12">
											...
											<strong for="users-list-role">OH : Optional Holiday, &nbsp;&nbsp;</strong> </br></br>
											<strong for="users-list-role">Comp Off : Composition Off, &nbsp;&nbsp;</strong>
											<strong for="users-list-role">PL : Paid  Leave, &nbsp;&nbsp;</strong>
											<strong for="users-list-role">SL : Sick Leave, &nbsp;&nbsp;</strong>
...
$.fn.serializeObject = function() {
    ...
    $(document).ready(function () {
        var attendanceTable = $('#attendanceTable').DataTable({
            ...
            "serverSide": true,
            "ajax":{
		     "url": "{{ route('admin.attendance.attendence-record-detail-single') }}",
		     "dataType": "json",
		     "type": "GET",
			 "data": function(data){
