				...
				<div class="row match-height">
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.asset_pro.employee-asset-pro') }}" method="get" name="filtersubmit">
										@csrf
										<div class="form-body">
											<div class="row">	
												<div class="col-md-4">
												...
												<div class="col-md-8">
													...
													<fieldset class="form-group">		
														...
														<a href="{{ route('admin.asset_pro.employee-asset-pro') }}" class="btn btn-warning">Reset</a>
													</fieldset>
												</div>
											</div>
										</div>
					...
					<table class="table data-list-view" style="background:#fff;width:100%" id="assetTable">
						...
						@if(count($emp_asset_list) > 0)
							...
							$assigned_asset = DB::table('asset')
												...
												->where('assign_asset.assigned_by', $value->assigned_by)
							...
							<tr>
								...
								<td class="product-action">
									<a title="Update Asset" href="{{ route('admin.asset_pro.edit', $value->emp_id) }}">
