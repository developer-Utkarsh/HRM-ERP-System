		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-8">
						<h2 class="content-header-title float-left mb-0">Invoice History</h2>
					...
					<div class="col-4 text-right">
						<a href="{{ route('admin.freelancer.index') }}" class="btn btn-primary">Back</a>
					</div>
				</div>
			</div>
		</div>
					...
					<table class="table data-list-view" id="">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $r->amount }}</td>
								<td>{{ $r->created_at }}</td>
								<td><a href="{{ route('admin.freelancer.freelancer-invoice-download',$r->id) }}">Print</a></td>
							</tr>
