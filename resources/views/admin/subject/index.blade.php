					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.subjects.index') }}" method="get" name="filtersubmit">
									<div class="row">
					...
					<table class="table data-list-view">
						...
						<tbody>							
							...
							<tr>
								...
								<td>
									{{-- @if($value->status == "1")
									<a href="{{ route('admin.subject.status', $value->id) }}"><i class="fa fa-toggle-on"></i> Active </a>
									@else
									<a href="{{ route('admin.subject.status', $value->id) }}"><i class="fa fa-toggle-off"></i> Inactive </a>
									@endif --}}
									<a href="{{route('admin.subject.status', $value->id)}}">
								...
								<td class="product-action">
									<a href="{{ route('admin.subjects.edit', $value->id) }}">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="{{ route('admin.subject.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Subject')">
