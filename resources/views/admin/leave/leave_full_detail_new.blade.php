		...
		<div class="content-body">
			...
			<section id="data-list-view" class="data-list-view-header">
				...
				<table class="table data-list-view">
					<thead>
						<tr>
							<th style="width:20%;">Emp Name / Joining Date</th>
							<th style="width:10%;">Emp Code</th>
							<th>Taken Leave Count</th>
							<th>Reamining Leave Count</th>
				...
				if (count($get_data) > 0) { 
					foreach ($get_data as $leave) {
						...
						?>
							...
							<td><?php echo $leave->name?> / <?php echo (!empty($leave->joining_date))?date('d/m/Y',strtotime($leave->joining_date)):'';?></td>
							<td><?php echo $leave->register_id?></td>								
							<td>
								<table style="width: 100%;">
									<tr>
										<td style="width: 50%;">PL</td>
										<td><?php echo $leave->taken_pl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">CL</td>
										<td><?php echo $leave->taken_cl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">SL</td>
										<td><?php echo $leave->taken_sl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">CO</td>
										<td><?php echo $leave->taken_co?></td>
									</tr>
								</table>
							...
							<td>
								<table style="width: 100%;">
									<tr>
										<td style="width: 50%;">PL</td>
										<td><?php echo ($leave->pl + $leave->last_year_pl) - $leave->taken_pl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">CL</td>
										<td><?php echo $leave->cl - $leave->taken_cl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">SL</td>
										<td><?php echo $leave->sl - $leave->taken_sl?></td>
									</tr>
									<tr>
										<td style="width: 50%;">CO</td>
										<td><?php echo $remaining_comp_off;?></td>
									</tr>
								</table>
							</td>
							<td>
