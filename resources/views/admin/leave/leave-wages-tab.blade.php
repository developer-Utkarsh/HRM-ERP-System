...
.xl176
	...
	<body link="blue" vlink="purple">
		<button style="    position: absolute;top: 20px;right: 20px;background-color: #007bff;border-color: #007bff;font-weight: 400;color: #fff;text-align: center;
    vertical-align: middle;user-select: none;border: 1px solid transparent;padding: 0.375rem 0.75rem;font-size: 1rem;line-height: 1.5;border-radius: 0.25rem;"  onclick="window.print()" id="printPageButton">Print</button>
		<table border="0" cellpadding="0" cellspacing="0" width="1344" style="border-collapse:collapse;table-layout:fixed;width:1008pt">
			...
			<tbody>
				...
				@php $balance_of_leave_from_proceeding_year = 0; @endphp
				<tr height="23" style="height:17.25pt">
					...
					<td class="xl89" style="border-left:none">&nbsp;</td>
					<td class="xl89" style="border-left:none">&nbsp;</td>
					<td class="xl90" style="border-left:none">{{$balance_of_leave_from_proceeding_year}}</td>
					<td class="xl89" style="border-left:none">&nbsp;</td>
					<td class="xl89" style="border-left:none">&nbsp;</td>
					<td class="xl89" style="border-left:none">&nbsp;</td>
				...
				@if($diff >= 0)
					@php $col_3 = 0;$col_4 = 0;$col_5 = 0;$col_6 = 0;$col_7 = 0;$col_8 = 0;$col_10 = 0;$col_11 = 0;$col_12 = 0;$col_14 = 0; @endphp
					@for ($i = 0; $i <= $diff; $i++)
					@php
						...
						$no_of_days = date("t", strtotime($first_selected_month.'-01'));
						
						$final_attendence_record = DB::table('final_attendence')->where('emp_code', $leave_wage->register_id)->where('month_year', $first_selected_month)->first();
						
						$ii = 1;
						$pl_data = '';
						$actual_present = 0;$actual_pl = 0;$lay_off = 0;$maternity_leave = 0;$leave_mentioned = 0;$wages_earned = 0;$leave_refused = 0;$leave_balance = 0;$total_4_to_7 = 0;$total_9_to_10 = 0;
						
						if(!empty($final_attendence_record)){
							for($ii=1; $ii<=31; $ii++){ 
								if($final_attendence_record->{'d_' . $ii} == "P"){
									$actual_present += 1;
								}
								if($final_attendence_record->{'d_' . $ii} == "PL"){
									$actual_pl += 1;
									$pl_data .= $ii.',';
								}
							}
							
							$wages_earned = round((($final_attendence_record->salary)*($actual_present+$lay_off+$maternity_leave+$actual_pl)/$no_of_days), 2);
							$total_4_to_7 = $actual_present+$lay_off+$maternity_leave+$actual_pl;
							$total_9_to_10 = $balance_of_leave_from_proceeding_year+$leave_mentioned;
							
							$col_3 += $wages_earned;
							$col_4 += $actual_present;
							$col_5 += $lay_off;
							$col_6 += $maternity_leave;
							$col_7 += $actual_pl;
							$col_8 += $total_4_to_7;
							$col_10 += $leave_mentioned;
							$col_11 += $total_9_to_10;
							$col_12 += $leave_refused;
							$col_14 += $leave_balance;
						}
					...
					<tr height="24" style="height:18.0pt">
						...
						none">{{$wages_earned}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$actual_present}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$lay_off}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$maternity_leave}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$actual_pl}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$total_4_to_7}}</td>
						<td class="xl95">&nbsp;</td>
						<td class="xl96" style="border-top:none">{{$leave_mentioned}}</td>
						<td class="xl96" style="border-top:none;border-left:none">{{$total_9_to_10}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{$leave_refused}}</td>
						<td colspan="2" class="xl111" style="border-right:.5pt solid black;border-left:
						none">{{rtrim($pl_data, ',')}}</td>
						<td class="xl96" style="border-top:none;border-left:none">{{$leave_balance}}</td>
						<td class="xl94" style="border-top:none;border-left:none">{{!empty($final_attendence_record->salary) ? $final_attendence_record->salary : '' }}</td>
				...
				<tr height="25" style="height:18.75pt">
					...
					none">{{$col_3}}</td>
					<td class="xl104" style="border-left:none">{{$col_4}}</td>
					<td class="xl104" style="border-left:none">{{$col_5}}</td>
					<td class="xl104" style="border-left:none">{{$col_6}}</td>
					<td class="xl104" style="border-left:none">{{$col_7}}</td>
					<td class="xl104" style="border-left:none">{{$col_8}}</td>
					<td class="xl105" style="border-left:none">{{$balance_of_leave_from_proceeding_year}}</td>
					<td class="xl105" style="border-left:none">{{$col_10}}</td>
					<td class="xl105" style="border-left:none">{{$col_11}}</td>
					<td class="xl104" style="border-left:none">{{$col_12}}</td>
					<td colspan="2" class="xl107" style="border-right:.5pt solid black;border-left:
					none">&nbsp;</td>
					<td class="xl105" style="border-left:none">{{$col_14}}</td>
					<td class="xl104" style="border-left:none">&nbsp;</td>
					<td class="xl104" style="border-left:none">&nbsp;</td>
					<td class="xl104" style="border-left:none">&nbsp;</td>
