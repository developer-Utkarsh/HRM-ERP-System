						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									...
									<form class="form" action="{{ route('admin.remove-supervisor-by-department') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										@csrf
										<div class="form-body"> 
											<div class="row">
						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									...
									<form class="form" action="{{ route('admin.remove-supervisor-by-employee') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										@csrf
										<div class="form-body"> 
											<div class="row">
						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									...
									<form class="form" action="{{ route('admin.remove-supervisor-by-branch') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure to want to remove supervisor?');">
										@csrf
										<div class="form-body"> 
											<div class="row">
												<div class="col-md-4 col-12">
														...
														<select class="form-control select-multiple branch_id" name="branch_id[]" multiple>
															...
															@if(count($branch_list) > 0)
																@foreach($branch_list as $value)
																	<option value="{{$value->id}}" @if($value->id == old('from_branch')) selected="selected" @endif>{{$value->name}}</option>
																@endforeach
															@endif
														</select>
