										...
										<div class="col-md-3">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple1 branch_id" name="branch_id">
													...
													<option value="{{ $value->id }}" @if(!empty(app('request')->input('branch_id')) && $value->id == app('request')->input('branch_id')) selected="selected" @endif>{{ $value->name }}</option>
													@endforeach
													@endif
												</select>												
											</fieldset>
					...
					<table class="table data-list-view">
						...
						<?php $i = 0; ?> 
							...
							<tr>
								...
								<td>{{ !empty($value['intime']) ? $value['intime'] : '' }}</td>
								<td>{{ $value['date'] }}</td>
							</tr>
							<?php $i++; ?> 
							@endif
