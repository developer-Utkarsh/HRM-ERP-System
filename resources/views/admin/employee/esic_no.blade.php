					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.employees.esic-no-detail') }}" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-md-3">
										...
										<div class="col-md-3">
											...
											<a href="{{ route('admin.employees.esic-no-detail') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						<tbody>
							@if(count($employees) > 0)
								...
								<tr>
									...
									<td>{{ !empty($value->user_details->esic_no) ? $value->user_details->esic_no : '--' }}</td>
								</tr>
								@endforeach
							@else
								<tr>
