									...
									<div class="col-12 col-md-12 col-lg-5">
										<table class="ml-0 ml-sm-0 ml-lg-0">
											...
											<tr>
												...
												<td>{{ !empty($sub_department->name)?$sub_department->name:'' }}</td>
											</tr>
							...
							<div class="card-body">
								<table>
									...
									<tr>
										...
										<td>{{ isset($employee->user_details->probation_to) ?  date('d-m-Y', strtotime($employee->user_details->probation_to)) : '' }}</td>
									</tr>
									<tr>
										<td class="font-weight-bold">Probation From</td>
										<td>{{ isset($employee->user_details->probation_from) ?  date('d-m-Y', strtotime($employee->user_details->probation_from)) : '' }}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>{{ date('d-m-Y',strtotime($employee->reason_date)) }}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											@if($employee->is_extra_working_salary==1)
												Yes
											@else
												No
											@endif
									...
									<tr>
										...
										<td>{{ isset($employee->asset_requirement) ?  $employee->asset_requirement : '' }}</td>
									</tr>
								</table>
							</div>
						</div>
