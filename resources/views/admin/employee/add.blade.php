			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="{{ route('admin.employees.index') }}" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
											...
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control get_role select-multiple1" name="role_id">
															...
															<option value="{{ $value->id }}" @if($value->id == old('role_id')) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
														@endif
												...
												<div class="col-md-6 col-12 course_category_div hide">
													<div class="form-group">
														...
														<select class="form-control select-multiple6 course_category" name="course_category[]" multiple>
															...
															<option value="{{ $value->id }}" @if($value->id == old('course_category')) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
														@endif
												...
												<div class="col-md-6 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Committed Hours" name="committed_hours" value="{{ old('committed_hours') }}">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Darwin Code" name="darwin_code" value="{{ old('darwin_code') }}" required >
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple2" name="employee_type">
															...
															<option value="Fulltime" @if('Fulltime' == old('employee_type')) selected="selected" @endif>Full Time</option>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<span class="text-danger">{{ $errors->first('degination') }} </span>
														@endif
													</div>
												</div>
												<div class="col-md-6 col-12">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control joining_date" name="joining_date" placeholder="Joining Date" value="{{ old('joining_date') }}" onblur="joinTime()" min="{{$min_date}}">
												...
												<div class="col-md-6 col-12 probationTime">
													<div class="form-group">
														...
														<input type="date" class="form-control probation_from" name="probation_from" placeholder="Joining Date" value="{{ $fromDate }}" min="{{$min_date}}" onblur="callprobation(this.value)">
										...
										<div class="row">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="Gross Salary" name="net_salary" value="{{ old('net_salary') }}">
