					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.task.store') }}" method="post" enctype="multipart/form-data">
										@csrf
											...
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control" placeholder="Date" name="date" value="{{ old('date') }}"  min="{{date('Y-m-d', time() - 86400)}}" required>
														@if($errors->has('date'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														if(Auth::user()->role_id == 29 || Auth::user()->role_id == 24){ 
															...
															$users = \App\User::where('status', '1')->where('role_id', '!=','1')->where('register_id', '!=', NULL)->whereRaw('(id = "'.Auth::user()->id.'" OR supervisor_id LIKE  \'%"'.Auth::user()->id.'"%\')')->get(); 
														}
														?>
														<label for="first-name-column">Employee</label>
														@if(count($users) > 0)
														<select class="form-control emp_id select-multiple1" name="emp_id" required>
											...
											<div class="row">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="" name="plan_hour[]" value="0" step="any" min="0">
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														<label for="">Spent Hour</label>
														<input type="number" class="form-control" placeholder="" name="spent_hour[]" value="0" step="any" min="0">
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
