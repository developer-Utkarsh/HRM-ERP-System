					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.designation.index') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-6">
											...
											<a href="{{ route('admin.designation.index') }}" class="btn btn-warning">Reset</a>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									{{-- @if($value->status == "1")
									<a href="{{ route('admin.designation.status', $value->id) }}"><i class="fa fa-toggle-on"></i> Active </a>
									@else
									<a href="{{ route('admin.designation.status', $value->id) }}"><i class="fa fa-toggle-off"></i> Inactive </a>
									@endif --}}
									<a href="{{route('admin.designation.status', $value->id)}}">
								...
								<td class="product-action">
									...
									<a href="{{ route('admin.designation.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Designation')">
...
<script type="text/javascript">
	...
	$("body").on("click", "#download_excel", function (e) {
		var data = {};
			...
			window.location.href = "<?php echo URL::to('/admin/'); ?>/degination-report-excel?" + Object.keys(data).map(function (k) {
