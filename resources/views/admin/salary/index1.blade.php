			...
			<section id="data-list-view" class="data-list-view-header">
				...
				<div class="row">
					...
					<div class="col-md-3 mt-1">
						<a href="{{ route('admin.add-increment') }}" class="btn btn-primary float-right">Add Increment</a>
					</div>
					<div class="col-md-3">
					...
					<table class="table data-list-view"  id="salaryTable">
						<thead>
							<tr>
								...
								<th>Total Absent</th>
								<th>Total Holiday Working</th>
								<th>Total Week Off</th>
								<th>Salary</th>
								<!--th>Previous Month Leave Balance</th-->
								<th>Holiday leave balance</th>
								<th>Actual Paid</th>
								<th>Adjustment Amount</th>
								<!--th>Woking Days</th>
								<th>Calculate Woking Days</th>
								<th>Salary</th>
								<th>Leave</th>
								<th>Extra Day</th>
								<th>Sandwich</th>
	...
	$(document).ready(function () {
        var salaryTable = $('#salaryTable').DataTable({
	    	...
	    	"columns": [
				  ...
				  { "data": null, render:function(data){ 
						var actionHtml ='';			
							actionHtml = '<a href="javascript:void(0)" id="download_pdf" data-id="'+data.user_id+'" data-year_wise_month="{{$search_year_month}}" class=""><span class="action-edit"><i class="feather icon-file-text"></i></span></a>';
					  return actionHtml; 
				  } },
		       ]				   
