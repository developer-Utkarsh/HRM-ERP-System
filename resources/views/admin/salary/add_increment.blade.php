		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-8">
						<h2 class="content-header-title float-left mb-0">Import Increment/Arrears</h2>
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a>
								</li>
								<li class="breadcrumb-item active">Increment
								</li>
							</ol>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.salary.store-increment') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
                                                <div class="col-md-12 col-12"><h3>Add Increment/Arrears</h3></div> 
												...
												<div class="col-md-4 col-12 mt-2">
                                                    ...
                                                    <a href="{{asset('laravel/public/salary_increment.xlsx')}}" download>Download sample file</a>
												</div>
											</div>
										</div>
									</form>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.add-increment') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.add-increment') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						<tbody>
                            @if(count($salary_increment) > 0)
                                ...
                                <tr>
                                    ...
                                    <td class="product-category">{{ !empty($value->increment_amount) ? $value->increment_amount : '0' }}</td>
                                    <td class="product-category">{{ !empty($value->arrear_day) ? $value->arrear_day : '0' }}</td>
                                    <td class="product-category">{{ !empty($value->arrear_amount) ? $value->arrear_amount : '0' }}</td>
                                    <td class="product-category">{{ !empty($value->salary) ? $value->salary : '0' }}</td>
                                    <td class="product-category">{{ !empty($value->increment_remark) ? $value->increment_remark : '--' }}</td>
                                </tr>
                                @endforeach
                            @else
                            <tr>
