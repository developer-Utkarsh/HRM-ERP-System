            ...
            <td valign="top" colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%;">
                    <tr>
                        ...
                        <td valign="top" style="width: 30%; font-size: 12px; line-height: 15px;  font-weight: 600;">Date. : <?=$invoiceDetail->c_date?></td>
                    ...
                    <tr>
                        ...
                        <td valign="top" style="font-size: 12px; line-height: 15px;  font-weight: 600;">Order Date : <?=$invoiceDetail->date?></td>
                        <td valign="top" style="font-size: 12px; line-height: 15px; font-weight: 300;">&nbsp;</td>
                    </tr>
                    <tr><td height="20"></td></tr>
                    <tr>
