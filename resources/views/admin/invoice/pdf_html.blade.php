    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 100%; -webkit-text-size-adjust: 100%; background: #ffffff; color: #000; margin: 0px auto 0px; padding: 15px; text-align: left;<?=$page_break?>">
        ...
        <tr>
            <td width="70%" valign="top" style="color:#000; font-size:14px; line-height: 20px; font-weight:300;">
				...
				<br/>
				<strong style="margin-top: 26px;float: left;">Name: <?=ucfirst($invoiceDetail['name'])?></strong> 
            </td>
        ...
        <tr>
            <td valign="top" colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%;">
                    <tr>
                        <td valign="top" style="width: 25%; font-size: 12px; line-height: 15px;  font-weight: 600;">Invoice No. : <?=$invoiceDetail['invoice_no']?></td>
                        <td valign="top" style="width: 15%; font-size: 12px; line-height: 15px; font-weight: 300;">&nbsp;</td>
                        <td valign="top" style="width: 30%; font-size: 12px; line-height: 15px;  font-weight: 600;">Date. : <?=$invoiceDetail['date']?></td>
                        <td valign="top" style="width: 30%; font-size: 12px; line-height: 15px; font-weight: 300;">&nbsp;</td>
                    </tr>
                    <tr><td height="20"></td></tr>
                    <tr>
                        <td valign="top" style="font-size: 12px; line-height: 15px;  font-weight: 600;">Order No. : <?=$invoiceDetail['order_number']?></td>
                        <td valign="top" style="font-size: 12px; line-height: 15px; font-weight: 300;">&nbsp;</td>
                        <td valign="top" style="font-size: 12px; line-height: 15px;  font-weight: 600;">Order Date : <?=date('d-m-Y',strtotime($invoiceDetail['created_date']))?></td>
                        <td valign="top" style="font-size: 12px; line-height: 15px; font-weight: 300;">&nbsp;</td>
                    </tr>
                    <tr><td height="20"></td></tr>
                    <tr>
