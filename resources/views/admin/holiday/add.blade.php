					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.holiday.store') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
												...
												<div class="col-12 col-md-4 branch_loader">
													...
													<fieldset class="form-group">												
														<select class="form-control select-multiple1 branch_id" name="branch_id[]" id="" multiple>
															...
															<option value="{{ $value->id }}"  @if(!empty(old('branch_id')) && in_array($value->id, old('branch_id'))) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
															@endif
														</select>
