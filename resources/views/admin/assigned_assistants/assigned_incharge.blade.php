					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.assigned-incharge') }}" method="get" name="filtersubmit">
									<div class="row">
										<div class="col-md-3">
									...
									<a href="{{ route('admin.assigned-incharge') }}" class="btn btn-warning">Reset</a>
									</fieldset>
								</form>
							</div>
						</div>
...
$(".change_incharge").on("click",function(e) {
		...
		$.ajax({
			...
			type: "POST",
			url : '{{ route('admin.assigned_incharge_update') }}',
