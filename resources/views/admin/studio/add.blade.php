			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="{{ route('admin.studios.index') }}" class="btn btn-primary mr-1">Back</a>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.studios.store') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Studio Name" name="name" value="{{ old('name') }}">
														@if($errors->has('name'))
												...
												<div class="col-md-6 col-12 capacity_div" style="display:none;">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Capacity" name="capacity" value="{{ old('capacity') }}" min="0">
