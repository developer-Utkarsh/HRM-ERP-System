					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.location.index') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.location.index') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{route('admin.location.status', $value->id)}}">
								...
								<td class="product-action">
									<a href="{{ route('admin.location.edit', $value->id) }}">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="{{ route('admin.location.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Location')">
