					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.support_category.index') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-sm-6 col-lg-3">
											...
											<a href="{{ route('admin.support_category.index') }}" class="btn btn-warning">Reset</a>
											</fieldset>
										</div>
									</div>
								</form>
						...
						@if(count($category) > 0)
							...
							<tr>
								...
								<td class="product-category">
									<a href="{{route('admin.support_category.status', $value->id)}}">
								...
								<td class="product-action">
									...
									<a title="Delete Category" href="{{ route('admin.support_category.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Category')">
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="{{ route('admin.support_category.store') }}">
      		{{ csrf_field() }}
	      <!-- Modal body -->
...
<script type="text/javascript">
	$(".get_edit_data").on("click", function() { 
		...
		if(cat_id){
			...
			$.ajax({
				type : 'POST',
				url : '{{ route('admin.edit-support-category') }}',
