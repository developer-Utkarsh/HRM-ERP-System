		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-md-4">
						<a class="btn btn-outline-primary float-right" href="{{ route('admin.asset.employee-asset') }}"><span class="action-edit"><i class="feather icon-arrow-left"></i></span></a>
					</div>
				</div>
			</div>
		</div>
						...
						@if(count($assigned_asset) > 0)
							...
							<tr>
								...
								<td class="product-action">
									<a title="Update Asset" href="{{ route('admin.asset.update-asset-status', [$value->id, $value->emp_id]) }}" onclick="return confirm('Are you sure to accept asset')">
