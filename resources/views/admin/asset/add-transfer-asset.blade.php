...
<div class="app-content content">
	...
	<div class="content-wrapper">
		<div class="content-header row">
			...
			<div class="col-md-2"><a href="{{ route('admin.asset.index') }}" class="btn btn-outline-primary float-right"><i class="feather icon-arrow-left"></i></a></div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('admin.asset.store-transfer-asset', $id) }}" method="post" enctype="multipart/form-data">
										@csrf
												...
												<div class="col-md-4">
													...
													<fieldset class="form-group">												
														<select class="form-control select-multiple1 serial_no" name="serial_no" required>
															...
															<option value="{{ $value->id }}" {{ old('serial_no') == $value->id ? 'selected' : '' }}>{{ $value->serial_no }}</option>
															@endforeach
															@endif
														</select>
