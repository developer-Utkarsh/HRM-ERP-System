					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('admin.batch-reports') }}" method="get" name="filtersubmit">
									<div class="row">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple2 batch_id" name="batch_id[]" multiple>
													...
													<option value="{{ $value->id }}" 
														@if(in_array($value->id, (array) app('request')->input('batch_id'))) 
															selected="selected" 
														@endif>
														{{ $value->name }}
													</option>
										...
										<div class="col-12 col-md-3">
											...
											<fieldset class="form-group">												
												<input type="text" name="erp_id" placeholder="" value="{{ app('request')->input('erp_id') }}" class="form-control">
											</fieldset>
										</div>
										<div class="col-12 col-md-3">
										...
										<fieldset class="form-group">		
											...
											<a href="{{ route('admin.batch-reports') }}" class="btn btn-warning">Reset</a>
