					...
					<div class="col-12">
						...
						<div class="breadcrumb-wrapper col-12">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><a href="#">Add Batch</a>
								</li>
							</ol>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Batch Name">
														@if($errors->has('name'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" name="start_date" class="form-control" value="{{ old('start_date') }}" placeholder="Start Date">
													</div>
												</div>										
												<div class="col-md-6 col-12">
