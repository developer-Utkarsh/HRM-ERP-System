                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Studio Assistant Profile</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ route('studioassistant.profile.update') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-label-group">
                                                        <input type="text" class="form-control" name="mobile" placeholder="Mobile Number" value="{{ Auth::user()->mobile }}">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <img id="adminimg" src="{{ asset('laravel/public/profile/' . Auth::user()->image) }}" alt="{{ Auth::user()->name }}" height="80" width="80">
                                                        @endif
                                                    </div>
                                                </div>                                               
                                                <div class="col-12">
