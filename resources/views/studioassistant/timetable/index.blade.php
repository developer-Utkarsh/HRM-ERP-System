				...
				<script type="text/javascript">
				    ...
				    $(document).on("change",".batch_accord_subject", function () { 
						...
						if (batch_id) {
							$.ajax({
								type : 'POST',
								url : '{{ route('studioassistant.get-course') }}',
					...
					$(document).on("change", ".batch_accord_course", function () { 
						...
						if (course_id) {
							$.ajax({
								type : 'POST',
								url : '{{ route('studioassistant.get-class-batch-subject') }}',
								data : {'_token' : '{{ csrf_token() }}', 'batch_id': batch_id},
								dataType : 'html',
								success : function (data){
					...
					$(document).on("change", ".batch_accord_subjects", function () {
						...
						if (subject_id && course_id) {
							$.ajax({
								type : 'POST',
								url : '{{ route('studioassistant.get-chapter') }}',
					...
					$(document).on("change", ".batch_accord_chapter", function () {
						...
						if (chapter_id) {
							$.ajax({
								type : 'POST',
								url : '{{ route('studioassistant.get-topic') }}',
					...
					$(".end_class").on("click", function() {
						...
						if(class_type=="online"){
							...
							if(class_status == 'Partially' || class_status == 'End Class'){
								$.ajax({   
									type: "POST",
									url : '{{ route('studioassistant.partially_end_class_data') }}',
