<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    ...
    <div class="main-menu-content">
		...
		<?php if(Auth::user()->role_id !=21 && Auth::user()->role_id != 20){ ?>
		...
		<?php //if(Auth::user()->role_id !=21){ ?>
		<li class="nav-item"><a href="#"><i class="feather icon-file"></i><span class="menu-title" data-i18n="User">Staff Movement System</span></a>
			<ul class="menu-content">
		...
		<?php //} ?>
		<?php if(Auth::user()->role_id !=21 && Auth::user()->role_id !=20){ ?>
		<li class="nav-item"><a href="#"><i class="feather icon-list"></i><span class="menu-title" data-i18n="User">Department</span></a>
			<ul class="menu-content">
		...
		<li class="nav-item"><a href="#"><i class="feather icon-list"></i><span class="menu-title" data-i18n="User">Designation</span></a>
			<ul class="menu-content">
