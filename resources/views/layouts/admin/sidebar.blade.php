  ...
  <div class="navbar-header">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">			
			...
			<li class="nav-item"><a href="{{ route('admin.support-dashboard') }}"><i class="feather icon-info"></i><span class="menu-title" data-i18n="User">Message to Chairman Dashboard <sup class="text-warning">New</sup></span></a></li>
		  <li class="nav-item"><a href="{{ route('admin.support-enquiry') }}"><i class="feather icon-activity"></i><span class="menu-title" data-i18n="User">Message to Chairman Enquiry <sup class="text-warning">New</sup></span></a></li>
			...
			<li><a href="{{ route('admin.academic.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Academic Dashboard</span></a>
						  </li>
					</li>
			...
			<li class="nav-item">
				<a href="{{ route('admin.freelancer.faculty-invoice-history') }}"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Faculty Invoice</span>
				</a>
			</li>
			<?php } ?>
		
			<?php if(Auth::user()->role_id == 28 || Auth::user()->role_id == 25 || Auth::user()->user_details->degination == "CENTER HEAD"){ ?>
			<li class="nav-item"><a href="{{ route('admin.branch-product-inventory') }}"><i class="feather icon-codepen"></i><span class="menu-title" data-i18n="User">Inventory <sup>(For Center Head)</sup></span></a>
			<!-- 
				...
				<li class="nav-item"><a href="#"><i class="feather icon-wind"></i><span class="menu-title" data-i18n="User">Academic</span></a>
					<ul class="menu-content">
					  <?php if(Auth::user()->role_id == 29 || Auth::user()->is_cxo==1 || Auth::user()->user_details->degination == "CATEGORY HEAD" || Auth::user()->user_details->degination == "CITY HEAD"){ ?>	
						...
						?>
						  <li class=""><a href="{{ route('admin.academic.attendance') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Academic Attendance</span></a>
						  </li>  
						<?php } ?>                    
				  </ul>
				</li>
		...
		<?php if(Auth::user()->role_id == 29 || Auth::user()->role_id == 24){ ?>
			<li class="nav-item"><a href="#"><i class="feather icon-wind"></i><span class="menu-title" data-i18n="User">Holiday</span></a>
				<ul class="menu-content">
				  <li class="{{ Request::is('admin/holiday/create') ? 'active' : '' }}"><a href="{{ route('admin.holiday.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Add Holiday</span></a>
				  </li>
				  <li class="{{ Request::is('admin/holiday') ? 'active' : '' }}"><a href="{{ route('admin.holiday.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View</span></a>
				  </li>                       
			  </ul>
			</li>
		...
		<?php } ?>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Inventory Management</span></a>
				<ul class="menu-content">	
					...
					<?php } */ ?>
					<li class="{{ Request::is('admin/buyer') ? 'active' : '' }}"><a href="{{ route('admin.buyer.index') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Buyer List</span></a></li>
					...
					<?php if(Auth::user()->department_type != 10 || Auth::user()->id == 8799){ ?>
						<li class="nav-item"><a href="{{ route('admin.category.index') }}"><i class="feather icon-git-branch"></i><span class="menu-title" data-i18n="User">Category</span></a></li>
						<li class="{{ (Request::is('admin/product') || Request::is('admin/product/create')) ? 'active' : '' }}"><a href="{{ route('admin.product.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Products</span></a></li>
						<li class="{{ (Request::is('admin/inventory') || Request::is('admin/inventory/create')) ? 'active' : '' }}"><a href="{{ route('admin.inventory.index') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="View">Inventory List</span></a></li>
						<li class="{{ Request::is('admin/transfer-branch-inventory') ? 'active' : '' }}"><a href="{{ route('admin.transfer-branch-inventory') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Branch Transfer Inventory</span></a></li>
					<?php } ?>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">My Asset</span></a>
				<ul class="menu-content">
					<li class="{{ Request::is('admin/asset_pro') ? 'active' : '' }}"><a href="{{ route('admin.asset_pro.index') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Asset List</span></a>
					</li>
					<!--
					<li class="{{ Request::is('admin/asset_pro/employee-asset-pro') ? 'active' : '' }}"><a href="{{ route('admin.asset_pro.employee-asset-pro') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Employee Asset List</span></a>
					</li>
					-->			
				</ul>
			</li>
				...
				<ul class="menu-content">			
					...
					<li class="nav-item">
						...
						<ul class="menu-content">
							...
							<li><a href="{{ route('admin.request.reports.location-request-list') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Location Request List</span></a></li>
							-->
							<li><a href="{{ route('admin.request.reports.inventory-valuation') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Inventory Valuation</span></a></li>
							<li><a href="{{ route('admin.request.reports.monthly-master-data') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Monthly Master Data</span></a></li>
							<li><a href="{{ route('admin.store-purchase-dashboard') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Store/Pur. Dashboard</span></a></li>
						</ul>
					</li>
					<?php } ?>
					
					<li><a href="{{ route('admin.request.add-request') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Add</span></a></li>
					<li><a href="{{ route('admin.request.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">View</span></a></li>
					...
					<li><a href="{{ route('admin.request.requisition-request') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Requisition Request </span></a></li>
					<?php } ?>
					
					<?php if(Auth::user()->role_id == 25){ ?>
					<li><a href="{{ route('admin.request.request-approval') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">InStock Request Approval</span></a></li>
					<?php } ?>
					...
					<li><a href="{{ route('admin.request.manual-invoice') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Manual Invoice</span></a></li>
					<?php } ?>
					...
					<li><a href="{{ route('admin.request.po-list') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">PO / WO</span></a></li>
					<li><a href="{{ route('admin.request.vendor-invoice') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Vendor Invoice</span></a></li>
					<?php }  ?>
					...
					<li><a href="{{ route('admin.request-pending-accept') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Request Pending Accept</span></a></li>
					<?php } ?>
					...
					<li><a href="{{ route('admin.request.maintenance-list') }}"><i class="feather icon-list"></i><span class="menu-item" data-i18n="List">Maintenance Report</span></a></li>
					<?php } ?>
					...
					<li><a href="{{ route('admin.request.requested-asset-by-hr') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Requested Asset By HR</span></a></li>
					<li><a href="{{ route('admin.request.return-product-list') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Return Products List</span></a></li>
					<?php } ?>
				</ul>
			</li>
				...
				<li class="nav-item"><a href="#"><i class="feather icon-printer"></i><span class="menu-title" data-i18n="User">Salary</span></a>
					<ul class="menu-content">
					  ...
					  <!--li class="{{ Request::is('admin/import-salary') ? 'active' : '' }}"><a href="{{ route('admin.import-salary') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Import Salary</span></a>
						...
						<li class="{{ Request::is('admin/add-increment') ? 'active' : '' }}"><a href="{{ route('admin.add-increment') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Add Increment</span></a>
					  </li--> 
					</ul>
			...
			<ul class="menu-content">
				...
				<?php if(Auth::user()->role_id == 29){ ?>
					<li class="{{ Request::is('admin/employee/esic-no-detail') ? 'active' : '' }}"><a href="{{ route('admin.employees.esic-no-detail') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">ESI NO.</span></a>
					</li> 

					<li class="{{ Request::is('admin/employee/uan-no-detail') ? 'active' : '' }}"><a href="{{ route('admin.employees.uan-no-detail') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">UAN NO.</span></a>
					</li> 
					
					<li class="{{ Request::is('admin/employee/add-supervisor') ? 'active' : '' }}"><a href="{{ route('admin.employees.add-supervisor') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Add Supervisor</span></a>
					</li> 
					
					<li class="{{ Request::is('admin/employee/remove-supervisor') ? 'active' : '' }}"><a href="{{ route('admin.employees.remove-supervisor') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Remove Supervisor</span></a>
					</li> 
					
				<?php } ?> 	
				<?php if(Auth::user()->role_id == 21 || Auth::user()->role_id == 24 || Auth::user()->role_id == 29){ ?>
					<li class="{{ Request::is('admin/employee/job-role') ? 'active' : '' }}"><a href="{{ route('admin.employees.job-role') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Job Role</span></a>
					</li> 
				<?php } ?> 	
				
				<?php if(Auth::user()->role_id == 24 || Auth::user()->role_id == 29){ ?>
					<li class="{{ Request::is('admin/employee/probation-month') ? 'active' : '' }}"><a href="{{ route('admin.employees.probation-month') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Probation Month</span></a>
					</li> 
				<?php } ?>

					<li class="{{ Request::is('admin/employee/birthday') ? 'active' : '' }}"><a href="{{ route('admin.employees.birthday') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Birthday</span></a>
					</li> 
					
					<li class="{{ Request::is('admin/employee/work-anniversary') ? 'active' : '' }}"><a href="{{ route('admin.employees.work-anniversary') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Work Anniversary</span></a>
					</li> 			
			</ul>
			</li>
			<?php } ?>
			...
			<?php if(Auth::user()->role_id != 24 || Auth::user()->role_id != 29){ ?>
			  <li class="{{ Request::is('admin/employee/view-job-role') ? 'active' : '' }}"><a href="{{ route('admin.employees.view-job-role') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View Job Role</span></a>
			</li> 
			<?php } ?>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">Send Links</span></a>
				<ul class="menu-content">
					<li class="{{ Request::is('admin/links') ? 'active' : '' }}"><a href="{{ route('admin.links.faculty') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Faculty</span></a>
					</li>                       
			  </ul>
			</li>
			<?php
			...
			<!--li class="nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="User">Drivers</span></a>
				<ul class="menu-content">
					<li class="{{ Request::is('admin/drivers') ? 'active' : '' }}"><a href="{{ route('admin.drivers.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View</span></a>
					</li>                       
			  </ul>
			</li-->
			...
			<li class="nav-item"><a href="#"><i class="fa fa-video-camera"></i><span class="menu-title" data-i18n="User">Studios</span></a>
				...
				<?php if($studio_incharge==false){ ?>
				  ...
				  <li class="{{ Request::is('admin/assigned-incharge') ? 'active' : '' }}"><a href="{{ route('admin.assigned-incharge') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Assigned Incharge</span></a>
					</li>
				<?php } ?>

					<li class="{{ Request::is('admin/assigned-assistants') ? 'active' : '' }}"><a href="{{ route('admin.assigned-assistants') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Assigned Assistants</span></a>
					</li> 
			  </ul>
			</li>
			<?php } ?>
			...
			<li class="nav-item"><a href="#"><i class="fa fa-calendar"></i><span class="menu-title" data-i18n="User">Time Table Management</span></a>
				<ul class="menu-content">
				 ...
				 <li class="{{ Request::is('admin/timetable-history-reports') ? 'active' : '' }}"><a href="{{ route('admin.timetable-history-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Changes History</span></a>
				 </li> 
			...
			<li class="nav-item"><a href="#"><i class="fa fa-file-text"></i><span class="menu-title" data-i18n="User">Reports</span></a>
				<ul class="menu-content">
					...
					<li class="{{ Request::is('admin/batch-reports') ? 'active' : '' }}"><a href="{{ route('admin.batch-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Batch Reports</span></a>
					</li>
					<?php 
					...
					<li class="{{ Request::is('admin/batch-reports-shiftwise') ? 'active' : '' }}"><a href="{{ route('admin.batch-reports-shiftwise') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Batch Reports shift wise</span></a>
					</li>
					<!--li class="{{ Request::is('admin/dppsystem') ? 'active' : '' }}"><a href="{{ route('admin.dppsystem.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">DPP System</span></a>
					</li-->
					
					<li class="{{ Request::is('admin/faculty-early-delay-reports') ? 'active' : '' }}"><a href="{{ route('admin.faculty-early-delay-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Faculty Early/Delay Reports</span></a>
					</li>

					<li class="{{ Request::is('admin/timetable-change-counts') ? 'active' : '' }}"><a href="{{ route('admin.timetable-change-counts') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Timetablle Change Counts</span></a>
					</li>
					
				  <?php 
					$reportNotArr =  array(901,1056,5409,1859); 
					if(in_array(Auth::user()->id, $reportNotArr)){ ?> 	
						<li class="{{ Request::is('admin/faculty-hours-reports') ? 'active' : '' }}"><a href="{{ route('admin.faculty-hours-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Faculty Hours Reports</span></a>
						</li>
					<?php } ?>
					...
					<li class="{{ Request::is('studio-availability') ? 'active' : '' }}"><a href="{{ route('admin.studio-availability') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Studio Class Report</span></a>
					</li>
					<li class="{{ Request::is('faculty-agreement-hours') ? 'active' : '' }}"><a href="{{ route('admin.faculty-agreement-hours') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Agreement Hours Report</span></a>
					</li> 
					<li class="{{ Request::is('batch-hours-reports') ? 'active' : '' }}"><a href="{{ route('admin.batch-hours-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Batch Hours Report</span></a>
					</li> 
					
					<li class="{{ Request::is('admin/faculty-monthly-hours-reports') ? 'active' : '' }}"><a href="{{ route('admin.faculty-monthly-hours-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Faculty Monthly Hours</span></a>
					</li>
					
					<li class="{{ Request::is('admin/class-type-wise') ? 'active' : '' }}"><a href="{{ route('admin.class-type-wise') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Class Type Wise </span></a>
					</li>
			...
			?>
			<li class="{{ Request::is('admin/faculty-topic') ? 'active' : '' }}">
				<a href="{{ route('admin.faculty-topic') }}"><i class="feather icon-circle"></i>
			...
			<?php if(Auth::user()->user_details->degination=='CENTER HEAD' || Auth::user()->user_details->degination=='SR EXECUTIVE'){ ?>
				<li class="{{ Request::is('batch-hours-reports') ? 'active' : '' }}">
					<a href="{{ route('admin.batch-hours-reports') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Batch Hours Report</span></a>
				</li> 
			<?php } ?>
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="">
					<a href="{{ route('admin.task-add') }}"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Add Task</span></a>
					</li>    
					<li class="">
						<a href="{{ route('admin.view-task') }}"><i class="feather icon-slack"></i><span class="menu-title" data-i18n="User">View Task</span></a>
					</li>
				</ul>
			</li>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-clock"></i><span class="menu-title" data-i18n="User">Attendance</span></a>
				<ul class="menu-content">
				   ...
				   <?php }*/ ?>
					...
					<li class="{{ Request::is('admin/attendance/incomplete-attendence') ? 'active' : '' }}"><a href="{{ route('admin.attendance.incompleteattendence') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Incomplete Attendance</span></a>
					</li>
					<?php } ?>
					
					
					<?php if(Auth::user()->role_id == 29){ ?>
					<li class="{{ Request::is('admin/attendance/final-attendence') ? 'active' : '' }}"><a href="{{ route('admin.attendance.final-attendence') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Final Attendence</span></a>
					</li>
					
					<li class="{{ Request::is('admin/leave-wages') ? 'active' : '' }}"><a href="{{ route('admin.leave.leave-wages') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Leave Wages</span></a>
					</li>
					
					<li class="{{ Request::is('admin/attendance-lock/index') ? 'active' : '' }}"><a href="{{ route('admin.attendance-lock.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Lock Attendance/Leave</span></a>
					</li>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="User">Leave</span></a>
				<ul class="menu-content">
					...
					<?php if(Auth::user()->role_id == 29 || Auth::user()->role_id == 24){ ?>
						<li class="{{ Request::is('admin/paternity-leave-list') ? 'active' : '' }}"><a href="{{ route('admin.leave.paternity_leave_list') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Paternity Leave</span></a>
				</li> 
					<?php } ?>
					<li class="{{ Request::is('admin/leave-count-view') ? 'active' : '' }}"><a href="{{ route('admin.leave.leavecount') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Leave Count View</span></a>
					</li>
					<?php if(Auth::user()->role_id == 29 || Auth::user()->role_id == 21 || Auth::user()->role_id == 24){ ?>
					<li class="{{ Request::is('admin/leave-full-detail') ? 'active' : '' }}"><a href="{{ route('admin.leave.leave-full-detail') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Leave Full Details</span></a>
					</li>
					<?php } ?>
					<?php if(Auth::user()->role_id == 29){ ?>
					<!--li class="{{ Request::is('admin/approved-leave') ? 'active' : '' }}"><a href="{{ route('admin.leave.approved-leave') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Approved Leave</span></a>
					</li--> 
					<?php } ?>	
				</ul>
			</li>
			...
			<li class="nav-item"><a href="#"><i class="fa fa-folder-open"></i><span class="menu-title" data-i18n="User">Department</span></a>
				<ul class="menu-content">
					...
					<li class="{{ Request::is('admin/sub_department') ? 'active' : '' }}"><a href="{{ route('admin.sub_department.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Add Sub Department</span></a>
					</li>
			...
			if(Auth::user()->department_type == 37){
				...
				<li class="nav-item"><a href="#"><i class="fa fa-file-video-o"></i><span class="menu-title" data-i18n="User">Training</span></a>
					<ul class="menu-content">
						<li class="{{ Request::is('admin/training_video_category') ? 'active' : '' }}"><a href="{{ route('admin.training_video_category.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Category</span></a>
						</li>    
						<li class="{{ Request::is('admin/training_video') ? 'active' : '' }}"><a href="{{ route('admin.training_video.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Video</span></a>
						</li>  
						<li class="{{ Request::is('admin/training_pdf') ? 'active' : '' }}"><a href="{{ route('admin.training_pdf.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">PDF</span></a>  
					</li> 					
					</ul>
				</li>
				<?php
			...
			<li class="nav-item"><a href="#"><i class="fa fa-link"></i><span class="menu-title" data-i18n="User">Knowledge Based</span></a>
				<ul class="menu-content">
					<li class="{{ Request::is('admin/knowledge_based_category') ? 'active' : '' }}"><a href="{{ route('admin.knowledge_based_category.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Category</span></a>
					</li>    
					<li class="{{ Request::is('admin/knowledge_based') ? 'active' : '' }}"><a href="{{ route('admin.knowledge_based.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View</span></a>
					</li>                       
				</ul>
			</li>
			...
			<li class="nav-item"><a href="#"><i class="fa fa-laptop"></i><span class="menu-title" data-i18n="User">Meeting</span></a>
				<ul class="menu-content">  
					<?php if(Auth::user()->role_id == 29){ ?>
					<li class="{{ Request::is('admin/meeting-places') ? 'active' : '' }}"><a href="{{ route('admin.meeting-places') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Meeting Places</span></a>
					</li>
					<?php } ?>
					<li class="{{ Request::is('admin/appointment') ? 'active' : '' }}"><a href="{{ route('admin.appointment') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Meeting</span></a>
					</li>  
				</ul>
			</li> 
			...
			<li class="nav-item"><a href="#"><i class="fa fa-money"></i><span class="menu-title" data-i18n="User">Expense</span></a>
				<ul class="menu-content">
					<li class="{{ Request::is('admin/expense_category') ? 'active' : '' }}"><a href="{{ route('admin.expense_category.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Category</span></a>
					</li>    
					<li class="{{ Request::is('admin/expense') ? 'active' : '' }}"><a href="{{ route('admin.expense.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View</span></a>
					</li>                       
				</ul>
			</li>
			...
			<li class="nav-item"><a href="#"><i class="fa fa-file-text-o"></i><span class="menu-title" data-i18n="User">Material Requisition</span></a>
				<ul class="menu-content">    
					<li class="{{ Request::is('admin/material-requisition') ? 'active' : '' }}"><a href="{{ route('admin.material-requisition.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">View</span></a>
					</li>                       
				</ul>
			</li>
			...
			<li class="nav-item"><a href="#"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Appraisal</span></a>
				<ul class="menu-content">   
					<?php if(Auth::user()->role_id == 29){ ?> 
					<li class="{{ Request::is('admin/appraisal') ? 'active' : '' }}"><a href="{{ route('admin.appraisal.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Appraisal Questions</span></a>
					</li> 
					<?php } ?>
					 
					<li class="{{ Request::is('admin/appraisal-user-list') ? 'active' : '' }}"><a href="{{ route('admin.appraisal-user-list') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Appraisal User List</span></a>
					</li> 
			...
			<?php if(Auth::user()->role_id == 29 || !empty($check_support_admin)){ ?>
				<li class="nav-item"><a href="#"><i class="feather icon-user-plus"></i><span class="menu-title" data-i18n="User">Support</span></a>
					<ul class="menu-content">
						<li class="{{ Request::is('admin/support-dashboard') ? 'active' : '' }}">
						<a href="{{ route('admin.support-dashboard') }}"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Message to Chairman Dashboard</span></a>
						</li>    
						<li class="{{ Request::is('admin/support_category') ? 'active' : '' }}">
							<a href="{{ route('admin.support_category.index') }}"><i class="feather icon-slack"></i><span class="menu-title" data-i18n="User">Message to Chairman Category</span></a>
						</li>
						<li class="{{ Request::is('admin/support_user') ? 'active' : '' }}">
							<a href="{{ route('admin.support_user.index') }}"><i class="feather icon-headphones"></i><span class="menu-title" data-i18n="User">Message to Chairman User</span></a>
						</li>  					
					</ul>
				</li>
			<?php } ?> 
			...
			<?php if(!empty($check_enquiry_modules) || !empty($check_support_admin) || in_array(Auth::user()->role_id,$support_role)){ ?>
			  ...
			  <li class="nav-item d-none"><a href="{{ route('admin.enquiry.index') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Enquiry</span></a></li>
			...
			?>
			 <li class="nav-item"><a href="{{ route('admin.support-discussion') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Chopal Discussion</span></a></li>
			<?php } ?>
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="">
					<a href="{{ route('admin.permission-add') }}"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Add Role</span></a>
					</li>    
					<li class="">
						<a href="{{ route('admin.permission-list') }}"><i class="feather icon-slack"></i><span class="menu-title" data-i18n="User">View Role</span></a>
					</li>
				</ul>
			</li>
			<?php } ?>
			...
			<?php if(Auth::user()->role_id == 24 || Auth::user()->role_id == 29){ ?>
			<li class="nav-item"><a href="{{ route('admin.course_category.index') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Course Category</span></a></li>
			<?php } ?>
			
			<?php if(Auth::user()->role_id == 24 || Auth::user()->role_id == 29 || Auth::user()->user_details->degination == 'DPP & TEST PAPER INCHARGE'){ ?>
			<li class="nav-item"><a href="{{ route('admin.batch-test-report') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Batch Test Report</span></a></li>
			<?php } ?>
			
			<?php if(Auth::user()->role_id == 29){ ?>
			<li class="nav-item"><a href="{{ route('admin.faculty-leave') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Faculty Leave</span></a></li>
					</li>
			<?php } ?>
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="">
					<a href="{{ route('admin.feedback-form') }}"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Feedback Form</span></a>
					</li>    
					<li class="">
						<a href="{{ route('admin.feedback-question') }}"><i class="feather icon-slack"></i><span class="menu-title" data-i18n="User">Feedback Question</span></a>
					</li>
				</ul>
			</li>
			
			
			<li class="nav-item"><a href="{{ route('admin.employee-complaint-view') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Employee Complaint</span></a></li>
			<?php } ?>
			...
			<li class="nav-item">
				...
				<ul class="menu-content">
					<li class="">
					<a href="{{ route('admin.sendsms_textlocal') }}"><i class="feather icon-database"></i><span class="menu-title" data-i18n="User">Send Template SMS</span></a>
					</li>    
					<li class="">
						<a href="{{ route('admin.sendsms_templates') }}"><i class="feather icon-slack"></i><span class="menu-title" data-i18n="User">All Templates</span></a>
					</li>
				</ul>
			</li>
			<?php } ?>
			...
			<li class="nav-item"><a href="{{ route('admin.crm-desk.search') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">CRM-DESK</span></a></li>
			<!--
			<li class="nav-item"><a href="{{ route('admin.student-attendance') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">Student Attendance</span></a></li>-->
			<?php } ?>
			<?php
			...
			<li class="nav-item">
				...
				<ul class="menu-content">			
					...
					<?php if(in_array(Auth::user()->id,[901,7087])) {?>
						<li class="{{ Request::is('admin/std-attendence-anupriti') ? 'active' : '' }}">
							<a href="{{ route('admin.std-attendence-anupriti') }}">
			...
			?>
			<li><a href="{{ route('admin.studnet-attendance-notification') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Student Notification</span></a></li> 
			<?php } ?>
			
			<?php 
				$trUser = array(1292,1557,7087); 
				if(Auth::user()->role_id == 29 || in_array(Auth::user()->id, $trUser)){ ?>
			<li><a href="{{ route('admin.batch-test-report-new') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Test Report</span></a></li> 	
			<?php } ?>
			...
			<li><a href="{{ route('admin.send-faculty-pdf-view') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Send Faculty PDF</span></a></li> 
			<?php } ?>
		<?php } ?>
		...
		<li class="nav-item"><a href="{{ route('admin.it-deo-work-report') }}"><i class="feather icon-help-circle"></i><span class="menu-title" data-i18n="User">IT DEO Report</span></a></li>
		<?php } ?>
		...
		<li class="nav-item">
			<a href="{{ route('admin.payment.index') }}"><i class="fa fa-inr"></i><span class="menu-title" data-i18n="User">Payment Link</span></a> 
		</li>
		<?php } ?>
		
		<?php if(Auth::user()->id==901 || Auth::user()->id==7651){ ?>
		<li class="nav-item">
			<a href="{{ route('admin.pincode.index') }}"><i class="feather icon-wind"></i><span class="menu-title" data-i18n="User">Pincode</span></a> 
		</li>
		<?php } ?>
		
		<?php if(Auth::user()->id==901){ ?>
		<li class="nav-item">
			<a href="{{ route('admin.freelancer.index') }}"><i class="feather icon-wind"></i><span class="menu-title" data-i18n="User">Freelancer</span></a>
		</li>	
		<?php 
		} ?>
		...
		<li class="nav-item">
			...
			?>
				<li class="nav-item">
					<a href="{{ route('admin.newcoupon.index') }}"><i class="fa fa-check"></i><span class="menu-title" data-i18n="User">Request Coupon</span></a>
				</li>
				<li class="nav-item">
					<a href="{{ route('admin.newcoupon.historyList') }}"><i class="fa fa-list"></i><span class="menu-title" data-i18n="User">All Requests List</span></a>
				</li>
					<?php
			}
			...
			if(Auth::user()->id==901 || Auth::user()->id == 7087 || Auth::user()->id == 8088 || Auth::user()->id == 1665){
				?>
				<li class="nav-item">
					<a href="{{ route('admin.newcoupon.historyList') }}"><i class="fa fa-list"></i><span class="menu-title" data-i18n="User">Approval Request</span></a>
				</li>
			<?php } ?>
			</ul>
		</li>
		...
		<li class="nav-item">
			<a href="{{ route('admin.faculty-sme.index') }}"><i class="fa fa-university"></i><span class="menu-title" data-i18n="User">Faculty Requests</span></a>
		</li>
		<?php  } ?>
		
		<?php if(Auth::user()->role_id==3 || Auth::user()->department_type==2 || in_array(Auth::user()->id,[901,6321,1078])){ ?>
		<li class="nav-item">
			<a href="{{ route('admin.faculty-sme.faculty-sme-assistant') }}"><i class="fa fa-university"></i><span class="menu-title" data-i18n="User">Panel PDF</span></a>
		</li>
		<?php  } ?>
		...
		<li class="nav-item">
			<a href="{{ route('admin.faculty-sme.sme-visibility') }}"><i class="fa fa-university"></i><span class="menu-title" data-i18n="User">SME Visibility</span></a>
		</li>
		<?php } ?>
		...
		<li class="nav-item">
			<a href="{{ route('coupon.index') }}"><i class="fa fa-university"></i><span class="menu-title" data-i18n="User">Assign Coupon <sup class="text-danger">New</sup></span></a>
		</li>
		<?php } ?>

		<?php if(Auth::user()->id==8377 || Auth::user()->id==901 || Auth::user()->user_details->degination == "CENTER HEAD"){ ?>
		<li class="nav-item">
			<a href="{{ route('view-cleanliness-report') }}"><i class="fa fa-bath"></i><span class="menu-title" data-i18n="User">Cleanliness Report</span></a>
		</li>
		<?php } ?>

		<?php if(Auth::user()->id == 8377 || Auth::user()->id==901){ ?>
		<li class="nav-item">
			<a href="{{ route('software-management') }}" title="Software Management"><i class="fa fa-desktop"></i><span class="menu-title" data-i18n="User">Software Management</span></a>
		</li>
		<?php } ?>
		
		
		<li class="nav-item">
			<a href="{{ route('request-access') }}" title="Request Access">
				<i class="fa fa-desktop"></i>
				<span class="menu-title" data-i18n="User"> Request Access
					@if (!empty($hasRequestAccessUpdates))
		...
		<li class="nav-item">
			...
			<ul class="menu-content">
				<li>
					<a href="{{ route('admin.faculty-utilization-dashboard') }}" title="Academic Access">
						<i class="fa fa-desktop"></i>
				...
				<li>
					<a href="{{ route('admin.subject-utilization-dashboard') }}" title="Academic Access">
						<i class="fa fa-desktop"></i>
						<span class="menu-title" data-i18n="User"> 
							Subject Dashboard
						</span>
				...
				<li>
					<a href="{{ route('admin.academic-faculty-report') }}" title="Academic Access">
						<i class="fa fa-desktop"></i>
						<span class="menu-title" data-i18n="User"> 
							Faculty Overview
						</span>
				...
				<li class="nav-item">
					<a href="{{ route('admin.prediction-report') }}" title="Prediction Report">
						<i class="fa fa-desktop"></i>
						<span class="menu-title" data-i18n="User"> 							
							Prediction Report			
						</span>
				...
				<li class="nav-item">
					<a href="{{ route('admin.faculty-plan') }}" title="Faculty Plan">
						<i class="fa fa-desktop"></i>
						<span class="menu-title" data-i18n="User"> 							
							Faculty Plan		
						</span>
				...
				<li class="nav-item">
					<a href="{{ route('admin.proposed-plan') }}" title="Faculty Plan">
						<i class="fa fa-desktop"></i>
						<span class="menu-title" data-i18n="User"> 							
							Proposed plan	
						</span>
