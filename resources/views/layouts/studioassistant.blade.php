...
<head>
    ...
    <title>{{ config('app.name') }} - Studio Assistant Panel</title>
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <!-- BEGIN: Header-->
    @include('layouts.studioassistant.header')
    <!-- END: Header-->
    <!-- BEGIN: Main Menu-->
    @include('layouts.studioassistant.sidebar')
    <!-- END: Main Menu-->
    ...
    <!-- BEGIN: Footer-->
    @include('layouts.studioassistant.footer')
    <!-- END: Footer-->
