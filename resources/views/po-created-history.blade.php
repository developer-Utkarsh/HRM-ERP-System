		...
		<div class="content-body">
			<section id="data-list-view" class="data-list-view-header">
				<div class="text-right pb-2 d-none">
					<a href="{{ route('po-created-history',[$buyer_id]) }}" class="btn-dark p-1">Back</a>
				</div>
				<div class="card mb-1">
					<div class="card-content collapse show">
						<div class="card-body">
							...
							<form class="" action="{{ route('po-created-history',[$buyer_id]) }}" method="get">
								...
								<button type="button" class="btn btn-primary" onclick="location.href = '{{ route('po-created-history',[$buyer_id]) }}';">Reset</button>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="card-content">
						<div class="card-body">
							...
							<div class="row" style="padding-top:5px;">
								...
								<div class="col-7 font-weight-bold">: <a href="{{ route('web-view-poprint', [$g->id,$buyer_id]) }}">Download</a></div>
							</div>
