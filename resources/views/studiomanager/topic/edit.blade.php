					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.topics.update', $topic->id) }}" method="post" enctype="multipart/form-data">
										@method('PATCH')
										@csrf
										<div class="form-body">
											<div class="row">
												<div class="col-md-6 col-12" id="course_loader">
													<div class="form-group">
														...
														<select class="form-control course_id" name="course_id">
															...
															<option value="{{ $value->id }}" @if($topic->course_id == $value->id) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
												...
												<div class="col-md-6 col-12" id="subject_loader">
													<div class="form-group">
														...
														<select class="form-control subject_id" name="subject_id">
															@if(isset($topic->subject_id) && !empty($topic->subject_id))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control chapter_id" name="chapter_id">
															@if(isset($topic->chapter_id) && !empty($topic->chapter_id))
															<option value="{{ $topic->chapter_id }}">{{ $topic->chapter->name }}</option>
															@endif
														</select>
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="name" class="form-control" value="{{ old('name', $topic->name) }}" placeholder="Topic Name">
														@if($errors->has('name'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="duration" class="form-control" value="{{ old('duration', $topic->duration) }}" placeholder="Duration">
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group d-flex align-items-center">
														...
														<label>
															<input type="radio" name="status" value="1" {{ ($topic->status == 1) ? "checked" : ""}}>
															Active
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="status" value="0" {{ ($topic->status == 0) ? "checked" : ""}}>
															Inactive
														</label>
													</div>
												</div>                                       
