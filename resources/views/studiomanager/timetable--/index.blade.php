									...
									<tbody>
										...
										<tr>
											<td scope="row text-center">
												<p>{{ $value->name }}</p>
												@if($user->role_id==29 || $user->role_id==4)						
												<a href="#myModal" data-toggle="modal" studioname="{{ $value->name  }} - Set Class" data-id="{{ $value->id }}" data-assistant_id="{{ $value->assistant_id }}" class="btn btn-sm btn-primary get_studio_data">
													Set Class
												</a>
												@endif
											</td>
						...
						<div class="modal-content">
							<form method="post" id="submit_timetable_form">
								...
								<div class="modal-body">
									<div class="form-body">
										<div class="row pt-2">
											<?php $batch = \App\Batch::where('status', '1')->orderBy('id', 'asc')->get(); ?>
											...
											<div class="col-md-6 col-12" id="course_loader" style="display: none;">
