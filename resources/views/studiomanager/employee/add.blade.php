		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-8">
						<h2 class="content-header-title float-left mb-0">Add Faculty</h2>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.employees.store') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
												<div class="col-md-4 col-12" style="display: none;">
													<div class="form-group">
														...
														<select class="form-control get_role select-multiple1" name="role_id">
															...
															<option value="{{ $value->id }}" @if($value->id == 2) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
														@endif
												...
												<div class="col-md-4 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple1" name="supervisor_id[]" multiple>
															...
															<option value="{{ $value->id }}" @if($value->id == old('supervisor_id')) selected="selected" @endif>{{ $value->name . ' ( ' .$value->register_id.' ) ' }}</option>
															@endforeach
														</select>
														@endif
												...
												<div class="col-md-6 col-12 show_fields subject_div" style="display: ;">
													<div class="form-group">
														...
														<select class="form-control select-multiple" multiple="multiple" name="subject_id[]">
															...
															<option value="{{ $value->id }}" <?php if( !empty(old('subject_id')) && in_array($value->id,old('subject_id'))){ echo "selected";} ?> >{{ $value->name }}</option>
															@endforeach
														</select>
														@endif
													</div>
												...
												<div class="col-md-6 col-12 show_fields" style="display: ;">
													<div class="form-group">
														<label for="first-name-column">Agreement</label>														
														<select class="form-control get_hours" name="agreement">
															<option value=""> - Select Type - </option>
															<option value="Yes" @if('Yes' == old('agreement')) selected="selected" @endif>Yes</option>
															<option value="No" @if('No' == old('agreement')) selected="selected" @endif>No</option>
														</select>
													</div>
												</div>
												
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														<label for="first-name-column">Committed Hours</label>
														<input type="text" class="form-control com_hours" placeholder="Committed Hours" name="committed_hours" value="{{ old('committed_hours') }}">
													</div>
												</div>
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														<label for="first-name-column">Start Date</label>
														<input type="date" class="form-control" placeholder="Start Date" name="agreement_start_date" value="{{ old('agreement_start_date') }}" >
													</div>
												</div>
												<div class="col-md-4 col-12 committed_fields" style="display:none ;">
													<div class="form-group">
														<label for="first-name-column">End Date</label>
														<input type="date" class="form-control" placeholder="End Date" name="agreement_end_date" value="{{ old('agreement_end_date') }}">
													</div>
												</div>
												
												
											</div>
											<div class="row show_fields" style="display: block;">
											...
											<div class="row">
												...
												<!--div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Register Id" name="register_id" value="{{ old('register_id') }}">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Nominee Name" name="nominee_name" value="{{ old('nominee_name') }}">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control" placeholder="DOB" name="dob" value="{{ old('dob') }}" max="<?=date('Y-m-d')?>">
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														<label for="first-name-column">Father's Name</label>
														<input type="text" class="form-control" placeholder="Father's Name" name="fname" value="{{ old('fname') }}">
														@if($errors->has('fname'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Mother's Name" name="mname" value="{{ old('mname') }}">
														@if($errors->has('mname'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Contact Number" name="contact_number" value="{{ old('contact_number') }}">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Alternate Contact Number" name="alternate_contact_number" value="{{ old('alternate_contact_number') }}">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="email" class="form-control" placeholder="Alternate Email" name="alternate_email" value="{{ old('alternate_email') }}">
													</div>
												</div>
												<div class="col-md-6 col-12">
												...
												<div class="col-md-6 col-12">
													<div class="form-group d-flex align-items-center">
														...
														<label>
															<input type="radio" name="material_status" value="Single" {{ (old('material_status') == 'Single') ? "checked" : ""}}>
															Single
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="material_status" value="Married" {{ (old('material_status') == 'Married') ? "checked" : ""}}>
															Married
														</label>
													</div>
												...
												<div class="col-md-6 col-12 anniversary_div hide">
													<div class="form-group">
														...
														<input type="date" class="form-control" name="anniversary_date" value="{{ old('anniversary_date') }}" max="<?=date('Y-m-d')?>">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<textarea class="form-control" name="c_address" placeholder="Current Address">{{ old('c_address') }}</textarea>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<textarea class="form-control" name="p_address" placeholder="Permanent Address">{{ old('p_address') }}</textarea>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple2" name="employee_type">
															...
															<option value="Fulltime" @if('Fulltime' == old('employee_type')) selected="selected" @endif>Fulltime</option>
															<option value="PartTime" @if('PartTime' == old('employee_type')) selected="selected" @endif>Part Time</option>
															<option value="Hourlybasis" @if('Hourlybasis' == old('employee_type')) selected="selected" @endif>Hourly Basis</option>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple3" name="degination">
															...
															<option value="{{ $value->name }}" @if($value->name == old('degination')) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple4" name="blood_group">
															...
															<option value="A+" @if('A+' == old('blood_group')) selected="selected" @endif>A+</option>
															<option value="A-" @if('A-' == old('blood_group')) selected="selected" @endif>A-</option>
															<option value="B+" @if('B+' == old('blood_group')) selected="selected" @endif>B+</option>
															<option value="B-" @if('B-' == old('blood_group')) selected="selected" @endif>B-</option>
															<option value="O+" @if('O+' == old('blood_group')) selected="selected" @endif>O+</option>
															<option value="O-" @if('O-' == old('blood_group')) selected="selected" @endif>O-</option>
															<option value="AB+" @if('AB+' == old('blood_group')) selected="selected" @endif>AB+</option>
															<option value="AB-" @if('AB-' == old('blood_group')) selected="selected" @endif>AB-</option>
														</select>
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control select-multiple5" name="branch_id[]" multiple>
															...
															<option value="{{ $value->id }}" <?php if( !empty(old('branch_id')) && in_array($value->id,old('branch_id'))){ echo "selected";} ?>>{{ $value->name }}</option>
															@endforeach
														</select>
														@endif
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="date" class="form-control joining_date" name="joining_date" placeholder="Joining Date" value="{{ old('joining_date') }}">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control pl" name="pl" placeholder="PL" value="{{ old('pl') }}" readonly >
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														<label for="company-column">CL</label>
														<input type="text" class="form-control cl" name="cl" placeholder="CL" value="{{ old('cl') }}" readonly >
													</div>
												</div>
												<div class="col-md-6 col-12">
													<div class="form-group">
														<label for="company-column">SL</label>
														<input type="text" class="form-control sl" name="sl" placeholder="SL" value="{{ old('sl') }}" readonly >
													</div>
												</div>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control total_time" name="total_time" placeholder="Total Time ( in minutes )" value="{{ old('total_time') }}">
														@if($errors->has('total_time'))
															<span class="text-danger">{{ $errors->first('total_time') }} </span>
														@endif
													</div>
												</div>
										...
										<div class="row">
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="Account Number" name="account_number" value="{{ old('account_number') }}">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Bank Name" name="bank_name" value="{{ old('bank_name') }}" onkeypress="return blockSpecialChar(event)">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="IFSC Code" name="ifsc_code" value="{{ old('ifsc_code') }}">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													<label for="first-name-column">Branch</label>
													<input type="text" class="form-control" placeholder="Branch" name="bank_branch" value="{{ old('bank_branch') }}">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="Net Salary" name="net_salary" value="{{ old('net_salary') }}">
											...
											<div class="col-md-6 col-12">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="TDS" name="tds" value="{{ old('tds')?old('tds'):0 }}">
													@if($errors->has('tds'))
										...
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="PF Amount" name="pf_amount" value="{{ old('pf_amount') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="date" class="form-control" name="pf_date" value="{{ old('pf_date') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<select class="form-control" name="is_pf">
														...
														<option value="No" @if('No' == old('is_pf')) selected="selected" @endif>No</option>
														<option value="Yes" @if('Yes' == old('is_pf')) selected="selected" @endif>Yes</option>
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="ESIC Amount" name="esi_amount" value="{{ old('esi_amount') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="date" class="form-control" name="esi_date" value="{{ old('esi_date') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<select class="form-control" name="is_esi">
														<!--option value=""> - Select - </option-->
														<option value="No" @if('No' == old('is_esi')) selected="selected" @endif>No</option>
														<option value="Yes" @if('Yes' == old('is_esi')) selected="selected" @endif>Yes</option>
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Esic No" name="esic_no" value="{{ old('esic_no') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Addhar Card No" name="aadhar_card_no" value="{{ old('aadhar_card_no') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Name As Per Aadhar" name="aadhar_name" value="{{ old('aadhar_name') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Pan No" name="pan_no" value="{{ old('pan_no') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Name As Per Pan" name="pan_name" value="{{ old('pan_name') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Official No" name="official_no" value="{{ old('official_no') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Previous Experience" name="previous_experience" value="{{ old('previous_experience') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="UAN No" name="uan_no" value="{{ old('uan_no') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Name As Per Bamnk" name="bank_emp_name" value="{{ old('bank_emp_name') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="time" class="form-control" name="timing_shift_in" value="{{ old('timing_shift_in') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="time" class="form-control" name="timing_shift_out" value="{{ old('timing_shift_out') }}">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="EMP File No" name="emp_file_no" value="{{ old('emp_file_no') }}">
...
<script type="text/javascript">
	...
	$(document).on("change",".joining_date",function(){
		...
		$.ajax({
			type : 'POST',
			url : '{{ route('studiomanager.employee.get_leave_month') }}',
