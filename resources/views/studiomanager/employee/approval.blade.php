				...
				<div class="row">
									...
									<div class="col-12 col-md-12 col-lg-5">
										<table class="ml-0 ml-sm-0 ml-lg-0">
											...
											<tr>
												...
												<td>{{ isset($employee->user_details->branch->name) ?  $employee->user_details->branch->name : '' }}</td>
											</tr>
											<tr>
												<td class="font-weight-bold">Degination</td>
												<td>{{ isset($employee->user_details->degination) ?  $employee->user_details->degination : '' }}
												<?php
											...
											<tr>
												...
												<td>{{ isset($employee->user_details->employee_type) ?  $employee->user_details->employee_type : '' }}
												<?php
							...
							<div class="card-body">
								<table>
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->alternate_contact_number) ?  $employee->user_details->alternate_contact_number : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->alternate_email) ?  $employee->user_details->alternate_email : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->fname) ?  $employee->user_details->fname : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->mname) ?  $employee->user_details->mname : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->gender) ?  $employee->user_details->gender : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->material_status) ?  $employee->user_details->material_status : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->c_address) ?  $employee->user_details->c_address : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->p_address) ?  $employee->user_details->p_address : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->blood_group) ?  $employee->user_details->blood_group : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->joining_date) ?  $employee->user_details->joining_date : '' }}
										<?php
							...
							<div class="card-body">
								<table>
									<tr>
										...
										<td>
										{{ isset($employee->user_details->account_number) ?  $employee->user_details->account_number : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->bank_name) ?  $employee->user_details->bank_name : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->ifsc_code) ?  $employee->user_details->ifsc_code : '' }}
										<?php
									...
									<tr>
										<td class="font-weight-bold">Branch</td>
										<td>
										{{ isset($employee->user_details->bank_branch) ?  $employee->user_details->bank_branch : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->net_salary) ?  $employee->user_details->net_salary : '' }}
										<?php
									...
									<tr>
										...
										<td>
										{{ isset($employee->user_details->tds) ?  $employee->user_details->tds : '' }}
										<?php
					...
					<div class="col-12">
						<div class="card">
							...
							<form class="form" action="{{ route('studiomanager.employees.approval_update', $employee->id) }}" method="post" enctype="multipart/form-data">
							@csrf
							<div class="card-body">
								<div class="row">
									<div class="col-md-6 col-12">
