					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.employees.update', $employee->id) }}" method="post" enctype="multipart/form-data">
										@method('PATCH')
										@csrf
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-4 col-12 committed_fields" style="display: <?=$is_aggrement?> ">
													<div class="form-group">
														...
														<input type="text" class="form-control com_hours" placeholder="Committed Hours" name="committed_hours" value="{{ old('committed_hours', $employee->committed_hours) }}">
													</div>
												</div>
												...
												<div class="col-md-4 col-12 committed_fields" style="display:<?=$is_aggrement?>;">
													<div class="form-group">
														...
														<input type="date" class="form-control" placeholder="Start Date" name="agreement_start_date" value="{{ old('agreement_start_date', $employee->agreement_start_date) }}" >
													</div>
												</div>
												<div class="col-md-4 col-12 committed_fields" style="display:<?=$is_aggrement?>;">
													<div class="form-group">
														<label for="first-name-column">End Date</label>
														<input type="date" class="form-control" placeholder="End Date" name="agreement_end_date" value="{{ old('agreement_end_date', $employee->agreement_end_date) }}">
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="number" class="form-control" placeholder="Contact Number" name="contact_number" value="{{ old('contact_number', isset($employee->mobile) ?  $employee->mobile : '') }}">
												...
												<div class="col-md-6 col-12 anniversary_div @if($employee->user_details->material_status == 'Married'){{'show'}}@else{{'hide'}}@endif">
													@if($employee->user_details)
													<?php 
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														@endif
														<input type="date" class="form-control joining_date" name="joining_date" placeholder="Joining Date" value="{{ old('joining_date', isset($joining_date) ? $joining_date : '') }}">
													</div>
												</div>
										...
										<div class="row">
											...
											<div class="col-md-6 col-12" style="display:none;">
												<div class="form-group">
													...
													<input type="number" class="form-control" placeholder="Net Salary" name="net_salary" value="{{ old('net_salary', isset($employee->user_details->net_salary) ? $employee->user_details->net_salary : '0') }}">
										...
										<div class="row">
											...
											<div class="col-md-4 col-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Official No" name="official_no" value="{{ old('official_no', isset($employee->user_details->official_no) ? $employee->user_details->official_no : '') }}">
