					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.subject-reports') }}" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="{{ route('studiomanager.subject-reports') }}" class="btn btn-warning">Reset</a>
				...
				if (count($get_data) > 0) {
					foreach ($get_data as $subjectArray) {
						...
						<?php  
							...
							?>
							<tr style="">
							<td colspan="7"> <strong>Total Duration:</strong> &nbsp; {{ $schedule_total_tt }} Hours</td>
							<td colspan="2"></td>
							</tr>
							<?php
						} 
