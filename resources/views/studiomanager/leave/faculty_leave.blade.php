					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.leave.faculty-leave') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-md-6">
											...
											<fieldset class="form-group" >		
												...
												<a href="{{ route('studiomanager.leave.faculty-leave') }}" class="btn btn-warning">Reset</a>
					...
					foreach ($get_data as $faculty) {
						...
						?>
							...
							<div class="assistant_form">
								...
								<?php
								if(empty(app('request')->input('fdate')) || strtotime(app('request')->input('fdate'). " +2 days") >= strtotime(date('Y-m-d'))){
									?>
