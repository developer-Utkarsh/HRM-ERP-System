					...
					<div class="col-12">
						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.links.faculty_link') }}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-6 col-12 mt-4">
													...
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="{{route('studiomanager.links.all_send', 'faculty')}}" class="btn btn-primary mr-1 mb-1" >All Faculty Send Link</a>
												</div>
											</div>
										</div>
									</form>
										...
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-6 col-12 mt-4">
													<button type="submit" class="btn btn-primary mr-1 mb-1">Send Link</button>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="{{route('studiomanager.links.all_send', 'studio_manager')}}" class="btn btn-primary mr-1 mb-1" >All Studio Manager / TimeTable Manager Send Link</a>
												</div>
											</div>
										</div>
									</form>
										...
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-6 col-12 mt-4">
													<button type="submit" class="btn btn-primary mr-1 mb-1">Send Link</button>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="{{route('studiomanager.links.all_send', 'studio_assistant')}}" class="btn btn-primary mr-1 mb-1" >All Studio Assistant Send Link</a>
												</div>
											</div>
										</div>
									</form>
										...
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-6 col-12 mt-4">
													<button type="submit" class="btn btn-primary mr-1 mb-1">Send Link</button>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="{{route('studiomanager.links.all_send', 'drivers')}}" class="btn btn-primary mr-1 mb-1" >All Drivers Send Link</a>
												</div>
											</div>
										</div>
									</form>
