												...
												<div class="col-md-3 col-12 mplanner">
													<div class="form-group">
														...
														<select class="form-control select-multiple1 planner" name="planner_id">
															...
															?>
																<option value="{{ $p->id }}" @if($p->id == $batch->master_planner) selected @endif>
																	{{ $p->planner_name }}
																</option>
											...
											<div class="row">
												<div class="col-md-12 col-12">
													<div class="form-group d-flex align-items-center">
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label>
															<input type="radio" name="type" value="Test Series" class="change_class" {{ ($batch->type == 'Test Series') ? "checked" : ""}}>Test Series
														</label>
													</div>
												</div>
											</div>
