											...
											<div class="row">
												...
												<div class="col-md-2 col-12">
													<div class="form-group">
														...
														<input type="text" name="batch_code" class="form-control" value="{{ old('batch_code') }}" placeholder="Batch Code" required readonly>
													</div>
												</div>
												...
												<div class="col-md-2 col-12 capacity_div">
													<div class="form-group">
														<label>Branch</label>
														<input type="text" name="branch" class="form-control" value="{{ old('branch') }}" placeholder="Branch" required readonly>
													</div>
												</div>
												...
												<div class="col-md-2 col-12">
													<div class="form-group">
														...
														<input type="date" name="start_date" class="form-control" value="{{ old('start_date') }}" placeholder="Start Date" min="<?=date("Y-m-d")?>" required readonly>
													</div>
												</div>
												...
												<div class="col-md-2 col-12">
													<div class="form-group">
														...
														<input type="date" name="end_date" class="form-control" value="{{ old('end_date') }}" placeholder="Batch End Date" required readonly>
													</div>
												</div>
												...
												<div class="col-md-2 col-12 capacity_div">
													<div class="form-group">
														...
														<input type="text" name="capacity" class="form-control" value="{{ old('capacity') }}" placeholder="Capacity" required readonly>
													</div>
												</div>
												...
												<div class="col-md-3 col-12 mplanner">
													<div class="form-group">
														...
														<span class="text-danger">{{ $errors->first('planner_id') }} </span>
														@endif
													</div>
												</div>
											</div>
	...
	function getPlanner(course_id){
		if (course_id) {
			$.ajax({
				...
				type : 'POST',
				url : '{{ route('studiomanager.get-planner') }}',
				data : {'_token' : '{{ csrf_token() }}', 'course_id': course_id},
				dataType : 'html',
				success : function (data){
					$("#course_loader i").hide();
