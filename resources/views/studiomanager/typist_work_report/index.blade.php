					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.typist-work-report') }}" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="{{ route('studiomanager.typist-work-report') }}" class="btn btn-warning">Reset</a>
