					...
					<div class="col-12">
						...
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.onlinecourses.store') }}" method="post" enctype="multipart/form-data">
										@csrf
...
$(".get_course_details").on("click", function() {
	...
	$.ajax({type : 'POST',
		url : '{{ route('studiomanager.get-course-list-by-mobile') }}',
...
$(document).on("click", ".destroy_course", function () {  
	...
	$.ajax({type : 'POST',
		url : '{{ route('studiomanager.delete-course') }}',
