	...
	<div class="content-wrapper">
		...
		<div class="content-body">			
			<section id="data-list-view" class="data-list-view-header">
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.reports.index') }}" method="get" name="filtersubmit">
									<div class="row">
				...
				<div class="row">
					<form method="POST" action="{{ route('studiomanager.report.export') }}">
						@csrf
							...
							<tbody>							
								...
								<tr>
									...
									<td class="product-action">
										<a href="{{ route('studiomanager.reports.show', $value->id) }}">
