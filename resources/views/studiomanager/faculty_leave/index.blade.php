		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-2">
						<a href="{{ route('studiomanager.faculty-leave-add') }}" class="btn btn-warning">Add Faculty Leave</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.faculty-leave') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-12 col-md-3 branch_loader">
											...
											<fieldset class="form-group">												
												<select class="form-control select-multiple1 faculty_id" name="faculty_id" id="">
													...
													@foreach($get_faculty as $key => $value)
										...
										<div class="col-12 col-md-2">
											...
											<fieldset class="form-group">												
												<input type="date" name="tdate" placeholder="Date" value="{{ (app('request')->input('tdate'))?app('request')->input('tdate') :date('Y-m-d') }}" class="form-control tdate">
											</fieldset>
										</div>
										<div class="col-12 col-md-5">
											...
											<fieldset class="form-group" >		
												...
												<a href="{{ route('studiomanager.faculty-leave') }}" class="btn btn-warning">Reset</a>
...
$(".submit_reason").on("click",function(e) {
		...
		$.ajax({
			...
			type: "POST",
			url : '{{ route('studiomanager.faculty_leave_update') }}',
