		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-left mb-0">Batch Hours Report New</h2>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.batch-hours-reports') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control from_date" name="from_date" value="@if(!empty(Request::get('from_date'))){{ Request::get('from_date') }}@endif">
											</fieldset>
										</div>
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control to_date" name="to_date" value="@if(!empty(Request::get('to_date'))){{ Request::get('to_date') }}@endif">
											</fieldset>
										</div>
										...
										<fieldset class="form-group">		
											...
											<a href="{{ route('studiomanager.batch-hours-reports') }}" class="btn btn-warning">Reset</a>
									...
									foreach($get_subjects as $get_subject){
										...
										if(count($get_faculty) > 0){
											foreach($get_faculty as $f_detail){
												...
												<tr style="">
													<td><?=$i;?></td>
													<td class="{{$subject_id}}"><?=$get_subject->subject_name;?><?=$subject_id;?></td>
													<td><?=$faculty;?></td>
													<td><?php 
											...
											<tr style="">
												<td><?=$i;?></td>
												<td class="{{$subject_id}}"><?=$get_subject->subject_name;?></td>
												<td><?=$faculty;?></td>
												<td><?php
												echo $get_subject->no_of_hours;
												$total_plan_hours += $get_subject->no_of_hours;
