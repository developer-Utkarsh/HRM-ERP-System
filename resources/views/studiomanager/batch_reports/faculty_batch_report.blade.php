					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.faculty-batch-reports') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control from_date" name="from_date" value="{{$from_date}}">
											</fieldset>
										</div>
										...
										<div class="col-md-2">
											...
											<fieldset class="form-group">
												<input type="date" class="form-control to_date" name="to_date" value="{{$to_date}}">
											</fieldset>
										</div>
										...
										<fieldset class="form-group">		
											...
											<a href="{{ route('studiomanager.faculty-batch-reports') }}" class="btn btn-warning">Reset</a>
				...
				<div class="table-responsive">
					...
					<table class="table data-list-view" style=''>					 
						...
						<tbody  id="myTable">
							...
							<tr style="">
								<td><?=$i;?></td>
								<td class="{{$subject_id}}"><?=$get_batch->batch_name;?></td>
								<td class="{{$subject_id}}"><?=$get_batch->subject_name;?></td>
