			...
			<div class="content-header-left col-md-6 col-12 mb-2 text-right">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						...
						<a href="{{ route('studiomanager.chapter.import') }}" class="btn btn-primary mr-1">Import Chapter</a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.chapters.index') }}" method="get" name="filtersubmit">
									<div class="row">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									{{-- @if($value->status == "1")
									<a href="{{ route('studiomanager.chapter.status', $value->id) }}"><i class="fa fa-toggle-on"></i> Active </a>
									@else
									<a href="{{ route('studiomanager.chapter.status', $value->id) }}"><i class="fa fa-toggle-off"></i> Inactive </a>
									@endif --}}
									<a href="{{route('studiomanager.chapter.status', $value->id)}}">
								...
								<td class="product-action">
									<a href="{{ route('studiomanager.chapters.edit', $value->id) }}">
										<span class="action-edit"><i class="feather icon-edit"></i></span>
									</a>
									<a href="{{ route('studiomanager.chapter.delete', $value->id) }}" onclick="return confirm('Are You Sure To Delete Chapter')">
