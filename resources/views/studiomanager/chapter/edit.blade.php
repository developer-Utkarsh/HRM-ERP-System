					...
					<div class="col-12">
						<div class="card">
							<div class="card-content">
								<div class="card-body">
									<form class="form" action="{{ route('studiomanager.chapters.update', $chapter->id) }}" method="post" enctype="multipart/form-data">
										@method('PATCH')
										@csrf
										<div class="form-body">
											<div class="row">
												<div class="col-md-6 col-12" id="course_loader">
													<div class="form-group">
														...
														<select class="form-control course_id select-multiple1" name="course_id">
															...
															<option value="{{ $value->id }}" @if($value->id == $chapter->course_id) selected="selected" @endif>{{ $value->name }}</option>
															@endforeach
														</select>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<select class="form-control subject_id select-multiple1" name="subject_id">
															@if(isset($chapter->subject_id) && !empty($chapter->subject_id))
															<option value="{{ $chapter->subject_id }}">{{ $chapter->subject->name }}</option>
															@endif
														</select>
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="Chapter Name" name="name" value="{{ old('name', $chapter->name) }}">
														@if($errors->has('name'))
												...
												<div class="col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="duration" class="form-control" value="{{ old('duration', $chapter->duration) }}" placeholder="Duration">
													</div>
												</div>
												<div class="col-md-6 col-12">
