			...
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					...
					<div class="col-4 text-right">
						<a href="{{ route('studiomanager.inventory-dashboard') }}" class="btn btn-primary mr-1">Back</a>
				...
				<div class="card-content collapse show">
					<div class="card-body">
						<div class="users-list-filter">
							<form action="{{ route('studiomanager.student-inventory-view',[$batch_id,$id,$type]) }}" method="get" name="filtersubmit">
								<div class="row">
									...
									<div class="col-12 col-sm-6 col-lg-3">
										...
										<a href="{{ route('studiomanager.student-inventory-view',[$batch_id,$id,$type]) }}" class="btn btn-warning">Reset</a>
										</fieldset>
									</div>
								</div>
							</form>
