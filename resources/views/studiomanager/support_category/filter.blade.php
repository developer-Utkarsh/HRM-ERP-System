				...
				<form action="{{ \Request::Url()}}" method="get" name="filtersubmit">
					<div class="row">
						...
						<div class="col-12 col-md-3">
							...
							<fieldset class="form-group">												
								<select class="form-control" name="category_id">
									...
									<option value="{{ $val->id }}"  @if(!empty(app('request')->input('category_id')) && $val->id==app('request')->input('category_id')) selected="selected" @endif>{{ $val->name }}</option>
									@endforeach
								</select>
							</fieldset>
						</div>
						...
						<div class="col-12 col-sm-6 col-lg-2">
							<label for="users-list-status">Status</label>
								<select class="form-control type" name="status">
									...
									<option value="replied" @if('replied' == app('request')->input('status')) selected="selected" @endif>Replied</option>
									<option value="resolved" @if('resolved' == app('request')->input('status')) selected="selected" @endif>Resolved</option>
									<option value="reopen" @if('reopen' == app('request')->input('status')) selected="selected" @endif>Reopen</option>
								</select>												
							</fieldset>
						</div>
						...
						<div class="col-12 col-sm-6 col-lg-3">
							...
							<fieldset class="form-group">
								<select class="form-control" name="rating">
									<option value="">Select Any</option>
									<option value="Excellent" @if('Excellent' == app('request')->input('rating')) selected="selected" @endif>Excellent</option>
									<option value="Average" @if('Average' == app('request')->input('rating')) selected="selected" @endif>Average</option>
									<option value="Poor" @if('Poor' == app('request')->input('rating')) selected="selected" @endif>Poor</option>
								</select>
							</fieldset>
						</div>
						...
						<div class="col-12 col-md-3">
							...
							<fieldset class="form-group">										<input type="date" name="fdate" placeholder="Date" value="{{ app('request')->input('fdate') }}" class="form-control StartDateClass fdate">
							</fieldset>
						</div>
