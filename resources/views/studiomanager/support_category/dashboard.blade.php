		...
		<div class="content-header row">
			<div class="content-header-left col-md-12 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-6">
						<h2 class="content-header-title float-left mb-0">Support Dashboard</h2>
								...
								<div class="card-body">
									...
									<div class="row mt-2">
										...
										@foreach($tkStatus as $tval)
										    <div class="col mr-1">
											  <a href="{{ route('studiomanager.support-enquiry')}}?search=search&category_id={{$tval['id']}}&status={{$tval['name']}}">
										...
										@endforeach
									   <div class="col mr-1">
										  <a href="{{ route('studiomanager.support-enquiry')}}?search=search&category_id={{$val->id}}">
