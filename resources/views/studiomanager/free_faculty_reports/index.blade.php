					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.free-faculty-reports') }}" method="get" name="filtersubmit">
									<div class="row">
									...
									<a href="{{ route('studiomanager.free-faculty-reports') }}" class="btn btn-warning">Reset</a>
