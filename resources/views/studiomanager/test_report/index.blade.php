					...
					<div class="card-content collapse show">
						<div class="card-body">
							<div class="users-list-filter">
								<form action="{{ route('studiomanager.batch-test-report') }}" method="get" name="filtersubmit">
									<div class="row">
										...
										<fieldset class="form-group">		
											...
											<a href="{{ route('studiomanager.batch-test-report') }}" class="btn btn-warning">Reset</a>
										</fieldset>
									</div>
									</div>
